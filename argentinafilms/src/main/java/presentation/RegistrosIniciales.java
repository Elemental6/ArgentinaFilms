...
public class RegistrosIniciales extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			if (!this.usuarioService.getByUserName("Jocs").equals(null)){
				System.out.println("No se pueden cargar los registros dos veces");
			}
		}
		catch (Exception e){
	...
	private void crearDatos(){
		...
		Actores actor482 = new Actores("Arturo", "Bon匤", 0, true);
		...
		Directores director49 = new Directores("Trist疣", "Bauer", 0);
		this.directorService.add(director49);
		Directores director50 = new Directores("Andrea", "M疵quez", 0);
		...
		Resenias resenia2 = new Resenias("El az昱ar diluy駭dose en mi vaso de t� con lim... en suspense brotando de la mirada y la investigaci.Una vieja Olivetti que escribe sin la &quot;A&quot;... temor a la vida, al tiempo, al amor.El secreto que oculta su mirada.", "", usuario9, null);
		Resenias resenia3 = new Resenias("Camino de Nassica (UGC Getafe), a ver la ineludible cita que produce el estreno de un filme de Campanella, tengo una sensaci de miedo, intento mentalizarme de que quiz� no sea para tanto, como prepar疣dome para una nueva decepci. Este a me he llevado alg佖 mosqueo por ir con las expectativas demasiado altas.", "", usuario32, null);
		Resenias resenia4 = new Resenias("Quer僘 ver la pel兤ula por Campanella, por Dar匤 (el GRAN Dar匤), porque hab僘 o冝o de grandes cr咜icas. No sab僘 nada m疽. Entonces empez� la pel兤ula y a los cinco minutos ya me impresinaba. Luego acab�, y tuve claro que hab僘 visto una obra maestra.", "", usuario17, null);
		...
		Resenias resenia6 = new Resenias("La pel兤ula me gust�. No voy a analizarla en detalle. Simplemente un par de cosas:Tiene un gui muy bueno: Las escenas est疣 encadenadas con mucho estilo y esto la hace entretenida de principio a fin, manteniendo un ritmo constante, sin decaer en ning佖 momento.", "", usuario37, null);
		Resenias resenia7 = new Resenias("哲ueve reinas� es un inteligente divertimento cinematogr畴ico, construido con notables precisi e ingenio sobre las sidas bases del gui y las dos interpretaciones principales, excelentes.Como en un reportaje a lo 撤ickpocket�, vemos pronto el doble fondo de una escena callejera en un momento al azar, su trastienda delictiva.", "", usuario10, null);
		Resenias resenia8 = new Resenias("Estupenda pel兤ula argentina, con un gui bien estructurado aunque con varios peros. Entretenida de principio a fin y bastante absorbente, el director llega a conseguir que el espectador sea el tercer pillo, que nos preguntemos constantemente qui駭 enga a qui駭 y que estemos atentos a que no nos engan a nosotros.", "", usuario1, null);
		Resenias resenia9 = new Resenias("Empec� a ver la pel兤ula con cierto escepticismo, pero en seguida me enganch�.Un buen ritmo, un maravilloso y original gui, una buena elecci de actores: una gran pel兤ula. Te regalar� momentos en los que no sabr疽 que decir...", "", usuario34, null);
		Resenias resenia10 = new Resenias("Si &quot;El ni que grit� puta&quot; me conmocion�, &quot;El hijo de la novia&quot; me emocion�. El inicio de la pel兤ula apunta a un gui lleno de ticos, trucos emocionales, l疊rimas f當iles. Pero seg佖 va transcurriendo empiezo a ser consciente de mi piel: caray, me estoy emocionando, me est� enganchando, sonr卲, me emociono, .", "", usuario7, null);
		Resenias resenia11 = new Resenias("Escucha... no, no te estoy diciendo que me oigas. ｡Escucha! Es la diferencia entre la actitud pasiva y la activa, porque para esta pel兤ula lo vas a necesitar.Brevemente, la sinopsis: Rafael, estresado propietario de restaurante, un ｴmalabarista que corre arriba y abajo intentando mantener el equilibrio ｴ, que tiene una madre con Alzheimer, una novia a quien atiende como si florero, una hija para los jueves fruto de su divorcio y un reencuentro con un viejo amigo que le devuelve sues de su infancia.", "", usuario5, null);
		Resenias resenia12 = new Resenias("Posiblemente la m疽 equilibrada de la esplendida trilog僘 social de Campanella, El Hijo de la Novia es un drama extremadamente sutil e incisivo con respecto a la naturaleza del ser humano, de la vida en pareja, del trabajo, de los amigos o de la familia.", "", usuario4, null);
		...
		Resenias resenia14 = new Resenias("Gracias, Zoquete, por tu cr咜ica. Me exime de decir m疽. Los argentinos, que andamos tan mal en tantas cosas, hemos sabido rescatar el arte de la cinematograf僘. &quot;Hemos &quot;dijo el mosquito, pero bueno... Campanella es nuestro y Dar匤 supernuestro.", "", usuario35, null);
		Resenias resenia15 = new Resenias("El gran Jean Jacques Rousseau dec僘 ｨLos temores, las sospechas, la frialdad, la reserva, el odio, la traici, se esconden frecuentemente bajo ese velo uniforme y p駻fido de la cortes僘ｨ y este velo es el que viene a correr con vehemencia esta gran pel兤ula.", "", usuario28, null);
		Resenias resenia16 = new Resenias("Dividida en varias historias, encuentra la fmula perfecta para que sus dos horas de duraci te pasen volando. Cuando han aparecido los t咜ulos finales me he dicho a m� mismo &quot;ｿPero ya est�?&quot;. La verdad que la calidad de todas las historias est� muy bien, aunque como en todos lados hay unas mejores que otras, y hay unas m疽 violentas que otras.", "", usuario12, null);
		...
		Resenias resenia29 = new Resenias("A medio caminoLlin疽 hace suyo el postulado de Unamuno: &quot;� todo hombre es un boceto de novela&quot;. El resultado es una cinta irregular. Las historias no est疣 del todo mal. De hecho, comienzan muy bien, con im疊enes sugerentes y plenas de misterio, pero conforme avanza el tiempo, el recurso de las cajas chinas pierde fuerza e inter駸 y las tramas personales sin aparente resoluci, terminan dejando un extra sinsabor.", "", usuario14, null);
		Resenias resenia30 = new Resenias("摘l Ciudadano Ilustre� es la cuarta pel兤ula realizada por la dupla Cohn-Duprat y, como sus anteriores trabajos, es una buena recomendaci de cine argentino.En la cinta, se cuenta la historia del Premio Nobel de Literatura Daniel Mantovani, un escritor nacido en un peque pueblo rural de Argentina, llamado Salas, del cual huy� hace m疽 de 40 as para radicarse en Europa, sin haber vuelto jam疽 a pisar su pa﨎 natal.", "", usuario16, null);
		Resenias resenia31 = new Resenias("-Si nunca fuiste a un pueblo argentino, puede que la pel兤ula no te parezca tan genial (aunque conozcas pueblos de otros pa﨎es).-Si no sos de los que aman observar las conductas humanas, puede ser que la pel兤ula no te parezca tan genial.", "", usuario5, null);
		Resenias resenia32 = new Resenias("Muy buen film basado especialmente en la gran actuaci de Oscar Martinez y en el excelente trabajo de todos los actores de reparto. La composici del protagonista, de ese ser egoc駭trico y 當ido,   es perfecta. La pintura sobre un pueblo peque, del interior, de campo, es impresionantemente real en actitudes, modos y ticks de sus habitantes.", "", usuario28, null);
		Resenias resenia33 = new Resenias("Daniel Mantovani a los 20 as,  escap� de un peque pueblo, tal vez present僘 que si se quedaba morir僘 de asfixia. Nunca volvi�, ni para el entierro de su padre. Se fu� sin que lo echaran, huy� para crecer, de un lugar donde no podr僘 hacerlo, y paradicamente su obra y sus personajes giran alrededor de sus vivencias en la infancia y adolescencia construyendo la base de su obra literaria premiada en Suecia.", "", usuario29, null);
		...
		Resenias resenia51 = new Resenias("&quot;Gilda. No me arrepiento de este amor&quot; (2016) de Lorena Muz.Antes que nada sida actuaci de Natalia Oreiro, vale la pena reconocerlo. Muy bien caracterizada y dirigida adem疽. La pel兤ula llama la atenci por no tener una mirada pochoclera del feneno Gilda.", "", usuario25, null);
		Resenias resenia52 = new Resenias("La pel兤ula comienza con un caj dentro de un coche f佖ebre. La c疥ara est� sobre el caj, se ve la madera brillante, los arreglos florales, la lluvia en el exterior. La puerta del ba伃 se abre, el f駻etro sale y recibe las gotas de lluvia y las manos de unas 15 personas que simulan muchedumbre, envueltas en llanto, con caras desfiguradas por los gritos, con desesperaci por tocar el caj, por besarlo, por darle flores, por agarrarlo y llevarlo hasta su nicho.", "", usuario24, null);
		Resenias resenia53 = new Resenias("Emotiva pel兤ula que nos lleva al universo de Valent匤, un ni que sue con ser astronauta y que tiene los pies en la tierra m疽 que algunos adultos. Desde su perspectiva observamos como es su vida y la de los personajes que le rodean.Una mezcla de comedia y drama, que tan pronto nos pone tristes como nos hace sonreir con las ocurrencias del muchacho.", "", usuario27, null);
		Resenias resenia54 = new Resenias("Fastinante pel兤ula del otro lado del charco que nos invita a hacer una reflexi sobre la importancia del amor familiar en la vida de las personas. Desde el principio nos envuelve su pasi por la vida en unas condiciones en las que es dif兤il tener las ideas claras.", "", usuario32, null);
		...
		Resenias resenia60 = new Resenias("La 伃tima sorpresa que nos ha llegado de tierras argentinas no ha sido la eliminaci de su selecci en el mundial de f偀bol (con la que me han fastidiado una porra de m疽 de 120 �), ha sido &quot;Tiempo de valientes&quot;. Una buddy movie cuyo gui ya quisiera hollywood.", "", usuario8, null);
		...
		Resenias resenia62 = new Resenias("El cine argentino nos viene ofreciendo 伃timamente aut駭ticas perlas cinematogr畴icas, tanto en forma de suspense casi metaf﨎ico (El aura), drama de tono melancico (Luna de Avellaneda) o esta mezcla insita de thriller y comedia que es Tiempo de valientes.", "", usuario34, null);
		Resenias resenia63 = new Resenias("Excelente gui. De esos que no te deja indiferente, que al final de cada di疝ogo te da la impresi de haber aprendido un poquito m疽 de la vida, o por lo menos te recuerda algo que sab僘s pero que ten僘s olvidado. El personaje de Roma inolvidable.", "", usuario8, null);
		Resenias resenia64 = new Resenias("El director de una de las mejores pel兤ulas &quot;Martin Hache&quot;, nos vuelve a deleitar con &quot;Roma&quot;, un nuevo derroche de dialogos coherentes, bien construidos y que te dejan boquiabierto, es impresionante la naturalidad que consigue, gracias a un buen gui y auna excelente direcci de un reparto de actores y actrices de lujo, donde todos, por m疽 minima aparici que tengan es extraordinaria.", "", usuario2, null);
		...
		Resenias resenia66 = new Resenias("Una pel兤ula interesante pero mucho m疽 floja de lo habitual en el estupendo Aristarain (aqu� ayudado en el gui adem疽 por Mario Camus aparte de la habitual Kathy Saavedra).Cuenta el encuentro entre un joven periodista aspirante a escritor (Botto) y un escritor ya consagrado y aislado del mundo y de sus recuerdos (Sacrist疣), que activar� en el segundo la moviola de toda su vida.", "", usuario12, null);
		Resenias resenia67 = new Resenias("Magn凬ica pel兤ula, sin duda una inesperada y grata sorpresa la que me he llevado con este film, me ha encantado de principio a fin. Adem疽 de entretener adquiere formas sentimentales y muchas secuencias de gran car當ter po騁ico, tan profundo que van directamente al coraz.", "", usuario34, null);
		Resenias resenia68 = new Resenias("Apegado a narraciones intimistas, como las que mostrara en El Faro o Sol de Oto, admirador de Akira Kurosawa, &quot;porque se anima a llegar a un lugar del alma donde no muchos se atreven&quot;, el escritor y cineasta argentino Eduardo Mignona nos ofrece una historia sobriamente emotiva, que tiene como eje la reconstrucci del v匤culo afectivo entre un abuelo y su nieta.", "", usuario8, null);
		Resenias resenia69 = new Resenias("Despu駸 de ver 伃timamente tanto cine adocenado (hecho en Hollywood o mirando a Hollywood), por no hablar de la larga lista de filmes en los que el volumen de efectos especiales es inversamente proporcional a la calidad del gui y de comedias (ｿcomedias?) de una zafiedad pr當ticamente insultante, resulta absolutamente estimulante ir a ver una obra como &quot;El viento&quot;.", "", usuario28, null);
		Resenias resenia70 = new Resenias("Es imposible que esta pel兤ula tenga una nota tan alta. Es de risa que seg佖 las cr咜icas supere a Lawrence de Arabia, Amelie o Lo que el viento se llev�. Por Dios, esta pelicula es correcta, pero nada m疽. Las actuaciones son buenas y est� bien dirigida, pero el gui peca de simple y la pelicula solo emociona los 20 伃timos minutos.", "", usuario30, null);
		Resenias resenia71 = new Resenias("Cuando vi la altas puntuaciones que daban los usuarios a esta pel兤ula, situ疣dola entre las mejores de la historia pr當ticamente, no dud� en ir a verla al cine, esperando ver una obra maestra. Sin embargo esto no fue lo que ocurri�. Reconozco que es una buena pel兤ula, pero no creo que merezca m疽 de un 7,5.", "", usuario2, null);
		Resenias resenia72 = new Resenias("Lo mejor de Mignona y  de lo mejor que he visto 伃timamente.Un muy buen gui como punto de partida; una puesta en escena sobria, totalmente acorde con el tono que la historia demandaba; unas interpretaciones de lujo en ese choque generacional entre Frank y su nieta; unos valores en juego de los que conmueven al espectador sin alardes pirot馗nicos, y un cierre que lejos de decepcionar, potencia esa carga que la pel兤ula ha ido alimentando hasta entonces.", "", usuario20, null);
		Resenias resenia73 = new Resenias("Como dec僘 Coleccionista Visual, parece que llegados a una edad ya no queda esperanza,  ni sues, ni deseos por cumplir, so esperas que los d僘s pasen y la muerte llegue lo antes posible, y m疽 cuando la que pensabas que era la mujer de tu vida muere dej疣dote viudo, como en el caso de Fred.", "", usuario4, null);
		...
		Resenias resenia75 = new Resenias("Despu駸 del estreno de la pel兤ula, una radio entrevistaba a Elsa y por detr疽 se escuch� un grito de una admiradora que dec僘: &quot;Me hiciste llorar hija de puta&quot;. A mi, no tan solo me ha hecho llorar sino que he re冝o y he disfrutado de esta excelente interpretaci.", "", usuario14, null);
		Resenias resenia76 = new Resenias("Elsa y Fred fue un trabajo elegido para conformar la XLVI Muestra Internacional de Cine en M騙ico, la cual ameniz� de manera cica la proyecci de 15 pel兤ulas en su mayor僘 de g駭ero dram疸ico. Los protagonistas en plena senectud son escasos debido a la desafortunada visi que se tiene de la vida.", "", usuario15, null);
		Resenias resenia77 = new Resenias("Esta es una pel兤ula sobre todo de actores. El gui no deja de ser una historia pasable, salpicada de algunos momentos emotivos y simp疸icos, pero bastante previsible. Lo mejor de la pel兤ula, los actores, sobre todo Manuel Alexandre, un actor siempre secundario y que nunca ha defraudado a los que lo busc畸amos en una de esas innumerables pel兤ulas en las que ha trabajado.", "", usuario12, null);
		Resenias resenia78 = new Resenias("Lugo de alcanzar el 騙ito con series como &quot;Tumberos&quot; o de pel兤ulas como &quot;Un oso rojo&quot; el director uruguayo/argentino Israel Adri疣 Caetano vuelve al ruedo con &quot;Crica de una fuga&quot;, competidora en la selecci oficial de Cannes.", "", usuario32, null);
		...
		Resenias resenia83 = new Resenias("El realizador argentino Carlos Sorin revisita los terrenos y cigos que abarc� en la entrable Historias m匤imas. Nuevamente en el marco de los amplios horizontes y pueblos perdidos de las tierras patagicas, registra a actores no profesionales interpretando a personajes cuyas vidas bien pueden ser las de ellos mismos: en este caso un hombre maduro, humilde y desempleado, vislumbra nuevas esperanzas cuando por azar termina siendo due de un perro dogo que bien podr僘 ser un campe en exposiciones.", "", usuario34, null);
		Resenias resenia84 = new Resenias("Supuestamente el detonante de toda historia es el conflicto. Practicamente todos partimos de la idea de que esa palabra implica que hay un problema, que ha pasado algo negativo. Para Carlos Sor匤 no. Para 駘 el detonante de toda historia es lo cotidiano, lo sencillo, el d僘 a d僘, los encuentros fortuitos.", "", usuario21, null);
		Resenias resenia85 = new Resenias("Manolo es peque, peludo, suave; tan blando por fuera, que se dir僘 todo de algod. Manolo es mi perro y no es un burro. Y por si hubiera alguna duda, yo tampoco soy Juan Ram Jim駭ez.Si hubiera visto esta pel兤ula hace un a probablemente me habr僘 aburrido.", "", usuario24, null);
		Resenias resenia86 = new Resenias("Excelente pel兤ula que transcurre con el lento ritmo de la Patagonia, la lucha por la supervivencia, las necesidades de un hombre humilde que pueden ser satisfechas por el azar de recibir como regalo un perro, perro que no cumple con lo que se espera de 駘.", "", usuario30, null);
		Resenias resenia87 = new Resenias("Un problema de desempleo con una aparente soluci inusual, el Sr. Juan Villegas la verdad, ha hecho un trabajo de interpretaci muy bueno, al igual que el resto, no sab僘 que no eran profesionales o por lo menos no han tenido gran cantidad de trabajos.", "", usuario1, null);
		...
		Resenias resenia89 = new Resenias("Sublime China Zorrila. ｿPuede una actriz ser m疽 adorable, talentosa y cre兊le que la inmensa uruguaya?. No por supuesto, porque todo lo que haga China tiene su toque m疊ico 佖ico. En Conversaciones con mam� est� impresionante y Eduardo Blanco como su hijo no se queda atr疽, juntos tienen unos di疝ogos que son de antolog僘.", "", usuario6, null);
		Resenias resenia90 = new Resenias("Es una de las mejores pel兤ulas que he visto en los 伃timos cinco as, sin duda. Un maravilloso gui interpretado de forma magistral por todos los actores sin excepci. Eduardo Blanco se ha colocado merecidamente en uno de los mejores actores que he visto.", "", usuario20, null);
		Resenias resenia91 = new Resenias("...muy realista y humana. Una relaci madre e hijo bien dirigida da para mucho, como en 駸ta pel兤ula. Realmente no puede ser m疽 sencilla, pero a la vez llena de la propia vida de mucha gente.", "", usuario8, null);
		...
		Resenias resenia108 = new Resenias("Oto de 1.976, en Argentina. El pa﨎 sufre una conmoci cuando sufre un golpe militar. A partir de entonces, muchas personas hasta aquel momento libres y que ejerc僘n con total naturalidad sus derechos y defend僘n sus ideales pol咜icos, comenzar疣 a ser perseguidos.", "", usuario10, null);
		...
		Resenias resenia110 = new Resenias("Tras Plata quemada, Marcelo Piyro confirma las buenas maneras que ya apuntaba.La pol咜ica ha sido desde siempre un buen terreno del que sacar materia f匀mica. En muchas ocasiones ayuda a recuperar una memoria, que en muchos casos, se ha pretendido hacer olvidar a la fuerza.", "", usuario20, null);
		Resenias resenia111 = new Resenias("Hablar de la dictadura desde otro punto de vista, el de un ni. Como drama familiar est� muy bien, pero falta algo para que sea una pel兤ula redonda.Sus bazas son unos estupendos actores, incluidos los nis, una est騁ica muy buena, al estilo hollywoodiense (similar a la de &quot;Las horas&quot;, &quot;Magnolia&quot; y similares, aunque salvando las diferencias), un m疽 que aceptable gui y el importante tema tratado.", "", usuario37, null);
		Resenias resenia112 = new Resenias("Sosa,  y anodina, si no fuera por su trasfondo pol咜ico, que es en lo que se basa la pel兤ula, resultar僘 inaguantable, su 佖ico 疳ice est� en el principio y en el final, toda su &quot;aventura&quot; durante el metraje es algo casi sin inter駸.", "", usuario30, null);
		Resenias resenia113 = new Resenias("En Argentina existe la discriminaci hacia los peruanos, bolivianos, paraguayos, etc., y esta pel兤ula la retrata muy bien, al punto de que nos muestra la cara m疽 horrible de este asunto.Me he sentido identificado con ese pobre muchacho que deja a su familia, mujer e hijos en su Bolivia natal, y llega a Buenos Aires con la sola intenci de encontrar una oportunidad por m﨎era que sea.", "", usuario33, null);
		Resenias resenia114 = new Resenias("Con una ejemplar econom僘 narrativa y de medios, desarrollando la acci practicamente en un 佖ico lugar, el cineasta argentino Adri疣 Caetano cuenta la historia de un inmigrante boliviano reci駭 llegado a la prometedora Argentina, sin papeles, dde comenzar� a trabajar de cocinero en un bar.", "", usuario36, null);
		Resenias resenia115 = new Resenias("Ganador del Premio de la Cr咜ica Joven en el Festival de Cannes y del Premio Made In Spanish en el Festival de San Sebasti疣.Freddy (Freddy Flores), un inmigrante boliviano ha conseguido un reciente trabajo en Argentina de parrillero en un restaurant, ya que en su pa﨎 ha perdido su trabajo.", "", usuario20, null);
		Resenias resenia116 = new Resenias("Soberbias actuaciones: el oso, Freddy, el due del restaurant y Marcelo dan c疸edra. Este era mi principal miedo ante actores de poco cartel. Nada est� dem疽, nada parece fingido... Ahora que miro mejor, los nombres de los actores y de sus personajes son id駭ticos.", "", usuario29, null);
		Resenias resenia117 = new Resenias("Bolivia-Simplista y muy reconocido largometraje Argentino, en muchos niveles es el retrato de cada uno de los inmigrantes de Am駻ica Latina a otro pa﨎 hermano, independientemente el nombre del pa﨎 es casi seguro que la realidad vivida por el protagonista, es la dif兤il realidad de muchos que deciden viajar de su naci a un pa﨎 vecino que les pueda dar m疽 oportunidades de vida digna.", "", usuario11, null);
		Resenias resenia118 = new Resenias("Los nis que nacen entre rejas, el vinculo madre-hijo en esas circunstancias,  la relaci de solidaridad u hostilidad con las comparas del presidio, el derecho de los que est疣 afuera y el de los que est疣 encerrados, son los temas incorporados al 伃timo film del realizador argentino Pablo Trapero, que elude transitar por los lugares comunes del subg駭ero de pel兤ulas carcelarias, evitando hacer de lo escabroso un motivo central.", "", usuario22, null);
		Resenias resenia119 = new Resenias("Esta pel兤ula se caracteriza por lo real que es. El drama de la protagonista el espectador lo va a sentir como propio. Est� muy bien representada la presa embrazada. Parece haber estudio en la interpretaci. Y que muestren como ella est� embarazada de verdad, la hace aun m疽 cruda a la realidad.", "", usuario6, null);
		Resenias resenia120 = new Resenias("Creo que esta pel兤ula responde a la pregunta del t咜ulo. Describe el d僘 a d僘 en una c疵cel de mujeres, sin darle tintes novelescos ni melodram疸icos. Son cosas que podr僘n pasar en unas celdas. Y creo que logra describirlo as� de bien por co comienza la pel兤ula, ya que no hace falta que haya un culpable o un inocente para que pase algo as�, para que te veas embarazada y desvalida en una penitenciar僘.", "", usuario2, null);
		Resenias resenia121 = new Resenias("La veracidad es algo que siempre est� presente en las pel兤ulas de Trapero. En los 伃timos as han salido un grupo de cineastas argentinos como Carlos Sor匤 o el propio Trapero que dotan a su cine de una veracidad muy palpable. Usan para ello historias muy cotidianas y con actores no profesionales (en muchos casos).", "", usuario26, null);
		Resenias resenia122 = new Resenias("Trapero busca el realismo m疽 descarnado, como en sus anteriores pel兤ulas. Es una historia totalmente cre兊le, sobria y natural. Es diferente a otras pel兤ulas sobre prisiones. Nunca cae en lugares comunes. La sensaci de claustrofobia es enorme.", "", usuario37, null);
		...
		Resenias resenia124 = new Resenias("Cuarenta y dos as despu駸, Leonardo Favio retoma su segunda pel兤ula con el convencimiento de que no hay versi buena si no se transmuta la obra original. Y con esta idea, alejado por completo de lo que se ofrece en el mercado, convierte la historia de Aniceto y Francisca, en una obra nueva, visualmente deslumbrante y con un car當ter sensual donde antes solo exist僘 rudeza.", "", usuario37, null);
		Resenias resenia125 = new Resenias("El genio de Favio nos vuelve a sorprender con una f畸ula rebosante de ternura y lirismo, emanada de su sensible esp叝itu, la que, lamentablemente, es posible sea su obra ptuma, ya que su salud se encuentra muy deteriorada por una penosa enfermedad.", "", usuario21, null);
		Resenias resenia126 = new Resenias("Aniceto es la reversi 澱ailada� de la pel兤ula que dirigi� all� por el a 1967, titulada ﾉste es el romance del Aniceto y la Francisca, de co qued� trunco, comenz� la tristeza y unas pocas cosas m疽� protagonizada por Federico Luppi, Elsa Daniel y Mar僘 Vaner.", "", usuario10, null);
		Resenias resenia127 = new Resenias("Leonardo Favio ya hab僘 hecho en los as 60 una hermosa versi de este cuento de su hermano Jorge Zuhair Jury, con un t咜ulo bastante m疽 extenso, en blanco y negro. Sin embargo en la presente versi, &quot;Aniceto&quot;, mostrando su creatividad y capacidad, logra ir m疽 all� del cine.", "", usuario1, null);
		Resenias resenia128 = new Resenias("Kafkiano retrato de la sociedad argentina en el que un hombre normal se ve involucrado, de la noche a la mana, en la m疽 absurda de las pesadillas.Me gustan mucho estos finales tan abiertos, tan imprecisos. Cada uno se construir� el suyo propio.", "", usuario15, null);
		...
		Resenias resenia130 = new Resenias("Al principio todo comienza seg佖 lo previsto: crisis argentina, mirada costumbrista y relaci amorosa entrable y aparentemente id匀ica. Pero lo previsto se derrumba, pues la pel兤ula sorpresivamente adquiere la forma de un delirante drama kafkiano.", "", usuario1, null);
		...
		Resenias resenia133 = new Resenias("Pel兤ula humana, intimista y que se hace muy agradable gracias a los papeles de las dos actrices protagonistas. Norma Aleandro est� estupenda, como siempre, pero Norma Argentina no se le queda atr疽. Alejado de los circuitos comerciales, Jorge Gaggero nos intenta mostrar la decadencia de la clase media Argetina, que pierde poder econico poco a poco.", "", usuario3, null);
		Resenias resenia134 = new Resenias("El joven director Jorge Gaggero elige una tica diferente a la convencional dial馗tica ideolica del amo y el esclavo, para observar las relaciones de clase en medio del desplazamiento social de un pa﨎, que a fines de 2001 entr� en un caos econico y pol咜ico sin precedentes.", "", usuario13, null);
		Resenias resenia135 = new Resenias("En ocasi de la proyecci en TV2 de la fenomenal 滴istoria oficial�, el prestigioso cr咜ico de cine Juan Miguel Lamet no dud� en selar a Norma Aleandro como la mejor actriz en activo de habla hispana y probablemente una de las tres o cuatro mejores del mundo.", "", usuario11, null);
		Resenias resenia136 = new Resenias("Entretenid﨎imo cara a cara entre dos mujeres que tras vivir casi treinta as bajo un mismo techo (una, la sera de la casa; la otra, su empleada) se ven enfrentadas por la crisis econica que sacudi� recientemente a la Argentina.ｿQue suceder� cuando esos roles y status que mantuvieron durante tanto tiempo resulten dinamitados?ｿQu� mujer aparecer� tras la orgullosa burguesa venida a menos y cu疝 tras la empleada que no aguantaba ya m疽 a su jefa?ｿQu� queda cuando nada de eso queda? ｿServir� de algo todo lo que han comparetido juntas aunque de manera tan diferente?Interesante historia, interesante pel兤ula.", "", usuario22, null);
		Resenias resenia137 = new Resenias("Me gust� la historia. Me gustaron mucho los personajes. Me gust� como lo va contando todo Gaggero. Me gust� la fotograf僘. Me gustaron los toques de humor. Me gust� la mirada cr咜ica, limpia, humana del director. Me gustaron mucho las dos Normas, la que ya lo ha demostrado casi todo y la que debutaba ante las c疥aras.", "", usuario6, null);
		...
		Resenias resenia148 = new Resenias("Si fuera hacer un resumen de esta pel兤ula partiendo tan so de las escenas elegir僘 dos de ellas: la del di疝ogo de Cristina en la barca y la de Rom疣 en la Asamblea. Las dos son especialmente bellas porque nos hablan del verdadero concepto de la felicidad.", "", usuario30, null);
		Resenias resenia149 = new Resenias("Luna de Avellaneda es la historia de un emblem疸ico club de barrio que ha vivido en el pasado una 駱oca de esplendor y que en la actualidad se encuentra inmerso en una crisis que pone en peligro su existencia. Al parecer, la 佖ica salida posible es que se convierta en un casino, nada m疽 alejado de los ideales y de los fines de sus fundadores en la d馗ada de 1940: un club social, deportivo y cultural.", "", usuario31, null);
		...
		Resenias resenia153 = new Resenias("Pel兤ula muy seria, triste, deprimente; donde todo lo que sucede est� bajo la esfera de la realidad frustante de tant﨎imos millones de argentinos dentro de una patria-sociedad que es capaz de darles equipos de futbol campeones del mundo, pero para nada un Estado campe  en hacer cumplir los derechos humanos en la mayor僘 de sus ciudadanos, empezando por la comida, la educaci, el trabajo, la vivienda, etc.", "", usuario9, null);
		...
		Resenias resenia161 = new Resenias("Al final del t佖el Estamos de parabienes. De nuevo me toca reser una estupenda pel兤ula argentina pues, como ocurre con el cine espal, son aconticimientos escasos as� que, estas alegr僘s, dosificadas con cuentagotas, siempre significar疣 un motivo de celebraci.", "", usuario25, null);
		Resenias resenia162 = new Resenias("Siento decirlo, pero tengo cierta prevenci contra las pel兤ulas espalas e hispanoamericanas, quiz� sea injusto, pero es as�. Me cuesta darles una oportunidad. ﾉste es uno de esos casos, y me han sorprendido muy, muy, muy gratamente.Un thriller en estado puro, nada de denuncias sociales por en medio, nada de escenas de sexo para rellenar, nada de violencia gratuita, (aunque cuando hace falta est� ah�).", "", usuario18, null);
		...
		Resenias resenia164 = new Resenias("Esta es una pel兤ula de detalles, de cosas peques (que le llaman algunos a este tipo de historias), en la que disfrutar con miradas, silencios, reacciones sentimentales de los personajes... todo eso te puede atrapar y realmente emocionar, o quiz� dejar indiferente y aburrir, admito el riesgo.", "", usuario29, null);
		Resenias resenia165 = new Resenias("Herencia, es una comedia dram疸ica sobre dos inmigrantes europeos que llegan a Buenos Aires en dos 駱ocas muy diferentes. Olinda (Rita Cortese) es una inmigrante italiana que lleg� a la Argentina tras la Segunda Guerra Mundial. Aunque nunca pudo encontrar al hombre cuyos pasos segu僘, decidi� adoptar a Buenos Aires como su ciudad.", "", usuario6, null);
		Resenias resenia166 = new Resenias("Cine de sentimientos escondidos, de amistad a flor de piel oculta tras una coraza tan fr疊il como un plato, de amores perdidos, encontrados y vueltos a perder, la pel兤ula de Hern疣dez se paladea como las berenjenas, sin salsas que escondan su sabor.", "", usuario20, null);
		...
		Resenias resenia183 = new Resenias("No pensaba escribir una cr咜ica, pero mientras le僘 las ajenas se activaron ciertos botones que no pude negar.Ten僘 algo de informaci sobre la pel兤ula, viene premiada por varios festivales, hab僘 visto el Trailer y en m� cuerpo corr僘 cierta incomodidad previa.", "", usuario5, null);
		...
		Resenias resenia185 = new Resenias("ｿO no�?Si hay algo en el cine argentino que me atrae son sus actores. Parecen tocados por una barita m疊ica. Esta es una pel兤ula puramente actoral y de muy alto nivel.La trama se fundamenta en una idea, tan genial como sencilla.", "", usuario9, null);
		Resenias resenia186 = new Resenias("Muy interesante propuesta de Cohn y Duprat, quienes logran una comedia inteligente que circula entre lo est騁icamente visual y el discurso ideolico que transmite. Las im疊enes dicen m疽 de lo que muestran.  La frase: 添o lo que necesito es un poquito de luz que a vos te sobra�, funciona como disparadora del relato.", "", usuario18, null);
		Resenias resenia187 = new Resenias("ﾚltimamente tiendo a ordenar mentalmente el cine en tres categor僘s:1) Populista: Aquel que trata de saciar los instintos m疽 primarios de un espectador al que en realidad el cine no le interesa. Por ejemplo el Hollywood m疽 descerebrado, las espaladas o Bollywood.", "", usuario37, null);
		Resenias resenia188 = new Resenias("Pel兤ula estrenada en el a 2000, en blanco y negro, con actores desconocidos y bajo presupuesto, apenas 52000 dolares.Este Film se sale del molde y nos cuenta una original historia en 3 駱ocas de Buenos aires.Son 3 amigos que desde adolescentes, est疣 obsesionados por una actriz de teatro de revistas, que se van metiendo en &quot;quilombos&quot;, y van mostrando lo peor de los argentinos, el mundo de la noche, la droga, las mafias y la historia y las crisis que se repiten d馗ada a d馗ada.", "", usuario22, null);
		Resenias resenia189 = new Resenias("En est� semana con la oportunidad de ir al cine y ver propuestas en la segunda Muestra Internacional de Cine en M騙ico me he topado curiosamente con cuatro pel兤ulas de cr咜ica social a personajes ubicados como el pilar de la familia: la madre. La visi ha girado 180ｺ y la descomposici parte de ellas, gracias al desencanto con el que viven y con el cual han construido su destino, coloc疣dolas como la escoria de una sociedad supuestamente funcional.", "", usuario26, null);
		Resenias resenia190 = new Resenias("&quot;No me gusta trabajar&quot;, esgrime Florencia, protagonista principal de esta obra que conmueve, divierte y hace pensar. Son las vicisitudes femeninas, sus contradicciones, enfrentamientos de clase y familiares y dem疽 detalles de la vida cotidiana los que se nos presentan de una manera que nos permite mantener el inter駸 durante su desarrollo.", "", usuario9, null);
		Resenias resenia191 = new Resenias("La nena hace lo que puede, pero su actuaci es muy sobre actuada . Con la musica de los bobosicos que son insoportables. Es una comedia dram疸ica, pero de comedia no tiene nada, nunca te hace reir. La madre hace de cocainana y llega ser adicta a la idiotez.", "", usuario12, null);
		Resenias resenia192 = new Resenias("Aceptable film argentino que comienza de un modo exultante, con di疝ogos y escenas motivantes pero que a medida que transcurre la pel兤ula se va cayendo poco a poco, (comienza con suerte y acaba sin fortuna) llegando a tener un desenlace absurdo no cre兊le.", "", usuario32, null);
		Resenias resenia193 = new Resenias("Felipe (Marcelo Mazzarello) un actor desempleado y Guillermo (Gast Pauls) despedido de su trabajo y abandonado por su novia, son dos medio hermanos muy diferentes, hacen as que no se ven, pero vuelven a reunirse para complacer a su moribundo padre en su 伃timo deseo antes de morir.", "", usuario36, null);
		Resenias resenia194 = new Resenias("De nuevo una pel兤ula argentina entrable. La suerte est� ah�, y en muchas ocasiones hay un hilo muy fino que separa la mala de la buena. Nuestro querido protagonista no se resigna a ser un perdedor toda su vida y tendr� que luchar para que su suerte y la de quien le rodea cambie a mejor.", "", usuario22, null);
		...
		Resenias resenia208 = new Resenias("Luego de ver las pel兤ulas anteriores de Pablo Trapero se puede decir que va disminuyedo la intensidad con la que abordaba diferentes temas sangrantes de la Argentina. A佖 as�, en El Clan, logra llevar al cine una novela aterradora que sucedi� en la d馗ada del 80 en este pa﨎.", "", usuario9, null);
		Resenias resenia209 = new Resenias("Recomendable por la crudeza de las situaciones, con contadas escenas de violencia expl兤ita pero sin exceso de gore, lo cual la har� m疽 o menos dif兤il de tragar seg佖 la susceptibilidad de cada uno.Cualquier persona con un poco de humanidad, sentir� rechazo y repudio hacia los Puccio, que realizaban secuestros extorsivos para cobrar abundantes sumas de dinero, aunque siempre ejecutaban a sus v兤timas, en vez de devolverlas sanas y salvas a sus familias.", "", usuario22, null);
		Resenias resenia210 = new Resenias("溺edianeras� es una historia de amor aunque habla sobre todo de su ausencia, en tiempos de fobias sociales y en el marco de una sociedad progresivamente deshumanizada, tanto en su arquitectura como en su sofisticada tecnolog僘. El problema que plantea es universal: en las macrociudades actuales todos se cruzan sin conocerse.", "", usuario15, null);
		Resenias resenia211 = new Resenias("N疼fragos en un oc饌no sin apenas islas, viven en Buenos Aires, dentro de sus respectivas c疽caras de nuez, dos jenes. ﾉl, disedor de p疊inas web, con poca suerte y pocas ganas de buscarla. Ella, arquitecta, metida a decoradora de escaparates por aquello de la crisis, empeda en localizar a Wally en la ciudad.", "", usuario25, null);
		Resenias resenia212 = new Resenias("Medianeras cierra un 2011 de muy buen cine argentino. A佖 cuando todav僘 me queda por ver varios films del producci nacional del 2011 (De caravana y Las Acacias, principalmente) ya puedo destacar varios de ellos: Fase 7, La vieja de Atr疽, El Estudiante y ahora Medianeras.", "", usuario24, null);
		Resenias resenia213 = new Resenias("&quot;Buenos Aires crece descontrolada e imperfecta, una ciudad en la que se yerguen miles y miles de edificios sin ning佖 criterio. Al lado de uno muy alto hay uno muy bajo, al lado de uno racionalista, uno irracional. Probablemente estas irregularidades est騁icas y 騁icas nos reflejen perfectamente.", "", usuario4, null);
		Resenias resenia214 = new Resenias("Son almas gemelas, pero no se conocen... A pesar de vivir en la misma calle y coincidir en ella y hasta en la piscina. ﾉl ha pasado dos as encerrado en casa, haciendo todo en Internet, desde la compra hasta el sexo. Ella ha cortado recientemente una relaci de cuatro as.", "", usuario19, null);
		Resenias resenia215 = new Resenias("Les cuento: hace una semana v� El Ciudadano Ilustre (tambi駭 con Oscar Martinez como protagonista) y me encant�. Reci駭 termino de ver Inseparables, y la verdad es que no tiene ni punto de comparaci. Nunca me imagin� que 駸te hombre fuera a hacer una americanada as� (aunque sea una remake de cine franc駸), tan obvia, liviana, previsible y cursi.", "", usuario9, null);
		Resenias resenia216 = new Resenias("A diferencia de lo que pens�, es muy divertida, fui con mis hijos de 27 y 22 as y tambi駭 les gust�- escuchaba sus carcajadas en el cine- Rodrigo de la Serna est� espectacular, y Oscar Martinez,  excelente. Muy argentina, en los modismos y lenguaje.", "", usuario36, null);
		Resenias resenia217 = new Resenias("Remake argentina de la pel兤ula del 2011 llamada AMIGOS INTOCABLES producci que fue el m疽 exitoso del cine franc駸, a su vez basado en hechos reales.La pel兤ula original me encanto. Buena historia, buenos personajes, divertimiento y emoci en unas 2 horas magnificas.", "", usuario30, null);
		...
		Resenias resenia225 = new Resenias("No creo que sea posible comentar una pel兤ula de tan alto contenido social  desde un lugar objetivo y as駱tico. La tem疸ica divide y dividir� aguas por largo tiempo, pero en este caso el director (con la autoridad moral  y art﨎tica que da la referencia autobiogr畴ica) logra calar profundo en una mirada que se despega del golpe bajo y de la tentaci de cualquier bajada de l匤ea ideolica.", "", usuario5, null);
		Resenias resenia226 = new Resenias("Cuando me enter� de que Infancia Clandestina fue seleccionada para representar al pa﨎 para los Oscar, de repente me entraron las ganas de verla. No lo niego, los oscar, por mas desvalorizados (por culpas propias) siguen siendo una referencia de calidad para m�.", "", usuario15, null);
		Resenias resenia227 = new Resenias("En cualquier expresi art﨎tica es necesario que haya un.. alma? plus? punto de contacto? puente? que permita la identificaci de la obra con el p炻lico, que logre ese clic, ese cierre o broche final en la cabeza o en el coraz del espectador.", "", usuario26, null);
		...
		Resenias resenia240 = new Resenias("Hawaii es la tercer pel兤ula del director argentino Marco Berger (Plan B, Ausente) que compite en la categor僘 de Largometrajes Nacionales.Una historia de amor. As� presentan esta pel兤ula que trata sobre Mart匤 y Eugenio. Mart匤 debe pasar el verano sobreviviendo, no tiene un lugar donde quedarse y se hace algunos pesos como puede.", "", usuario9, null);
		...
		Resenias resenia242 = new Resenias("En la primera parte de la pel兤ula Marco Berger consigue despertar el inter駸 del espectador mediante la mirada de los protagonistas, inquieta, variante, como buscando algo o temiendo algo. A partir del encuentro de los dos protagonistas, las miradas cambian, ahora son de inter駸 personal y hasta de an疝isis f﨎ico, cada uno por el cuerpo del otro.", "", usuario8, null);
		Resenias resenia243 = new Resenias("Las relaciones entre hombres son una constante en el cine del director argentino Marco Berger. Desde sus primeros cortos hasta sus largometrajes 善lan B� y 羨usente�, Berger muestra como dos chicos se conocen y se atraen.Mart匤 hace algunas chambitas para pasar el verano antes de volver a Buenos Aires para asentarse ah�, Eugenio est� cuidando la casa de un t卲 mientras escribe una novela y decide contratarlo, m疽 por atracci hacia Mart匤 que por verdadera necesidad.", "", usuario11, null);
		Resenias resenia244 = new Resenias("El Zapa es un pobre cerrajero que se ve implicado en un robo. En el pueblo todos le conocen y saben que no es mal chico, por lo que todo se arregla para que viaje a Buenos Aires con una recomendaci para incorporarse al cuerpo de la Bonaerense.El Zapa se va dando cuenta, poco a poco, de que la polic僘 se mueve corruptamente por los bajos fondos.", "", usuario6, null);
		Resenias resenia245 = new Resenias("Pablo Trapero nos muestra una realidad cruda, sin edici y sin ornamentos, de una instituci tan cuestionada en la Argentina como lo es la Polic僘 Bonaerense, enmarcando las historias personales en un pa﨎 en plena crisis econica. Lejos est疣 en esta pel兤ula, los irreales sues primermundistas de la Argentina de los 90ｴ.", "", usuario28, null);
		Resenias resenia246 = new Resenias("Coproducci argentino-chilena que cuenta la historia de un hombre que por circunstancias ajenas a 駘 se ver� en la necesidad de dedicarse a ser polic僘 en la capital argentina.Posee una direcci art﨎tica mediocre, con p駸imas actuaciones de los protagonistas principales y a佖 peores de los secundarios (a la madre de Zapa so le falta mirar a la c疥ara y mandar saludos).", "", usuario5, null);
		Resenias resenia247 = new Resenias("M疽 que &quot;Trapero&quot; este hombre podr僘 ser &quot;modisto de Alta Costura&quot;,  posiblemente sea la pel兤ula argentina de los 伃timos as que m疽 poso deja tras verla. Escenas memorables y sutilmente inolvidables.Magn凬ico Trapero.", "", usuario1, null);
		Resenias resenia248 = new Resenias("Esta pel兤ula quiz疽 no tenga el super-argumento, pero nos demuestra lo m疽 profundo de la realidad de la Policia Bonaerense: corrupci, prostituci, oficiales excedidos de edad que entran por los &quot;amiguismos&quot;, y dem疽 cosas. Sin dudas el protagonista es un inutil, que lo pasan por arriba (por decirlo en criollo), unas 2 veces en la pel兤ula.", "", usuario11, null);
		Resenias resenia249 = new Resenias("Escondido cine  argentino, que  al igual que decenas de pel兤ulas  que no llegan a nuestras carteleras, no deja de ser un  cine interesante, sea cual fuere su procedencia. Su trasfondo es el del abandono,  el de la soledad y la muerte; una soluci de b俍queda que  acompa al protagonista y a todo al que la ve, que trasluce el 疥bito del cine independiente para hacerse a佖 m疽 desgraciadamente olvidado.", "", usuario23, null);
		...
		Resenias resenia251 = new Resenias("Cine antropolico pero no autoc駭trico (y por ah� el aficionado no encontrar� punto de apoyo en una personalidad o una empat僘 motor del metraje); aqu� el protagonista no se presenta en el centro de una ficci construida por y para 駘 (cl疽ico sujeto volitivo de introducci-nudo-desenlace) sino que el contexto emerge estructuralista como suma de elementos sin retica del 土o�.", "", usuario24, null);
		Resenias resenia252 = new Resenias("Segundo intento, segunda parte, continuaci con intermedio o vayan ustedes a saber. Lo cierto es que esta vez, arrancamos (de nuevo) con un intenso plano-secuencia de los momentos anteriores al asesinato. Sirve este inicio como prolegeno, como resumen y tambi駭, aunque no se vea, como conclusi.", "", usuario11, null);
		Resenias resenia253 = new Resenias("Existen grandes pel兤ulas, que se construyen con di疝ogos ingeniosos, bien elaborados, que son del disfrute para los amantes del buen cine, pero tambi駭 existen pel兤ulas en donde los di疝ogos son practicamente inexistentes, en el cual el uso de la c疥ara es importante, el cine es un arte y la c疥ara es el instrumento, la c疥ara nos habla nos muestra, sin necesidad de la palabra, tan solo que con el movimiento de esta, siendo grandes representantes de este cine Andrei Tarkovsky, Bresson y m疽 contempor疣eo Bela Tarr, pero latinoamerica tambi駭 tiene su representante con Lisandro Alonso.", "", usuario29, null);
		...
		Resenias resenia256 = new Resenias("Sorprendente thriller dram疸ico argentino en donde las cosas se han realizado con verdadera pericia, esto sin desmerecer nuestro cine pero aqu� la eficacia ha alcanzado niveles como so veo en contadas pelis de nuestro pa﨎. Desde luego, el t咜ulo es irico, pero vamos a la peli.", "", usuario19, null);
		Resenias resenia257 = new Resenias("Muchos quedamos sorprendidos al ver el palmar駸 de la pasada SEMINCI, en la que se alzaron con la Espiga de Oro ex aequo 'Copia certificada', de Abbas Kiarostami y 'Sin retorno', de Miguel Cohan. La primera es para el que esto escribe la mejor pel兤ula de 2010, por lo que el hueco en lo m疽 alto lo ten僘 de sobra merecido.", "", usuario27, null);
		...
		Resenias resenia271 = new Resenias("No hay lugar para la ampulosidad en El 伃timo Elvis; ni para la joda ni para la caricaturizaci. Sobria como pocas, justamente por tratar de un  tema como el que trata, lo que sorprende es la seriedad de la propuesta y el como desarrollarla apenas teniendo en cuenta el devenir psicolico del personaje principal.", "", usuario31, null);
		Resenias resenia272 = new Resenias("Historia pausada, intimista, con una camara omnipresente que sigue a nuestro ｿ冝olo? en cada momento vital. La historia de un hombre que se transforma en el 佖ico y ｿleg咜imo? continuador de Elvis Presley...o as� lo entiende 駘.", "", usuario7, null);
		Resenias resenia273 = new Resenias("Pel兤ula intrigante, de esas con las que piensas una vez salido del cine y meses despu駸. Una reflexi perfecta entre la obsesi y la realidad de un aut駭tico fan. Merece la pena verla, sin duda una de las mejores pel兤ulas que pueden salir en verano.", "", usuario30, null);
		...
		Resenias resenia275 = new Resenias("Hace m疽 de veinte as que Eliseo Subiela cuenta variaciones de una historia parecida. Si algo lo distingue como cineasta es la fidelidad a   sus ideas, a su mundo personal que tiene una est騁ica cinematogr畴ica  reconocible, con adeptos y detractores.", "", usuario28, null);
		Resenias resenia276 = new Resenias("Me gust�. Es una historia de amor con ensenza, que nos muestra los valores fundamentales del ser humano: amor desinteresado, lealtad en los malos momentos, generosidad, inocencia, confianza en uno mismo, piedad, etc.Mabel y Mart匤 encarnan muy bien estos valores y nos hacen part兤ipes de su ternura.", "", usuario22, null);
		...
		Resenias resenia278 = new Resenias("Es un film que trata de hacer pensar sobre la vida sin caer en el didactismo, por lo cual, los dos protagonistas, si son ejemplo, lo son con sus simples actos, que son de libertad y de amor: son personas at厓icas precisamente porque hacen uso de tal libertad, la que todos tenemos y quiz疽 no usamos.", "", usuario7, null);
		Resenias resenia279 = new Resenias("Pelicula muy en la l匤ea de Historias M匤imas, (es pr當ticamente un calco muy bien hecho). Se nos muestra la realidad de un pa﨎, de un amplio sector de la sociedad argentina que permanece agarrada a  unos sues, a unos ideales que permanecen muy arraigados.", "", usuario16, null);
		Resenias resenia280 = new Resenias("摘l camino de San Diego� (2006), merecid﨎imo Gran Premio del Jurado en el Festival de San Sebasti疣, es el quinto largometraje del argentino Carlos Sorin. Como en la mayor parte de sus trabajos anteriores -忍terna sonrisa en New Jersey� (1989), 滴istorias m匤imas� (2002), 釘omb, el perro� (2004).", "", usuario2, null);
		Resenias resenia281 = new Resenias("Que es el Diego para parte del pueblo argentino. Para esa parte del pueblo separado por la l匤ea de la General Paz del Buenos Aires cosmopolita (aunque tambi駭 ah� tiene sus fans, y muchos), y que define a La Otra, a la Otra Argentina que nunca ha podido demostrarse a si misma que El Dorado exist僘.", "", usuario19, null);
		Resenias resenia282 = new Resenias("A modo de falso documental, se nos presenta a Tati Benitez, un joven animado y jovial, fan疸ico de Maradona. Su vida da un vuelco cuando se queda sin empleo y, casi al mismo tiempo, su 冝olo m痊imo es ingresado en una cl匤ica por un problema card僘co.", "", usuario30, null);
		Resenias resenia283 = new Resenias("Carlos Sorin vuelve a convencer en esta reciente pel兤ula que sigue el esquema de una road movie, como tambi駭 ocurr僘 en 釘omb, el perro�. Y vuelve a utilizar un personaje lleno de dignidad que a pesar de su pobreza disfruta de las cosas de la vida.", "", usuario27, null);
		Resenias resenia284 = new Resenias("Tulio y Susana (Leandro Castello y Mercedes Sc疳ola), un hombre de edad incierta (ｿenvejecido?), deteriorado por su circunstancia, y su sobrina llegan a Buenos Aires desde un pueblo del interior. Acaban de ser empujados del rancho en el que viv僘n, rodeados de gallinas y chivos.", "", usuario22, null);
		Resenias resenia285 = new Resenias("Es interesante encontrarse con un pel兤ula como esta, que en momentos nos lleva a la reflexi; hac僘 rato que no me re僘 con los personajes muy bien elaborados, (tal vez tulio tendr僘 que estar mas envejecido), la fotograf僘 excelente. Por vivir en un pueblo bastante similar a lo que puede se Nogol�, me puedo identificar con partes de la pel兤ula que son tristemente ciertas.", "", usuario36, null);
		Resenias resenia286 = new Resenias("Maravillosa pel兤ula, destaca en todos los rubros, guion, actuaci, direccion, fotograf僘 y m俍ica. Es un compendio de como lograr una pelicular inolvidable. Quiz� perdida en le marem疊num de estrenos no tiene el lugar que se merece, muy cercano a  &quot; Esperando la carroza&quot;, pero con mayores dosis de poes僘.", "", usuario28, null);
		Resenias resenia287 = new Resenias("Un lujo del timming dialogal, de la fuerza y EXPRESION de cada palabra, de cada frase del gui, puestas ah�, sin que sobre ni falte absolutamente nada. CHAPEAU por la expresividad de cada uno de los 3 protagonistas principales.; Clara con su actuaci: MEMORABLE.", "", usuario37, null);
		...
		Resenias resenia300 = new Resenias("Versi del Mart匤 Fierro en animaci, si bien matizada para un p炻lico de menor edad, no se toma demasiadas libertades po騁icas y representa fielmente el poema de Jos� Hernandez. Con dibujos dirigidos por Fontanarrosa, esta trabajada de una manera muy interesante la imagen.", "", usuario7, null);
		...
		Resenias resenia310 = new Resenias("&quot;El 伃timo verano de la boyita&quot; es una peque joya del reciente cine argentino, sobre el tortuoso paso hacia la adolescencia y el despertar sexual, a trav駸 de una historia de amistad diferente y rodada con extremada sensibilidad por Julia Solomonoff (&quot;Hermanas&quot;), con una pareja de nis protagonistas que otorga gran credibilidad a lo que se nos cuenta.", "", usuario31, null);
		...
		Resenias resenia317 = new Resenias("Cautiva, la pel兤ula argentina, es simplemente brillante, una historia dura contada con profundidad, crudeza, y a la vez ternura. La historia de la apropiaci de menores durante la dictadura militar en Argentina ha tenido diferentes relatos, ya sea en forma documental como en otros g駭eros.", "", usuario19, null);
		Resenias resenia318 = new Resenias("Pel兤ula necesaria la de Gast Birab駭 que ahonda en el destino de los hijos de los desaparecidos, y que narra el descubrimiento de la verdad desde la tica de la adolescente protagonista (estupenda B疵bara Lombardo). El mayor m駻ito de la pel兤ula es el punto de vista, que se centra en las v兤timas contempor疣eas de aquella masacre: esos jenes de hoy d僘 a los que se les arrebat� la verdad para crearles una vida ficticia.", "", usuario20, null);
		Resenias resenia319 = new Resenias("Realmente no es una mala pel兤ula... Entonces ｿPor qu� esa nota tan baja?  Porque este tipo de trabajos son tan predecibles que no mantienen la tensi dram疸ica, se sustentan 佖icamente sobre la emocional, de ella se nutren y avanzan.   Cuando veo alguna pel兤ula, serie, corto, me interesa su desarrollo, su planteamiento y.", "", usuario26, null);
		...
		Resenias resenia321 = new Resenias("No s� por qu� hablar siempre so de Hitler cuando EEUU -Kissinger- hizo cosas peores que Mengele. Qu� si no es eliminar una generaci tirando a muchos de ellos desde aviones al mar, -los vuelos de la muerte-  y dar los beb駸 a parejas afines a la dictadura.", "", usuario23, null);
		Resenias resenia322 = new Resenias("Sin duda una pel兤ula para cin馭ilos. Para el que no busque ni acci ni sustos, y que si disfrute de tramas inteligentes. Despu駸 de la original y primera pel兤ula 哲ueve Reinas�, este director y guionista nos trae una historia mucho m疽 relajada, m疽 oscura y con un ritmo bastante m疽 lento, adem疽 de mucho m疽 profunda e inteligente; una trama que va creciendo en intensidad y suspense conforme van pasando los minutos; te mete dentro de la mente del personaje principal (superior interpretaci de Ricardo Dar匤) y no te deja tranquilo en ning佖 momento.", "", usuario22, null);
		...
		Resenias resenia324 = new Resenias("Pel兤ula de suspense, engancha desde el primer momento. La fotograf僘 y el clima que es capaz de generar, lo m疽 destacable. La pareja Dar匤-Bielinsky repite tras &quot;Nueve Reinas&quot;.", "", usuario37, null);
		Resenias resenia325 = new Resenias("Se agradece, y mucho, poder contemplar -de vez en cuando- un thriller que no se desarrolle en un contexto urbanita y, sobre todo, que no se haya rodado en Hollywood. Se agradece muy mucho porque los aficionados al thriller empezamos a estar hasta las mism﨎imas pelotas de que, una y otra vez, nos la metan doblada con peliculillas tan prefabricadas que, a los cinco minutos, ya nos han saturado la mollera con un bombardeo de 電eja vu� absolutamente insoportable.", "", usuario32, null);
		Resenias resenia326 = new Resenias("Quise ir a verla por varios motivos. En primer lugar, le� en esta p疊ina las cr咜icas existentes y todas le daban buena nota, a parte de que contaba con un 8,4 de nota (escribiendo estas l匤eas tiene un 8,2). Tambi駭 influ僘 que la dirig僘 Fabi疣 Bielinsky cuya pel兤ula  &quot;Nueve Reinas&quot; me pareci� soberbia y adem疽, igual que con aquella contaba con un gran actor como Ricardo Dar匤.", "", usuario35, null);
		Resenias resenia327 = new Resenias("La cosa dicen que es as�: Gabriel Medina, el debutante director de Los Paranoicos, supo ser asistente de direcci de Dami疣 Szifr, realizador que perge un par de 騙itos de TV en Argentina luego exportados a Espa: Los Simuladores y Hermanos y Detectives.", "", usuario35, null);
		Resenias resenia328 = new Resenias("Los paranoicos expone un excelente desarrollo de caracteres psicolicos al servicio de una trama tan interesante como sencilla. Hendler cumple un papel m疽 que correcto, la lejan僘/imposibilidad afectiva del personaje est� trazada bajo tonos humor﨎ticos, aunque hay mucho de tragedia ahi detr疽 unida a una cierta melancol僘, un cierto estancamiento.", "", usuario30, null);
		Resenias resenia329 = new Resenias("Entretenida pel兤ula que trata sobre la rivalidad entre dos 殿migos� guionistas. La verdad es que la pel兤ula me ha gustado principalmente, pero luego, hay cierta parte que parece un poco cogida con pinzas� (no puedo seguir, sin destripar parte de la pel兤ula, as� que contin侒 en el spoiler).", "", usuario31, null);
		Resenias resenia330 = new Resenias("Un personaje interesantisimo el protagonizado por Hendler, Gauna, en esta peli, es lo m疽 rescatable de la misma, un personaje lleno de miedos, de excentricidades y de contradicciones. As� vemos, como el mundo al rededor ve a este sujeto, a Gauna, como lo interpretan, como lo burlan, o tratan de entenderlo sobre todo stuart.", "", usuario8, null);
		Resenias resenia331 = new Resenias("Ten僘 gran ilusi en visionar esta pel兤ula Argentina, ya que es un cine bastante interesante y que ha realizado grandes pel兤ulas, y en los aspectos culturales tenemos caracter﨎ticas en com佖, y pienso que es a mi parecer recomendable que nos preocupemos por conocer su cultura, costumbres, ya que en estos momentos convivimos con una poblaci argentina considerable y ser僘 bueno que el hecho de que nos conozcamos no lleve a un mejor entendimiento, y como es sabido la diversidad es enriquecedora.", "", usuario29, null);
		Resenias resenia332 = new Resenias("Muchas de las cr咜icas negativas que recibi� esta pelicula cometen el error de utilizar par疥etros com佖mente utilizados para evaluar pel兤ulas b駘icas. Si bien la guerra es el tema central, el significado pasa por otro lado. Lamentablemente, esto es algo muy claro para un argentino, tal vez tambi駭 para otros latinoamericanos, pero no lo es para otro p炻lico.", "", usuario23, null);
		Resenias resenia333 = new Resenias("Desde el punto de vista puramente cinematrogr畴ico es una pel兤ula humilde, con golpes bajos por momentos innecesarios, elaborada con tes pero con algunas fallas f匀micas grandes y notorias. Pero perd, no puedo dejar de decir algo desde el coraz.", "", usuario28, null);
		Resenias resenia334 = new Resenias("Podr僘 haber sido mejor si no se hubiese hecho la historia mirando con un solo ojo. Como pel兤ula b駘ica hay que tener en cuenta que es Argentina y como tal (presupuesto y efectos especiales por medio) no llega a las alturas de ning佖 filme norteamericano, pero independientemente las escenas b駘icas matizan un poco la pel兤ula.", "", usuario1, null);
		Resenias resenia335 = new Resenias("PREMIOS:San Sebasti疣: Premio Especial del Jurado Premio Goya por mejor pel兤ula extranjera de habla hispana==================HECHOS (por Wikipedia):Los propios ex combatientes de Malvinas han expuesto su desacuerdo con la pel兤ula, que fue presentada como una historia real cuando los hechos parecen indicar que Esteban Leguizam no fue part兤ipe de las acciones como las relata la obra.", "", usuario33, null);
		Resenias resenia336 = new Resenias("http://filmicas.comEn la Buenos Aires de los 70s, Francisco Sanctis desayuna con su familia, camina al trabajo, intenta conseguir un ascenso, termina su d僘 laboral y regresa a casa. Podr僘 haber sido un d僘 rutinario, pero desde el comienzo de &quot;La larga noche de Francisco Sanctis&quot; sentimos que hay algo podrido en alguna parte y que es cuesti de esperar a que se destape.", "", usuario30, null);
		Resenias resenia337 = new Resenias("鼎uesti de principios� combina varias l匤eas narrativas que circulan por los canales de la comedia dram疸ica. Est騁ica y narrativamente, es una pel兤ula convencionalmente cl疽ica, que se parece a los valores que encarna su protagonista principal, un impecable Federico Luppi que apela a su no tan frecuente costado de comediante.", "", usuario26, null);
		...
		Resenias resenia346 = new Resenias("Gran actuaci de Marrales. La pel兤ula va de menor a mayor. Lo 佖ico que he escuchado por ah�, es que la verdadera obra del padre Mario es gigantesca e imposible de resumir en una pelicula de hora y media. Nos quitamos el sombrero ante Doria. Queremos m疽 cine de esta calidad.", "", usuario14, null);
		Resenias resenia347 = new Resenias("La leyenda dice que el ave Fenix resucita de sus propias cenizas. El ciclo interminable de la vida y la muerte. En este caso el ave es reemplazada por la mosca, que puede hundirse y ahogarse en el agua pero la ceniza la devolver� a la vida. La mosca.", "", usuario2, null);
		Resenias resenia348 = new Resenias("V� la pel兤ula &quot;La Mosca En La Ceniza&quot; y es buena pero por momentos no me atrap� mucho.El comienzo me pareci� entretenido y luego atrapante pero me esperaba otra cosa mejor.La historia realista est� bien contada pero se pudo haber mejorado.", "", usuario36, null);
		Resenias resenia349 = new Resenias("Parece que algo va a pasar en cualquier momento. El dolor sostenido de la protagonista es tan fuerte como las im疊enes en blanco y negro inspiradas en Bergman o en el Allen de Interiores. Ese algo que va a pasar es lo que sigue al final de la pel兤ula.", "", usuario10, null);
		...
		Resenias resenia355 = new Resenias("Cine under argentino, simple y contundente. Teniendo fresquito el recuerdo de &quot;La 21, Barracas&quot;, Vikingo se engrandece en la comparaci. Es que de todo lo que La 21 adolesce, Vikingo hace su mayor m駻ito. Vikingo es un personaje craso, rudo, pero mucho m疽 sensible que lo que habr僘 de esperarse.", "", usuario16, null);
		Resenias resenia356 = new Resenias("Me fascina el cine de Lucrecia Martel. Adoro su manera de contar, de filmar, la direcci perfecta que tiene sobre sus actores (es la 佖ica directora que puede hacer actuar a un muerto) su obsesi por contar lo que parece no interesar a nadie. Sus peques grandes historias de su Salta natal.", "", usuario19, null);
		Resenias resenia357 = new Resenias("Vuelta a las andadas de Lucrecia Martel, una directora con un estilo inconfundible: estupendo manejo de la c疥ara, buena fotograf僘, gran direcci de actores, personajes problem疸icos, punto de vista femenino aunque otorgando bastante protagonismo a los personajes masculinos.", "", usuario9, null);
		Resenias resenia358 = new Resenias("Lucrecia Martel es una gran directora, y sus pel兤ulas constituyen exquisito arte. Puro placer est騁ico. Su cine es un cine de climas, de sensaciones. Qu� maravilla que los recursos del cine y el talento de una directora puedan permitir estas composiciones.", "", usuario20, null);
		Resenias resenia359 = new Resenias("Apadrinada por los hermanos Almodar, la argentina Lucrecia Martel ambienta su segunda pel兤ula &quot;La Ni Santa&quot; en un hotel donde se celebra un congreso de medicina y donde conviven unas adolscentes que reciben adoctrinamiento religioso.", "", usuario25, null);
		...
		Resenias resenia364 = new Resenias("Empecemos por decir que efectivamente el cine argentino es obviamente  argentino, por eso es un cine especial y muy particular: Veamos, si a esta pel兤ula se hiciera en Francia, ser僘 de arte y ensayo, se recorta la base de humor, se aumenta el drama, diciendo lo mismo pero de manera m疽 acad駑ica  y voil� tendr僘mos una pel兤ula para el fog de Cannes.", "", usuario4, null);
		Resenias resenia365 = new Resenias("Siempre me he preguntado porqu� no queremos que nuestros amigos cambien y sin embargo, tratamos de cambiar a nuestros amantes. ｿSignifica que respetamos m疽 la personalidad de nuestros amigos? ｿO de que en realidad idealizamos a nuestros amantes y a nuestros amigos los vemos tal y como son desde un princpio?.", "", usuario29, null);
		...
		Resenias resenia375 = new Resenias("Si, tiene un arranque bastante bueno y la relaci padre-hijo tiene muchos matices, pero en general la pel兤ula me pareci� falta de vida, sosa y reiterativa. Por su tono tan fr卲 me es dif兤il emocionarme con ella, porque ni funciona como comedia ni como drama, y si lo hace, aunque, a medias, es como an疝isis en torno a las relaciones de pareja, la madurez y el paso del tiempo.", "", usuario10, null);
		Resenias resenia376 = new Resenias("El asaltante parece un fragmento de otra pel兤ula mayor. Todos sabemos co se estructura  una pel兤ula tipo; 駸ta se divide en tres partes: presentaci, nudo y desenlace. Pues imaginen una pel兤ula diseccionada sobre la mesa de edici. Tomamos la presentaci y la arrojamos a la basura, tomamos el desenlace y hacemos lo mismo: nos quedamos so y exclusivamente con el nudo.", "", usuario27, null);
		Resenias resenia377 = new Resenias("Cabe recordar, que a partir de manifiestos como el Ulises de James Joyce, el esquema 疸ico 菟resentaci-nudo-desenlace� ha sido despojado de su primado y puesto en paridad. Es solamente un modo del ser, no uno de sus trascendentales. De manera que, corroer una trama por sospechar que se consuma nudamente, como pulpa expuesta, sin las tapas, sin el pecho y el rabo de uso, no es m疽 que consumar un juicio epocalmente impropio.", "", usuario32, null);
		Resenias resenia378 = new Resenias("La acci transcurre pr當ticamente en tiempo real. El protagonista es un ladr de guante blanco que roba colegios privados sin disparar un so tiro, interpretado por Arturo Goetz, con el porte necesario para pasar desapercibido ante sus v兤timas.", "", usuario34, null);
		...
		Resenias resenia380 = new Resenias("Es cruda. Un ba de humildad. Es lo que nos espera.David Burgos interpreta magistralmente su papel.Es darwinismo social, solo los m疽 fuertes sobreviven y el ejemplo: &quot;Per�&quot; es el buscavidas perfecto pero.... por encima de 駘 est� la mujer, Yekaterina, con sus artes (con sus armas) lo lleva al huerto y consigue sobrevivir a su costa.", "", usuario17, null);
		...
		Resenias resenia383 = new Resenias("Confieso que he esperado esta pel兤ula con mucha expectativa. Me predispuse de la mejor forma para degustarla pero finalizada la misma el paladar me quedo adormecido, como despu駸 de masticar hielo. La pel兤ula no es mala, es cierto, pero promet僘 mucho m疽.", "", usuario21, null);
		Resenias resenia384 = new Resenias("A priori, se podr僘 ubicar a este film dentro del mismo g駭ero que 釘elgrano: la pel兤ula� ya que en ambos casos se trata de reconstruir una parte de la historia de nuestro pa﨎 pero con un enfoque basado en la personalidad del personaje principal, Jos� de San Mart匤 en este caso.", "", usuario5, null);
		...
		Resenias resenia389 = new Resenias("Lo siento, pero despu駸 de ver tanto cine bueno (dentro de la propia Argentina, adem疽) no me vale con un pudo de moralinas y cuatro escenas cicas para decir que algo es, por lo menos, interesante. La parte inicial de la pel兤ula es ramplona y est� mal sujeta por el elenco joven que la interpreta, y aunque es verdad que el gui se va entonando y al final hasta consigue enternecer un poco al espectador, lo cierto es que eso no es suficiente para salvar la pel兤ula.", "", usuario20, null);
		Resenias resenia390 = new Resenias("Me pareci� una pel兤ula bastante ocurrente para ser argentina... Me gust� mucho el lazo que se genera entre el pibe y el fantasma, quien parece ser muy rudo, pero al final se termina quebrando ante las situaciones que no supo ver y que se entero muchos as despu駸.", "", usuario33, null);
		Resenias resenia391 = new Resenias("Este cuarto largometraje de la realizadora Mar僘 Victoria Menis es una bienaventurada rareza en el cine argentino actual, no so porque prescinde de actores conocidos pero que igualmente demuestran un sido oficio forjado en el teatro independiente, sino por su apuesta tem疸ica y narrativa, a contracorriente de buena parte de la producci nacional.", "", usuario1, null);
		Resenias resenia392 = new Resenias("Mar僘 Cristina Menis demuestra co se hace un excelente cine a partir de una historia aparentemente sencilla. &quot;La c疥ara oscura&quot; es una pel兤ula de esas que hay ver nueva vez. De manera sutil te va llevando a un reconocimiento de los valores esenciales del ser, a mirar con ojos atentos lo importante de este mundo.", "", usuario3, null);
		Resenias resenia393 = new Resenias("Pel兤ula un tanto especial, de ritmo pausado y tono intimista, con muy pocos di疝ogos. Y aunque no es para nada aburrida, para m� el hecho de que haya tan pocos di疝ogos  hace que sea algo fr僘 y distante. Me hubiera gustado saber m疽 cosas de Gertrudis, su protagonista:  qu� siente, qu� desea hacer, qu� est� pensando, por qu� no se rebela.", "", usuario11, null);
		...
		Resenias resenia400 = new Resenias("Termin� de ver &quot;M僘&quot; con la sensaci incomparable de haber asistido a un espect當ulo maravilloso. M疽 all� de su mirada social y de su profundo compromiso art﨎tico, &quot;M僘&quot; resume el encanto de las cosas bien hechas. Un gui contundente, unas actuaciones a medida y una sensibilidad que se desprende de su piel como un ejercicio m疊ico.", "", usuario8, null);
		Resenias resenia401 = new Resenias("El asadito trata de unos amigos que se re佖en para comer el 30 de Diciembre de 1999. La acci transcurre en la ciudad de Rosario, Argentina. Cada uno de los personajes encarna un cierto rol muy delimitado, sin demasiada profundidad y en algunos casos de manera un tanto histriica.", "", usuario31, null);
		Resenias resenia402 = new Resenias("Los siete amigos que vemos en este film tienen algo en com佖. Nacieron entre las d馗adas del 60/70. Llegado el d僘 del rodaje, en 1999, ya varios pelan canas, arrugas, miradas de desencanto y un considerable camino andado por sus respectivas vidas.", "", usuario7, null);
		Resenias resenia403 = new Resenias("Cuando vi el t咜ulo, le� la trama y conoc� su duraci me dije, tengo que ver esta pel兤ula. No me defraud�, un film interesante y que ayuda a pasar el rato. Las actitudes, gestos, palabras son para m� (argentino) conocidas y por ello m疽 de una vez graciosas.", "", usuario26, null);
		...
		Resenias resenia405 = new Resenias("Con lo que se gasta una europea en venir desde su pa﨎 hasta Argentina, la estancia larga ah� y luego el pago por llevarse un beb� (todo de manera ilegal y tratando con desalmados  intermediarios cuyo negocio es la venta de seres humanos), es decir unos 30.", "", usuario36, null);
		Resenias resenia406 = new Resenias("Interesante peli argentina sobre la adopci ilegal de nis, tr畴ico de lo m疽 espinoso porque nadie garantiza las buenas intenciones del 田omprador� (al que no se le hacen demasiadas preguntas cuando desembolsa la friolera de 20 o 30.000 euros por un ni), de manera que pueden acabar siendo pasto de la prostituci infantil o la venta de ganos.", "", usuario12, null);
		Resenias resenia407 = new Resenias("Con la intenci de desocultar una realidad que muchos no conocen, Juan Solanas (ver spoiler), elige un tema doloroso y encubierto en la Argentina: el tr畴ico de nis vinculado con la adopci ilegal pero tambi駭 con el negocio de ganos y la prostituci infantil.", "", usuario33, null);
		Resenias resenia408 = new Resenias("Nordeste trata el tema de la adopci internacional de nis, en este caso en Argentina, y sigue las peripecias de una ejecutiva francesa soltera y de mediana edad en su b俍queda de un beb�. Formar僘 una buana trilog僘 con La Casa del los Babys de John Sayles y la m疽 reciente La Peque Lola de Bertrand Tavernier, pero se distancia de ellos en la forma de contar la historia, muy pausada y sin hacer part兤ipe a la c疥ara de la intensidad emocional que vive los personajes (en contraste con el exceso de c疥ara en mano del que hac僘 uso Tavernier).", "", usuario10, null);
		Resenias resenia409 = new Resenias("Es el nordeste argentino, lugar donde est� contextualizada la era prima de Juan Solanas, una de las regiones m疽 deprimidas del pa﨎 sudamericano. Esta descarnada historia, que bebe del realismo social m疽 aguerrido, denuncia sin paliativos ni edulcorantes la adopci ilegal de infantes en las zonas m疽 depauperadas del globo.", "", usuario0, null);
		Resenias resenia410 = new Resenias("&quot;No sos vos, soy yo&quot; o lo que es lo mismo; &quot;no eres t�, soy yo&quot;; es una frase tan vieja como habitual en el d僘 a d僘 de la especie humana. Hoy le toca al amigo, mana al vecino y pasado te toca a ti. Y Taratuto sin duda sabe de qu� est� hablando.", "", usuario7, null);
		Resenias resenia411 = new Resenias("En el ranking de las tres frases m疽 jodidas que puede decirte el amor de tu vida est疣 las que siguen:- &quot;Tenemos que hablar&quot;.- &quot;Eres como un hermano/a para m�&quot;- &quot;S�, me lo he follado&quot;.", "", usuario25, null);
		Resenias resenia412 = new Resenias("Qu� condenadamente jodidas pueden ser las relaciones. Lo realmente malo es que tenemos la man僘 de ilusionarnos, de empezar a pensar en mana. El ser humano tiene la est侊ida obsesi de creer que, en cuanto alguien le ofrece unas migajas, ya sus manos van a pasear unidas por los oleajes del tiempo durante toda la eternidad.", "", usuario10, null);
		Resenias resenia413 = new Resenias("En esta opera prima de Juan Taruto la historia es todo un drama, pero el gui le da un delicioso clima de comedia que el director saca adelante con altas dosis de iron僘, agilidad y, por supuesto, humor. Presentar el terrible conflicto del protagonista con una sonrisa es el gran m駻ito de este trabajo.", "", usuario36, null);
		Resenias resenia414 = new Resenias("De las pocas pel兤ulas, que yo recuerde, cuyo tema principal sea el amor-desamor, que me haya gustado, tal vez por el tono tragicico que derrocha, o por lo entrable del protagonista o por todo en general.Una muestra mas de la calidad del cine Argentino.", "", usuario29, null);
		...
		Resenias resenia417 = new Resenias("Las crisis por decreto de intereses es el modus vivendi con el que las 伃timas generaciones en Latinoam駻ica hemos sido acondicionadas, irremediablemente conferidas de nacimiento. Ac� las crisis algunos las viven, otros la soportan y la mayor僘 las sufre.", "", usuario30, null);
		Resenias resenia418 = new Resenias("La novelista y directora argentina Luc僘 Puenzo se caracteriza por abordar temas que atraviesan la biolog僘 y la sexualidad en la adolescencia, con un punto de vista que rescata lo natural y espont疣eo de esa etapa de cruce hacia el mundo adulto, tal como se evidencia en sus pel兤ulas anteriores como 店XY� o 摘l Ni Pez.", "", usuario3, null);
		Resenias resenia419 = new Resenias("Realmente me hubiera gustado ponerle m疽 puntaje a esta peli, porque est� muy bien filmada, tiene actuaciones solidas y un tema m疽 que atrayente. Pero resulta la verdad que sal� del cine con una sensaci de gusto a poco y, despu駸 de rumiar un rato m疽, la sigo teniendo.", "", usuario36, null);
		Resenias resenia420 = new Resenias("Tercera pel兤ula de la directora argentina Luc僘 Puenzo, que adapta su propia novela, que a su vez se basa en la historia real de Josef Mengele: un despiadado criminal Nazi, que tras la Segunda Guerra Mundial se refugio en Sudam駻ica, donde continuo con sus experimentos en animales y nis.", "", usuario22, null);
		...
		Resenias resenia422 = new Resenias("Con una destacable realizaci y unas interpretaciones que sostienen la trama, el &quot;M馘ico alem疣&quot; quiz疽 adolece de querer ser demasiado sutil en el desarrollo del suspense. Tanto que roza la p駻dida del inter駸 del espectador en algunos momentos.", "", usuario2, null);
		Resenias resenia423 = new Resenias("Hay una mancha de humedad en tu departamento, puedes hacer de cuenta que no est� all� pero, como dice el dicho, &quot;acu駸tate con chicos y amanecer疽 mojado&quot;.Lo sorprendente de La mala verdad es su capacidad para implotar, en vez de explotar.", "", usuario3, null);
		...
		Resenias resenia439 = new Resenias("La flamante remake del cl疽ico de Daniel Tinayre , realizado en 1960, justifica la actualizaci de su propuesta, que incorpora la actualidad de su propio tiempo y a su vez interpela hasta qu� punto nos hemos desacostumbrado a los dilemas 騁icos y su consecuente dial馗tica para defender ideas y consecuencias.", "", usuario11, null);
		Resenias resenia440 = new Resenias("La pel兤ula de Mitre es un profundo despropito. Pretende hacer un an疝isis moral de la sociedad occidental pero para ello utiliza un gui poco o nada cre兊le. La pel兤ula no desgrana las motivaciones que conducen a los actos de la protagonista.", "", usuario35, null);
		Resenias resenia441 = new Resenias("Estamos ante un retrato poderoso de un personaje femenino que marca su independencia, que se enfrenta a su padre y a su novio, se rebela contra una previsible carrera exitosa en la judicatura y se revuelve contra las decisiones que otros toman por ella, colisionando con los convencionalismos al uso y demostrando que la integridad moral no conoce de v匤culos afectivos, ni de servilismos trasnochados, ni de sumisiones t當itas o expresas.", "", usuario27, null);
		Resenias resenia442 = new Resenias("En su segundo largometraje 勃n remake de ｫLa patotaｻ de Daniel Tinayre�, el argentino Santiago Mitre construye un drama de gran fuerza emotiva que se sostiene completamente sobre los hombros de su complejo personaje protagonista, Paulina, una joven idealista que ser� v兤tima de una violaci.", "", usuario34, null);
		Resenias resenia443 = new Resenias("Hermos﨎ima pel兤ula. Endemoniadamente compleja, interesante y bien hecha.Todos sabemos que las grandes causas, los idearios bellos, los discursos al viento, todo el entramado de frases, sentencias, normas, leyes, derechos..., y dem疽 reglas del juego son, en la medida en que se acercan a la cruda realidad, no m疽 que un p疝ido reflejo de su celestial intenci inicial.", "", usuario31, null);
		Resenias resenia444 = new Resenias("Un treintearo, que hace 10 as era un joven que viv僘 al d僘, so pensando en s� mismo y sin importarle lo que pensara la gente, se encuentra con una extra situaci:ahora que ya tiene su vida hecha pero contin俉 inseguro en sus relaciones, resulta que una ni de 10 as le hace descubrir que la vida puede tener otro sentido menos fr咩olo y m疽 gratificante.", "", usuario7, null);
		Resenias resenia445 = new Resenias("Nacionalidad: argentina. Los argentinos no dejan de sorprender con su cine, ya sea comedia, construyendo historias al uso o con este cine pausado. Rub駭 es un camionero que viaja de Paraguay a Buenos Aires, 1500 km. En este viaje, por petici de su jefe, debe llevar con 駘 a una mujer paraguaya, Jacinta, que adem疽 va acompada de su beb�, una nita sorprendente.", "", usuario16, null);
		Resenias resenia446 = new Resenias("Entrable y optimista pel兤ula capaz de hacernos recordar  que siempre se puede volver a empezar, que no todo es igual per secula seculorum. Es una pel兤ula radical en su desarrollo, no da concesiones a la galer僘, pero por la fuerza de sus im疊enes y el tratamiento de las situaciones y personajes,  logra que te llegues a  sentirte dentro de esa cabina, a sentir y comprender los sentimientos de los dos personajes adultos, a deleitarte con la alegr僘 de vida de la beba tan indiferente 朴or otra parte- a lo que ocurre en esa cabina de cami.", "", usuario4, null);
		Resenias resenia447 = new Resenias("Mientras transcurr僘 la pel兤ula me lo pregunt� varias veces: ｿCo una pel兤ula puede ser lenta, con pocos di疝ogos, sin m俍ica y  con planos fijos y, sin embargo, generar una sensaci de incomodidad, de tensi constante?ｿCo pueden tres personajes que hablan muy poco (o nada) meterse adentro del coraz del espectador y lograr que uno se sienta identificado con ellos?La respuesta: as�.", "", usuario35, null);
		Resenias resenia448 = new Resenias("Aunque esta pel兤ula no desprenda el nivelazo al que me tiene acostumbrada el cine argentino, se trata igualmente de una historia agradable de ver. Transcurre de manera sosegada (quiz� demasiado). Los actores estan muy bien y basicamente podemos intuir el resurgir de un sentimiento escondido, el deseo de volver a estar en compaa, querer y ser querido.", "", usuario33, null);
		Resenias resenia449 = new Resenias("Para los qu� amamos el cine de Sorin, para los que disfrutamos de las 塗istorias m匤imas�, Las Acacias, era prima de Pablo Giorgeli, es una caricia, es una joya qu� el cine nos regala y es un lujo del qu� no debemos privarnos.Las Acacias, ganadora de la c疥ara de oro en el festival de Cannes mejor era prima, es una road movie en la cual hacemos el trayecto de la frontera con Paraguay hasta Buenos Aires, es un recorrido, como cualquiera.", "", usuario17, null);
		Resenias resenia450 = new Resenias("Soy argentino, pero si no lo fuera, o si fuera un argentino de los tantos que so leen las p疊inas de deportes de los diarios y mira notas policiales por TV, y me encontrara por casualidad con la sinopsis de esta pel兤ula dir僘: ni loco voy al cine a ver eso.", "", usuario34, null);
		Resenias resenia451 = new Resenias("El infaltable azar vincula las diferentes historias de Ezequiel (Peretti) y Paula (Oreiro), cuya relaci empezar� mucho m疽 cercana al odio que al amor a primera vista: el personaje central es un compositor de m俍ica para pel兤ulas, moment疣eamente falto de inspiraci, que atraviesa un reciente divorcio y problemas econicos apremiantes.", "", usuario27, null);
		Resenias resenia452 = new Resenias("Seguramente mi desconocimiento del cine argentino, que no va mas all� de las siempre entretenidas y las mas de las ocasiones divertidas comedias que son estrenadas en Espa y aquellos desfases de Alberto Olmedo y Jorge Porcel  que nos llegaron en los 80 a los videoclubs patrios (con gran acogida por parte de la clientela, as� era y as� lo cuento) me impidan analizar con mas conocimiento esta pel兤ula.", "", usuario4, null);
		Resenias resenia453 = new Resenias("Dos situaciones iniciales, dos urgencias, cicamente desesperadas -la de un hombre y la de una mujer- que inopinadamente se agarran el uno al otro para ayudarse, casi a contrapelo,  y de ah� va naciendo al mismo tiempo , va fluyendo la cosa, a trancas y barrancas, con muchas complicaciones, pero fluyendo, hacia la musica cumplida y el amor que se hace y el ni que nace.", "", usuario28, null);
		...
		Resenias resenia455 = new Resenias("Vista en perspectiva histica de su estreno en el 2004 pocas veces en Argentina se hab僘 aventurado al g駭ero de la comedia romantica. Pero con El amor (Primera Parte) se llega a un g駭ero que en comparaci a posteriores pel兤ulas como las de Juan Taratuto (especialmente) es m疽 de un estilo de ensayo sobre el amor, con elementos de una historia de ficci suaves tamizadas por momentos de lecciones acerca de la experiencia del amor desde un punto de vista cientificista, racional que sirve esto 伃timo para darle un toque de humor, para sazonarla y descubrir su divague intelectual de estos cuatro directores.", "", usuario26, null);
		Resenias resenia456 = new Resenias("No voy a hacer una cr咜ica detallada. So voy a decir que la vi hace poquito y me hizo acordar mucho a Blue Valentine y a 500 D僘s juntos (500 Days with Summer). Un poco me indign� el parecido, ya que ambas me hab僘n gustado, pero esto ya me parec僘 una copia.", "", usuario31, null);
		...
		Resenias resenia459 = new Resenias("Al margen de sus valores cinematogr畴icos, tal vez el principal m駻ito de esta pel兤ula sea el de introducir al espectador en el fascinante -y para muchos supongo que exico- mundo del Zen. Y lo hace sin rubor, sus personajes tienen inquietudes espirituales (ｿespiri.", "", usuario29, null);
		...
		Resenias resenia462 = new Resenias("La directora Natalia Smirnoff debuta en la direcci con la pel兤ula Rompecabezas, que paso con una buena acogida por parte de la cr咜ica en el pasado Festival de Cine de Berl匤, aunque finalmente se quedara sin premio. Y la verdad es que viendo la sencillez y la sutileza con la que Smirnoff afronta su primera pel兤ula, de la que tambi駭 es guionista, solo cabe esperar con ganas su siguiente proyecto.", "", usuario4, null);
		Resenias resenia463 = new Resenias("ｿDe qu� excepci hablo?..... De la que dice que todo nel director de cine argentino har� de su era prima un presuntuoso, olvidable, incoherente, esperp駭tico y mediocre canto a la pavada seudoculturosa.  En el presente caso Natalia Smirnoff nos da una obra l昱ida, personal, profundamente imbu冝a de la genial sensibilidad femenina, no atada a los moldes habituales de los egresados de la escuela de cine argentina donde se les inculca que son cr厓ticos artistas (destinados a despoblar las salas de cine).", "", usuario18, null);
		Resenias resenia464 = new Resenias("Cuando encontr� ese t咜ulo entre varias pel兤ulas en el armario de mi hermano, me fascin� la sencillez del t咜ulo. Y a partir de all� me sumerg� en el mundo de una mujer tan simple y compleja que nos lleva a conocer una pasi que ejerce con real entusiasmo.", "", usuario20, null);
		...
		Resenias resenia496 = new Resenias("Agradable sorpresa la que depara esta era prima de Rosendo Ruiz, proveniente de la docta ciudad de Cdoba, Argentina, aunque no sean sus conocidas catedrales ni otros 兤onos promocionados por el turismo comercial los que muestra, sino el entorno marginal de boliches cuarteteros, clubes barriales y calles salvajes donde pululan todo tipo de personajes que bien podr僘n encabezar el ranking de una genuina picaresca nacional actualizada.", "", usuario6, null);
		Resenias resenia497 = new Resenias("El entusiasmo desmedido con el que me acerqu� a &quot;De Caravana&quot; jug� en contra. La cr咜ica la destacaba como la pel兤ula m疽 festiva del 2011 en Argentina, lo cual no me parece tan errado. Ahora...no me ocurre lo mismo con el comentario de &quot;una de las mejores pel兤ulas del a en Argentina&quot;.", "", usuario13, null);
		...
		Resenias resenia514 = new Resenias("Ni Dios, ni patr, ni marido es una historia generada a partir de un personaje real, Virginia Bolten (1870-1960?), redactora de la primera publicaci feminista latinoamericana denominada 鏑a voz de la mujer�, cuyo lema era 哲i Dios, ni patr ni marido�, que durante 9 n伹eros (editados en la clandestinidad entre 1896 y 1897), di� una perspectiva anarcofeminista en la defensa de los derechos elementales de la mujer y los trabajadores.", "", usuario2, null);
		Resenias resenia515 = new Resenias("He de confesar que suelo ser bastante esc駱tico ante cualquier pel兤ula revisionista, de corte pol咜ico o de trasfondo histico y ante la visi de 駸ta, y que no me pasase como con &quot;Las Hurdes&quot;, prefer� documentarme antes y, efectivamente, salvo alg佖 nimio detalle est� p伃cramente construida.", "", usuario6, null);
		Resenias resenia516 = new Resenias("Dec僘 el pianista Franz Listz que 鏑a m俍ica es el coraz de la vida. Por ella habla el amor, sin ella no hay bien posible y con ella todo es hermoso� Una frase que cala muy hondo en el director Gabriel Nesci, que nos presenta en su primer largometraje una historia que habla de m俍ica, de amor, de amistad, de belleza y de vida.", "", usuario7, null);
		...
		Resenias resenia524 = new Resenias("Pel兤ula digna de verse, por todo lo que contiene: la atracci entre distintos sexos, la necesidad e incluso el amor entre un hombre y una mujer maduros y bastante solos, el romanticismo y la burocracia que conlleva la conquista amorosa.De hecho, la simbolog僘 del frasco es enorme: un frasco es algo endeble, de cristal, fr疊il como el amor, puede guardar dentro cosas importantes pero igualmente puede quebrarse al m疽 m匤imo descuido.", "", usuario1, null);
		Resenias resenia525 = new Resenias("Los primeros minutos de la peli se me hicieron algo lentos , incluso llegue a temer por no haber acertado con ella, pero la historia va creciendo y me fue atrapando  sin saber muy bien porqu�, y de repente me encontr� con dos lagrimones bajando por mi cara y con una sonrisa de esas que se llaman de ternura y todo gracias a dos pedazos de actores como Dario Grandinetti y Leticia Br馘ice que hacen de una pelicula modesta una peque obra maestra .", "", usuario31, null);
		Resenias resenia526 = new Resenias("Una cinta intimista muy sencilla donde la apuesta m痊ima pasa por el trazado dentro del argumento de exc駭tricos personajes. Es un filme donde todo tipo de an疝isis riguroso de la calidad intr匤seca de la obra cae a pedazos ante las ocurrentes situaciones m匤imas que est疣 repletas de enredos jocosos.", "", usuario22, null);
		Resenias resenia527 = new Resenias("Esta pel兤ula, adem疽 de entretener con una bonita y algo extravagante historia de un frasco, nos muestra a un hombre extremadamente t匇ido. No recuerdo ninguna pelicula en la que el principal personaje fuera tan t匇ido y adem疽 se tratara con esta mezcla de humor y cari como lo ha hecho Lecchi.", "", usuario26, null);
		Resenias resenia528 = new Resenias("En pel兤ulas anteriores, Carnevale hab僘 abordado temas m疽 o menos espinosos, como el amor en la tercera edad (摘lsa &amp; Fred�), la orfandad de los discapacitados (鄭nita�) y la infidelidad (天iudas�), donde supo tamizar los puntos 疝gidos con una cuota de humor.", "", usuario19, null);
		Resenias resenia529 = new Resenias("La idea es buena. Parte de una base de comedia en la que el tema principal es una cr咜ica hacia la hipocres僘 de la sociedad, a sus prejuicios y a sus c疣ones de belleza preestablecidos.Todo dentro de un marco de humor respaldado por buenas actuaciones.", "", usuario10, null);
		...
		Resenias resenia532 = new Resenias("ｿVale la pena verla? Yo creo que s�. Una pel兤ula que te hace re叝, emocionar y que da elementos para pensar ya vale la pena. ｿTiene fallas? Algunas s�, es un poco previsible, la m俍ica es demasiado protagonista. Pero las actuaciones son Excelentes, muy buenos trabajos de todos los actores, da gusto ver co desarrollan sus personajes.", "", usuario33, null);
		Resenias resenia533 = new Resenias("Es la historia de varias peques historias de peques personajes de la gran urbe de Buenos Aires, que se llegan a cruzar de alguna manera y en alg佖 momento, con el trasfondo evidente de la terrible crisis econica reciente de nuestros hermanos argentinos.", "", usuario11, null);
		Resenias resenia534 = new Resenias("Historias que se encuentran en 駸e cruce com佖 a todos que es la b俍queda de amar y ser amado, de escuchar y de que te escuchen.Con el trasfondo com佖 a varios de sus trabajos, el judaismo, Burman hace un retrato de personajes en constante b俍queda, cre兊les y humanos.", "", usuario35, null);
		Resenias resenia535 = new Resenias("Daniel Burman empieza a alinearse en las peliculas de autor con Esperando al Mesias. De la misma manera que sus personajes en sus pel兤ulas (posibles alter ego) el busca su propia manera de filmar, su tem疸ica, su toma de posici ante la cuesti y la identidad argentina .", "", usuario16, null);
		Resenias resenia536 = new Resenias("Burman es un director a tomar en cuenta. Ya nos sorprendi� en &quot;Derechos de familia&quot;. Es un director que sabe tratar &quot;esa dura condici humana&quot;. Hace que revisemos, nos invita a eso...", "", usuario6, null);
		Resenias resenia537 = new Resenias("Vi la pel兤ula porque soy fan de Sbaraglia y me encantan todas sus pelis, pero en cuanto vi a Norma Aleandro me quede totalmente impresionado. Es la primera vez en mi vida que me entran ganas de llorar con cada escena que tiene una actriz, da igual lo que est� haciendo.", "", usuario28, null);
		...
		Peliculas pelicula2 = new Peliculas("El hijo de la novia",2001,"",124,"Rafael dedica 24 horas al d僘 a su restaurante, est� divorciado, ve muy poco a su hija, no tiene amigos y elude comprometerse con su novia. Adem疽, desde hace mucho tiempo no visita a su madre, internada en un geri疸rico porque sufre el mal de Alzheimer. Una serie de acontecimientos inesperados le obligan a replantearse su vida. Entre ellos, la intenci que tiene su padre de cumplir el viejo sue de su madre: casarse por la Iglesia.",0,"imgs/peliculas/2.jpg","",actorespelicula,director0,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula6 = new Peliculas("El ciudadano ilustre",2016,"",118,"Es la historia de un escritor argentino, Premio Nobel de Literatura, que hace cuarenta as abandon� su pueblo y parti� hacia Europa, donde triunf� escribiendo sobre su localidad natal y sus personajes. En el pico de su carrera, el alcalde de ese pueblo donde naci� le invita para nombrarle &quot;Ciudadano Ilustre&quot; del mismo, y 駘 decide cancelar su apretada agenda y aceptar la invitaci.",0,"imgs/peliculas/6.jpg","",actorespelicula,director5,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula24 = new Peliculas("Leonera",2008,"",113,"Julia (Martina Gusman) es una joven acusada del asesinato de su novio. Aunque las circunstancias del crimen no est疣 claras, acaba ingresando en prisi. Abatida y embarazada deber� adaptarse a su nueva vida en la c疵cel, donde nacer� su hijo Tom疽...",0,"imgs/peliculas/24.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula25 = new Peliculas("Aniceto",2008,"",82,"Aniceto (Hern疣 Piqu匤) es un hombre solitario que vive con su gallo en un pueblito de Mendoza. Francisca (Natalia Pelayo) es una chica ingenua que llega al lugar en busca de trabajo. Se conocen y se enamoran. Parece un sue, pero termina en pesadilla cuando aparece la enigm疸ica e irresistible Luc僘 (Alejandra Baldoni), su nueva vecina, que perturba al hombre y lo arrastra a su propia destrucci.",0,"imgs/peliculas/25.jpg","",actorespelicula,director18,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula29 = new Peliculas("El artista",2008,"",91,"Jorge (Sergio P疣garo) es un enfermero que pasa de cuidar ancianos en un geri疸rico a convertirse en el nuevo ni mimado de la escena art﨎tica bonaerense. Tras presentar como propias unas pinturas de uno de los ancianos, su vida simple y monona se transforma de repente en un constante peregrinar por galer僘s de arte, universidades, programas de televisi, y reuniones con artistas e intelectuales.",0,"imgs/peliculas/29.jpg","",actorespelicula,director5,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula33 = new Peliculas("Al final del t佖el",2016,"",120,"Joaqu匤 est� en silla de ruedas. Su casa, que conoci� tiempos mejores, ahora es l彅ubre y oscura. Berta, bailarina de striptease, y su hija Betty, llaman a su puerta respondiendo a un anuncio que puso Joaqu匤 para alquilar una habitaci. Su presencia alegra la casa y anima la vida de Joaqu匤. Una noche, mientras trabaja en su sano, Joaqu匤 escucha un ruido casi imperceptible.",0,"imgs/peliculas/33.jpg","",actorespelicula,director24,reseniaspelicula,usuario,genero0, true);
		...
		Peliculas pelicula35 = new Peliculas("Whisky Romeo Zulu",2004,"",107,"Whisky Romeo Zulu narra la historia previa al accidente del Boeing 737 de LAPA que, el 31 de agosto de 1999, se incendi� tras impactar contra un terrapl駭 en pleno centro de Buenos Aires, provocando la muerte de 67 personas. La cat疽trofe cambi� la historia de la aviaci civil y comercial en Argentina, y la pel兤ula relata, desde la tica del director -un ex piloto de l匤eas a駻eas- co en algunos pa﨎es la seguridad de los vuelos es incre兊lemente precaria.",0,"imgs/peliculas/35.jpg","",actorespelicula,director26,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula36 = new Peliculas("El patr, radiograf僘 de un crimen",2014,"",99,"El patr, radiografia de un crimen, se enfoca en un hecho criminal real sobre un hombre rural que llega a Buenos Aires en busca de trabajo y termina explotado por un siniestro patr que lo obliga a vender carne podrida y que lo somete a una verdadera esclavitud, en el coraz de la Ciudad de Buenos Aires y en el siglo XXI.",0,"imgs/peliculas/36.jpg","",actorespelicula,director27,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula37 = new Peliculas("El polaquito",2003,"",92,"Un chico de la calle, de 13 as de edad, se gana la vida cantando tangos en los trenes de la estaci central de Buenos Aires. Imita a Polaco Goyeneche, el famoso cantante de tangos, por lo que la gente le conoce como &quot;El Polaquito&quot; (Abel Ayala). El Polaquito conoce a &quot;Pelu&quot; (Marina Glezer), una joven prostituta que tambi駭 trabaja en la estaci de Constituci, de la cual queda inmediatamente prendado y a la que intenta rescatar de la mafia que la explota.",0,"imgs/peliculas/37.jpg","",actorespelicula,director28,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula40 = new Peliculas("Las mantenidas sin sues",2005,"",88,"Una madre que no sabe qu� hacer con su hija. Eugenia, su hija, s� sabe qu� har僘 siendo madre. Olga, ｿuna vecina o parte de la familia? Celina, ｿcrisis vocacional o vocaci de moda? Sara, ｿabuela o marido? Lola, ｿse qued� sin nada o nunca tuvo? Aqu� ninguna puede nada sola. Juntas pueden llegar a sor aunque sea algo.",0,"imgs/peliculas/40.jpg","",actorespelicula,director30,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula41 = new Peliculas("La suerte est� echada",2005,"",99,"Comedia que habla de la suerte, del destino y del afecto de dos hermanastros muy diferentes, que han vivido distanciados durante as. Es su padre quien los vuelve a unir en una circunstancia muy particular.",0,"imgs/peliculas/41.jpg","",actorespelicula,director31,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula44 = new Peliculas("El clan",2015,"",110,"La historia se basa en el caso policial del Clan Puccio, que conmocion� a la sociedad argentina a principios de los 80. Tras la aparente normalidad de la familia Puccio se oculta un siniestro clan dedicado al secuestro y al asesinato. Arqu匇edes, el patriarca, miembro del Servicio de Inteligencia desde la dictadura, lidera y planifica las operaciones.",0,"imgs/peliculas/44.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero0, true);
		...
		Peliculas pelicula52 = new Peliculas("El bonaerense",2002,"",99,"EL Zapa es cerrajero en un pueblo peque de la Provincia de Buenos Aires. El pueblo es tranquilo, trabajo de cerrajer僘 hay muy poco y las horas de trabajo pasan lentamente. El Polaco, el due del local lo env僘 a abrir una caja fuerte en una oficina. Al d僘 siguiente cae preso como responsable del robo al lugar. Su t卲 Ismael, polic僘 Bonaerense retirado, lo saca de la comisar僘 y lo env僘 al Gran Buenos Aires con una carta de recomendaci.",0,"imgs/peliculas/52.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula56 = new Peliculas("Nueces para el amor",2001,"",103,"En 1975, unos meses antes del comienzo de la dictadura militar argentina, Alicia y Marcelo se conocen en un concierto de rock. El amor surge inmediatamente entre ellos, pero el retorno del novio de Alicia provoca la separaci. En 1982, en Madrid, sus caminos vuelven a cruzarse. Tras el encuentro, se dan cuenta de que, a pesar de que el amor sigue latente, sus destinos discurren por rumbos separados.",0,"imgs/peliculas/56.jpg","",actorespelicula,director33,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula57 = new Peliculas("El 伃timo Elvis",2012,"",92,"Carlos Guti駻rez, &quot;Elvis&quot;, es un cantante separado que vive en un olvidado barrio de Buenos Aires y que tiene una peque hija llamada Lisa Marie, a la que no ve muy seguido. Siempre vivi� su vida como si fuese la reencarnaci de Elvis Presley, neg疣dose a aceptar su realidad. Pero est� a punto de cumplir los as que su 冝olo ten僘 al morir y su futuro se muestra vac卲.",0,"imgs/peliculas/57.jpg","",actorespelicula,director40,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula58 = new Peliculas("El resultado del amor",2007,"",94,"Mabel trabaja alternando la animaci de fiestas infantiles con la prostituci. A los 20 as se cruza con Mart匤, un abogado que se ha separado de su esposa, y deja el estudio para el cual trabajaba. Se atraen mutuamente y terminan enamor疣dose. Al poco tiempo Mabel descubre que es portadora del virus VIH.",0,"imgs/peliculas/58.jpg","",actorespelicula,director41,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula61 = new Peliculas("No sabe, no contesta",2002,"",90,"No sabe, no contesta cuenta la historia de Joaqu匤, que estudia cine y le gusta Laura. Tres d僘s en cuatro cap咜ulos en cuatro historias de cuatro amigos. Tres d僘s en la historia de Joaqu匤 que tiene tres amigos. Marcos, que tiene una novia que queda embarazada de otro. Dami疣, que tiene una novia que se acuesta con otro. David, que se acuesta con la novia de Dami疣.",0,"imgs/peliculas/61.jpg","",actorespelicula,director43,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula63 = new Peliculas("Mart匤 Fierro, la pel兤ula",2007,"",88,"Mart匤 Fierro es un renegado que lucha contra la corrupci que intenta someterlo y quitarle lo m疽 preciado de su vida: La libertad.",0,"imgs/peliculas/63.jpg","",actorespelicula,director45,reseniaspelicula,usuario,genero7, true);
		...
		Peliculas pelicula65 = new Peliculas("El 伃timo verano de la Boyita",2009,"",93,"La Boyita es una casa rodante que tiene la m疊ica capacidad de flotar. Una especie de anfibio dom駸tico, un refugio para Jorgelina, una ni que est� a punto de alcanzar la adolescencia. Cuando va a pasar las vacaciones al campo junto a su pap�, conoce a Mario, un ni que le plantea a Jorgelina dudas que no sabe co afrontar.",0,"imgs/peliculas/65.jpg","",actorespelicula,director46,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula69 = new Peliculas("Los paranoicos",2008,"",102,"&quot;Los paranoicos&quot; cuenta la historia de Gauna (Daniel Hendler), un joven que escribe pero nunca tuvo el coraje de enser su obra. Un hombre que en la intimidad expone una personalidad que parece censurar en su escasa vida social. La aparici de un viejo amigo, Manuel, que llega desde Espa embriagado por el suceso de una serie televisiva cuyo protagonista tiene un nombre que remite a 駘, provoca el enfrentamiento de Gauna con aquello que desea -aunque sea la novia de su amigo- y la reafirmaci de sus principios.",0,"imgs/peliculas/69.jpg","",actorespelicula,director48,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula71 = new Peliculas("La larga noche de Francisco Sanctis",2016,"",78,"Adaptaci de la novela homima de Humberto Costantini, situada en Buenos Aires en 1977. Un hombre recibe, en plena dictadura, la informaci del paradero de dos personas buscadas por los militares. Ahora tiene la posibilidad de salvarlas, aunque eso implica arriesgar su propia vida.",0,"imgs/peliculas/71.jpg","",actorespelicula,director50,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula72 = new Peliculas("Cuesti de principios",2009,"",115,"Castilla, modesto empleado portuario a punto de jubilarse, posee un ejemplar de una vieja revista que Silva, su nuevo y joven jefe, quiere comprarle a toda costa para completar su preciada colecci. Sin embargo, Castilla rechaza la oferta con el fin de darle una lecci, demostr疣dole que no todo en la vida tiene un precio. Las tentadoras ofertas de su obsesivo jefe provocar疣 un conflicto entre Castilla y su familia.",0,"imgs/peliculas/72.jpg","",actorespelicula,director24,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula77 = new Peliculas("Vikingo",2009,"",90,"Vikingo es un respetado motociclista de vida licenciosa pero, paradicamente, r刕ido en lo que hace a la aplicaci de ciertos preceptos morales. El honor y el respeto son sus cigos, aunque no est駭 presentes coherentemente en todas las dimensiones de su vida.",0,"imgs/peliculas/77.jpg","",actorespelicula,director55,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula85 = new Peliculas("Fantasma de Buenos Aires",2008,"",91,"Una historia fant疽tica con toques de comedia, sobre la relaci entre un joven t匇ido de hoy y el fantasma de un malevo asesinado en 1920.",0,"imgs/peliculas/85.jpg","",actorespelicula,director60,reseniaspelicula,usuario,genero9, true);
		...
		Peliculas pelicula89 = new Peliculas("El asadito",2000,"",71,"El 30 de diciembre de 1999 se encuentran a comer un asado siete amigos (m疽 un invitado sorpresa) en la terraza de Tito, el anfitri. La reuni se prolonga hasta las primeras horas del 伃timo d僘 del fin del milenio.",0,"imgs/peliculas/89.jpg","",actorespelicula,director62,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula100 = new Peliculas("ﾁnima Buenos Aires",2011,"",95,"Largometraje animado integrado por cuatro historias que revelan el incre兊le universo que encierran barrios y rincones de la ciudad de Buenos Aires.",0,"imgs/peliculas/100.jpg","",actorespelicula,director69,reseniaspelicula,usuario,genero7, true);
		...
		Peliculas pelicula112 = new Peliculas("Elefante blanco",2012,"",106,"Narra la historia de amistad de dos curas, Juli疣 y Nicol疽, que tras sobrevivir a un intento de asesinato por parte del ej駻cito durante su trabajo en Centroam駻ica, se asientan en una barriada de Buenos Aires para desarrollar su apostolado y labor social. All� conocen a Luciana, con quien luchar疣 codo con codo contra la corrupci, un mal end駑ico de la zona.",0,"imgs/peliculas/112.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula114 = new Peliculas("Los guantes m疊icos",2003,"",90,"Alejandro es un taxista de unos treinta y cinco as que se encuentra de pronto en medio de separaciones, cambios clim疸icos violentos, riqueza s炻ita, personajes que quieren volver a Argentina, otros que quieren irse para siempre, guantes m疊icos, m俍ica ensordecedora, empobrecimiento repentino, incontables viajes al aeropuerto, una nueva relaci, depresiones extremas, adicciones diversas.",0,"imgs/peliculas/114.jpg","",actorespelicula,director79,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula116 = new Peliculas("El lado oscuro del coraz 2",2001,"",108,"Diez as despu駸, Oliverio sigue buscando a la mujer que sea capaz de volar. Tras varios intentos, en Espa conoce a una equilibrista, y con ella logra demorar el tiempo y vencer a la muerte",0,"imgs/peliculas/116.jpg","",actorespelicula,director41,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula125 = new Peliculas("El frasco",2008,"",96,"P駻ez, un conductor de autob俍, rompe, sin querer, un frasco de orina que le ha entregado una maestra rural para que lo lleve a analizar. La idea que se le ocurre para solucionar el problema no puede ser m疽 absurda, pero marca el comienzo de una entrable historia de amor entre esos dos personajes.",0,"imgs/peliculas/125.jpg","",actorespelicula,director33,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula128 = new Peliculas("Cleopatra",2003,"",103,"Cleo, una maestra jubilada (Norma Aleandro), y Sandra (Natalia Oreiro), una popular actriz de telenovelas, hastiadas de sus rutinarias vidas, se lanzan a la carretera para vivir un fin de semana diferente que cambiar� por completo sus destinos. En el trayecto, conocen a Carlos (Leonardo Sbaraglia), un campesino que se sumar� a la aventura.",0,"imgs/peliculas/128.jpg","",actorespelicula,director11,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula129 = new Peliculas("Cornelia frente al espejo",2012,"",103,"La joven Cornelia llega a la antigua casona paterna para quitarse la vida. Cuando intenta cumplir con su cometido es continuamente interrumpida por imprevistas apariciones: una misteriosa ni, un ladr y un amante.",0,"imgs/peliculas/129.jpg","",actorespelicula,director86,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula130 = new Peliculas("Juana a los 12",2014,"",75,"Juana va a un colegio ingl駸 del conurbano bonaerense. Tras la preocupaci de sus maestras por su bajo rendimiento, su madre comienza a buscar ayuda externa. Juana lidia los desaf卲s acad駑icos y sociales con una aparente indiferencia mientras transita una edad de mucha incertidumbre.",0,"imgs/peliculas/130.jpg","",actorespelicula,director87,reseniaspelicula,usuario,genero1, true);
