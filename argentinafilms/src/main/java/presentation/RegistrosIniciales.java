...
public class RegistrosIniciales extends HttpServlet{
	...
	private void crearDatos(){
		...
		Directores director49 = new Directores("Andrea", "Márquez", 0);
		this.directorService.add(director49);
		Directores director50 = new Directores("Tristán", "Bauer", 0);
		...
		Resenias resenia2 = new Resenias("El azúcar diluyéndose en mi vaso de té con limón... en suspense brotando de la mirada y la investigación.Una vieja Olivetti que escribe sin la &quot;A&quot;... temor a la vida, al tiempo, al amor.El secreto que oculta su mirada.", "", usuario0, null);
		Resenias resenia3 = new Resenias("Camino de Nassica (UGC Getafe), a ver la ineludible cita que produce el estreno de un filme de Campanella, tengo una sensación de miedo, intento mentalizarme de que quizá no sea para tanto, como preparándome para una nueva decepción. Este año me he llevado algún mosqueo por ir con las expectativas demasiado altas.", "", usuario3, null);
		Resenias resenia4 = new Resenias("Quería ver la película por Campanella, por Darín (el GRAN Darín), porque había oído de grandes críticas. No sabía nada más. Entonces empezó la película y a los cinco minutos ya me impresinaba. Luego acabó, y tuve claro que había visto una obra maestra.", "", usuario8, null);
		...
		Resenias resenia14 = new Resenias("Gracias, Zoquete, por tu crítica. Me exime de decir más. Los argentinos, que andamos tan mal en tantas cosas, hemos sabido rescatar el arte de la cinematografía. &quot;Hemos &quot;dijo el mosquito, pero bueno... Campanella es nuestro y Darín supernuestro.", "", usuario20, null);
		Resenias resenia15 = new Resenias("El gran Jean Jacques Rousseau decía ¨Los temores, las sospechas, la frialdad, la reserva, el odio, la traición, se esconden frecuentemente bajo ese velo uniforme y pérfido de la cortesía¨ y este velo es el que viene a correr con vehemencia esta gran película.", "", usuario23, null);
		Resenias resenia16 = new Resenias("Dividida en varias historias, encuentra la fórmula perfecta para que sus dos horas de duración te pasen volando. Cuando han aparecido los títulos finales me he dicho a mí mismo &quot;¿Pero ya está?&quot;. La verdad que la calidad de todas las historias está muy bien, aunque como en todos lados hay unas mejores que otras, y hay unas más violentas que otras.", "", usuario31, null);
		...
		Resenias resenia26 = new Resenias("Un halo fantástico se desprende de estas tres potentes historias rodadas en localidades anodinas, desperdigadas en la llanura de la provincia de Buenos Aires, que encierran arquitecturas misteriosas y suntuosas geometrías recubiertas de olvido y abandono, que parecen aguardar a quien las descifre.", "", usuario36, null);
		...
		Resenias resenia47 = new Resenias("66/20(20/03/12) Original cortometraje argentino, que posee un arranque arrollador, donde se critica en un brillante monólogo la anarquía urbanística de Buenos Aires que deriva en una sociedad insegura, con la soledad, con relaciones complicadas, con fobias y manías, por que como dice el protagonista &lt;Que se puede esperar de una ciudad que da la espalda a su Río&gt;.", "", usuario16, null);
		Resenias resenia48 = new Resenias("Cortometraje fresco e imaginativo, con imágenes impactantes y un contenido muy lúcido. &quot;Medianeras&quot; ofrece una aguda disección de la sociedad moderna actual, en un entorno urbano alienante y claustrofóbico, pero con un mensaje esperanzador y positivo.", "", usuario17, null);
		Resenias resenia49 = new Resenias("No tengo en mi casa un solo disco de cumbia ni me gusta bailarla en las fiestas, es decir no soy una fan de la música tropical y desde ese lugar fui a ver “Gilda”.  Se trata de una película que tiene dos rasgos distintivos: el primero, que su directora ha recreado el mundo de la música más popular de las clases más populares sin caer en lugares comunes ni rozar el grotesco, con buen gusto y sobre todo con muchísimo respeto por los artistas y el público que los admira (algo que lamentablemente no supieron hacer Cohn y Duprat en  “El ciudadano ilustre”.", "", usuario19, null);
		...
		Resenias resenia51 = new Resenias("&quot;Gilda. No me arrepiento de este amor&quot; (2016) de Lorena Muñoz.Antes que nada sólida actuación de Natalia Oreiro, vale la pena reconocerlo. Muy bien caracterizada y dirigida además. La película llama la atención por no tener una mirada pochoclera del fenómeno Gilda.", "", usuario1, null);
		Resenias resenia52 = new Resenias("La película comienza con un cajón dentro de un coche fúnebre. La cámara está sobre el cajón, se ve la madera brillante, los arreglos florales, la lluvia en el exterior. La puerta del baúl se abre, el féretro sale y recibe las gotas de lluvia y las manos de unas 15 personas que simulan muchedumbre, envueltas en llanto, con caras desfiguradas por los gritos, con desesperación por tocar el cajón, por besarlo, por darle flores, por agarrarlo y llevarlo hasta su nicho.", "", usuario2, null);
		Resenias resenia53 = new Resenias("Emotiva película que nos lleva al universo de Valentín, un niño que sueña con ser astronauta y que tiene los pies en la tierra más que algunos adultos. Desde su perspectiva observamos como es su vida y la de los personajes que le rodean.Una mezcla de comedia y drama, que tan pronto nos pone tristes como nos hace sonreir con las ocurrencias del muchacho.", "", usuario3, null);
		Resenias resenia54 = new Resenias("Fastinante película del otro lado del charco que nos invita a hacer una reflexión sobre la importancia del amor familiar en la vida de las personas. Desde el principio nos envuelve su pasión por la vida en unas condiciones en las que es difícil tener las ideas claras.", "", usuario36, null);
		...
		Resenias resenia60 = new Resenias("La última sorpresa que nos ha llegado de tierras argentinas no ha sido la eliminación de su selección en el mundial de fútbol (con la que me han fastidiado una porra de más de 120 €), ha sido &quot;Tiempo de valientes&quot;. Una buddy movie cuyo guión ya quisiera hollywood.", "", usuario31, null);
		...
		Resenias resenia62 = new Resenias("El cine argentino nos viene ofreciendo últimamente auténticas perlas cinematográficas, tanto en forma de suspense casi metafísico (El aura), drama de tono melancólico (Luna de Avellaneda) o esta mezcla insólita de thriller y comedia que es Tiempo de valientes.", "", usuario24, null);
		Resenias resenia63 = new Resenias("Excelente guión. De esos que no te deja indiferente, que al final de cada diálogo te da la impresión de haber aprendido un poquito más de la vida, o por lo menos te recuerda algo que sabías pero que tenías olvidado. El personaje de Roma inolvidable.", "", usuario33, null);
		...
		Resenias resenia66 = new Resenias("Una película interesante pero mucho más floja de lo habitual en el estupendo Aristarain (aquí ayudado en el guión además por Mario Camus aparte de la habitual Kathy Saavedra).Cuenta el encuentro entre un joven periodista aspirante a escritor (Botto) y un escritor ya consagrado y aislado del mundo y de sus recuerdos (Sacristán), que activará en el segundo la moviola de toda su vida.", "", usuario23, null);
		...
		Resenias resenia75 = new Resenias("Después del estreno de la película, una radio entrevistaba a Elsa y por detrás se escuchó un grito de una admiradora que decía: &quot;Me hiciste llorar hija de puta&quot;. A mi, no tan solo me ha hecho llorar sino que he reído y he disfrutado de esta excelente interpretación.", "", usuario15, null);
		Resenias resenia76 = new Resenias("Elsa y Fred fue un trabajo elegido para conformar la XLVI Muestra Internacional de Cine en México, la cual amenizó de manera cómica la proyección de 15 películas en su mayoría de género dramático. Los protagonistas en plena senectud son escasos debido a la desafortunada visión que se tiene de la vida.", "", usuario34, null);
		Resenias resenia77 = new Resenias("Esta es una película sobre todo de actores. El guión no deja de ser una historia pasable, salpicada de algunos momentos emotivos y simpáticos, pero bastante previsible. Lo mejor de la película, los actores, sobre todo Manuel Alexandre, un actor siempre secundario y que nunca ha defraudado a los que lo buscábamos en una de esas innumerables películas en las que ha trabajado.", "", usuario25, null);
		Resenias resenia78 = new Resenias("Lugo de alcanzar el éxito con series como &quot;Tumberos&quot; o de películas como &quot;Un oso rojo&quot; el director uruguayo/argentino Israel Adrián Caetano vuelve al ruedo con &quot;Crónica de una fuga&quot;, competidora en la selección oficial de Cannes.", "", usuario37, null);
		...
		Resenias resenia84 = new Resenias("Supuestamente el detonante de toda historia es el conflicto. Practicamente todos partimos de la idea de que esa palabra implica que hay un problema, que ha pasado algo negativo. Para Carlos Sorín no. Para él el detonante de toda historia es lo cotidiano, lo sencillo, el día a día, los encuentros fortuitos.", "", usuario11, null);
		Resenias resenia85 = new Resenias("Manolo es pequeño, peludo, suave; tan blando por fuera, que se diría todo de algodón. Manolo es mi perro y no es un burro. Y por si hubiera alguna duda, yo tampoco soy Juan Ramón Jiménez.Si hubiera visto esta película hace un año probablemente me habría aburrido.", "", usuario18, null);
		Resenias resenia86 = new Resenias("Excelente película que transcurre con el lento ritmo de la Patagonia, la lucha por la supervivencia, las necesidades de un hombre humilde que pueden ser satisfechas por el azar de recibir como regalo un perro, perro que no cumple con lo que se espera de él.", "", usuario19, null);
		Resenias resenia87 = new Resenias("Un problema de desempleo con una aparente solución inusual, el Sr. Juan Villegas la verdad, ha hecho un trabajo de interpretación muy bueno, al igual que el resto, no sabía que no eran profesionales o por lo menos no han tenido gran cantidad de trabajos.", "", usuario25, null);
		...
		Resenias resenia89 = new Resenias("Sublime China Zorrila. ¿Puede una actriz ser más adorable, talentosa y creíble que la inmensa uruguaya?. No por supuesto, porque todo lo que haga China tiene su toque mágico único. En Conversaciones con mamá está impresionante y Eduardo Blanco como su hijo no se queda atrás, juntos tienen unos diálogos que son de antología.", "", usuario18, null);
		Resenias resenia90 = new Resenias("Es una de las mejores películas que he visto en los últimos cinco años, sin duda. Un maravilloso guión interpretado de forma magistral por todos los actores sin excepción. Eduardo Blanco se ha colocado merecidamente en uno de los mejores actores que he visto.", "", usuario3, null);
		Resenias resenia91 = new Resenias("...muy realista y humana. Una relación madre e hijo bien dirigida da para mucho, como en ésta película. Realmente no puede ser más sencilla, pero a la vez llena de la propia vida de mucha gente.", "", usuario37, null);
		...
		Resenias resenia110 = new Resenias("Tras Plata quemada, Marcelo Piñeyro confirma las buenas maneras que ya apuntaba.La política ha sido desde siempre un buen terreno del que sacar materia fílmica. En muchas ocasiones ayuda a recuperar una memoria, que en muchos casos, se ha pretendido hacer olvidar a la fuerza.", "", usuario17, null);
		Resenias resenia111 = new Resenias("Hablar de la dictadura desde otro punto de vista, el de un niño. Como drama familiar está muy bien, pero falta algo para que sea una película redonda.Sus bazas son unos estupendos actores, incluidos los niños, una estética muy buena, al estilo hollywoodiense (similar a la de &quot;Las horas&quot;, &quot;Magnolia&quot; y similares, aunque salvando las diferencias), un más que aceptable guión y el importante tema tratado.", "", usuario14, null);
		Resenias resenia112 = new Resenias("Sosa, ñoña y anodina, si no fuera por su trasfondo político, que es en lo que se basa la película, resultaría inaguantable, su único ápice está en el principio y en el final, toda su &quot;aventura&quot; durante el metraje es algo casi sin interés.", "", usuario6, null);
		Resenias resenia113 = new Resenias("En Argentina existe la discriminación hacia los peruanos, bolivianos, paraguayos, etc., y esta película la retrata muy bien, al punto de que nos muestra la cara más horrible de este asunto.Me he sentido identificado con ese pobre muchacho que deja a su familia, mujer e hijos en su Bolivia natal, y llega a Buenos Aires con la sola intención de encontrar una oportunidad por mísera que sea.", "", usuario15, null);
		Resenias resenia114 = new Resenias("Con una ejemplar economía narrativa y de medios, desarrollando la acción practicamente en un único lugar, el cineasta argentino Adrián Caetano cuenta la historia de un inmigrante boliviano recién llegado a la prometedora Argentina, sin papeles, dónde comenzará a trabajar de cocinero en un bar.", "", usuario13, null);
		Resenias resenia115 = new Resenias("Ganador del Premio de la Crítica Joven en el Festival de Cannes y del Premio Made In Spanish en el Festival de San Sebastián.Freddy (Freddy Flores), un inmigrante boliviano ha conseguido un reciente trabajo en Argentina de parrillero en un restaurant, ya que en su país ha perdido su trabajo.", "", usuario14, null);
		Resenias resenia116 = new Resenias("Soberbias actuaciones: el oso, Freddy, el dueño del restaurant y Marcelo dan cátedra. Este era mi principal miedo ante actores de poco cartel. Nada está demás, nada parece fingido... Ahora que miro mejor, los nombres de los actores y de sus personajes son idénticos.", "", usuario4, null);
		Resenias resenia117 = new Resenias("Bolivia-Simplista y muy reconocido largometraje Argentino, en muchos niveles es el retrato de cada uno de los inmigrantes de América Latina a otro país hermano, independientemente el nombre del país es casi seguro que la realidad vivida por el protagonista, es la difícil realidad de muchos que deciden viajar de su nación a un país vecino que les pueda dar más oportunidades de vida digna, también retrata de forma secundaria la penosa situación económica de los ciudadanos producida por el subdesarrollo de la misma economía, me ha llamado la atención en sobre manera la forma de dirigir de Caetano.", "", usuario18, null);
		Resenias resenia118 = new Resenias("Los niños que nacen entre rejas, el vinculo madre-hijo en esas circunstancias,  la relación de solidaridad u hostilidad con las compañeras del presidio, el derecho de los que están afuera y el de los que están encerrados, son los temas incorporados al último film del realizador argentino Pablo Trapero, que elude transitar por los lugares comunes del subgénero de películas carcelarias, evitando hacer de lo escabroso un motivo central.", "", usuario8, null);
		Resenias resenia119 = new Resenias("Esta película se caracteriza por lo real que es. El drama de la protagonista el espectador lo va a sentir como propio. Está muy bien representada la presa embrazada. Parece haber estudio en la interpretación. Y que muestren como ella está embarazada de verdad, la hace aun más cruda a la realidad.", "", usuario2, null);
		Resenias resenia120 = new Resenias("Creo que esta película responde a la pregunta del título. Describe el día a día en una cárcel de mujeres, sin darle tintes novelescos ni melodramáticos. Son cosas que podrían pasar en unas celdas. Y creo que logra describirlo así de bien por cómo comienza la película, ya que no hace falta que haya un culpable o un inocente para que pase algo así, para que te veas embarazada y desvalida en una penitenciaría.", "", usuario36, null);
		Resenias resenia121 = new Resenias("La veracidad es algo que siempre está presente en las películas de Trapero. En los últimos años han salido un grupo de cineastas argentinos como Carlos Sorín o el propio Trapero que dotan a su cine de una veracidad muy palpable. Usan para ello historias muy cotidianas y con actores no profesionales (en muchos casos).", "", usuario27, null);
		Resenias resenia122 = new Resenias("Trapero busca el realismo más descarnado, como en sus anteriores películas. Es una historia totalmente creíble, sobria y natural. Es diferente a otras películas sobre prisiones. Nunca cae en lugares comunes. La sensación de claustrofobia es enorme.", "", usuario29, null);
		...
		Resenias resenia125 = new Resenias("El genio de Favio nos vuelve a sorprender con una fábula rebosante de ternura y lirismo, emanada de su sensible espíritu, la que, lamentablemente, es posible sea su obra póstuma, ya que su salud se encuentra muy deteriorada por una penosa enfermedad.", "", usuario8, null);
		Resenias resenia126 = new Resenias("Aniceto es la reversión “bailada” de la película que dirigió allá por el año 1967, titulada Éste es el romance del Aniceto y la Francisca, de cómo quedó trunco, comenzó la tristeza y unas pocas cosas más… protagonizada por Federico Luppi, Elsa Daniel y María Vaner.", "", usuario7, null);
		Resenias resenia127 = new Resenias("Leonardo Favio ya había hecho en los años 60 una hermosa versión de este cuento de su hermano Jorge Zuhair Jury, con un título bastante más extenso, en blanco y negro. Sin embargo en la presente versión, &quot;Aniceto&quot;, mostrando su creatividad y capacidad, logra ir más allá del cine.", "", usuario12, null);
		Resenias resenia128 = new Resenias("Kafkiano retrato de la sociedad argentina en el que un hombre normal se ve involucrado, de la noche a la mañana, en la más absurda de las pesadillas.Me gustan mucho estos finales tan abiertos, tan imprecisos. Cada uno se construirá el suyo propio.", "", usuario23, null);
		...
		Resenias resenia130 = new Resenias("Al principio todo comienza según lo previsto: crisis argentina, mirada costumbrista y relación amorosa entrañable y aparentemente idílica. Pero lo previsto se derrumba, pues la película sorpresivamente adquiere la forma de un delirante drama kafkiano.", "", usuario8, null);
		...
		Resenias resenia139 = new Resenias("En principio el guión de “El Artista” promete: un enfermero que cuida ancianos descubre que uno de ellos - en silla de ruedas y sin habla (salvo para pedir puchos) - es un genio de la pintura. Sin ningún escrúpulo, decide  tomar sus obras y presentarlas como propias amparado en el ensimismamiento del viejo que ignora la situación.", "", usuario30, null);
		...
		Resenias resenia145 = new Resenias("Muchos pergaminos, mucha alharaca y en verdad la película de la salteña Lucrecia Martel no cuenta nada, se queda en una insolvencia argumental alarmante. Ya estos ingredientes se pueden vislumbrar en su posterior trabajo &quot;La niña santa&quot; que no es para nada distinto a este filme que nos ocupa.", "", usuario5, null);
		Resenias resenia146 = new Resenias("Tremenda decepción, me esperaba una película acorde con la puntuación que le daba la crítica y me ha defraudado. Lo único que puedo destacar es que ha sabido reflejar muy bien el prototipo de familia aburguesada que está pasada de vuelta, no hay ilusión ni esperanza, los valores brillan por su ausencia.", "", usuario11, null);
		...
		Resenias resenia148 = new Resenias("Si fuera hacer un resumen de esta película partiendo tan sólo de las escenas elegiría dos de ellas: la del diálogo de Cristina en la barca y la de Román en la Asamblea. Las dos son especialmente bellas porque nos hablan del verdadero concepto de la felicidad.", "", usuario16, null);
		Resenias resenia149 = new Resenias("Luna de Avellaneda es la historia de un emblemático club de barrio que ha vivido en el pasado una época de esplendor y que en la actualidad se encuentra inmerso en una crisis que pone en peligro su existencia. Al parecer, la única salida posible es que se convierta en un casino, nada más alejado de los ideales y de los fines de sus fundadores en la década de 1940: un club social, deportivo y cultural.", "", usuario15, null);
		...
		Resenias resenia153 = new Resenias("Película muy seria, triste, deprimente; donde todo lo que sucede está bajo la esfera de la realidad frustante de tantísimos millones de argentinos dentro de una patria-sociedad que es capaz de darles equipos de futbol campeones del mundo, pero para nada un Estado campeón  en hacer cumplir los derechos humanos en la mayoría de sus ciudadanos, empezando por la comida, la educación, el trabajo, la vivienda, etc.", "", usuario10, null);
		...
		Resenias resenia160 = new Resenias("Fuí sin siquiera saber el Título, ni de que trataba, y me llevé una grata sorpresa.La Película me tuvo atado a la butaca hasta el final.Me pareció original la idea de la trama central, y el guión muy bien llevado. La resumiría como &quot; La Doble Mejicaneada del Paralítico &quot;.", "", usuario36, null);
		Resenias resenia161 = new Resenias("Al final del túnel Estamos de parabienes. De nuevo me toca reseñar una estupenda película argentina pues, como ocurre con el cine español, son aconticimientos escasos así que, estas alegrías, dosificadas con cuentagotas, siempre significarán un motivo de celebración.", "", usuario26, null);
		...
		Resenias resenia164 = new Resenias("Esta es una película de detalles, de cosas pequeñas (que le llaman algunos a este tipo de historias), en la que disfrutar con miradas, silencios, reacciones sentimentales de los personajes... todo eso te puede atrapar y realmente emocionar, o quizá dejar indiferente y aburrir, admito el riesgo.", "", usuario23, null);
		...
		Resenias resenia166 = new Resenias("Cine de sentimientos escondidos, de amistad a flor de piel oculta tras una coraza tan frágil como un plato, de amores perdidos, encontrados y vueltos a perder, la película de Hernández se paladea como las berenjenas, sin salsas que escondan su sabor.", "", usuario0, null);
		...
		Resenias resenia168 = new Resenias("La película esta bien estructurada, cuenta lo importante de la situación de la aviación en Argentina desde un punto de vista miy crítico aunque tambien meten paja para rellenar pero eso es menos importante. A quien le guste la película y tenga ganas de saber algo mas del accidente y de las compañias aereas de ese pais, el mismo actor/piloto &quot;Piñeyro&quot; ha realizado un documental muy interesante, la puesta en escena me recuerda en algunos momentos al maestro Alfred Hitchcock, pero se puede llevar muy bien.", "", usuario28, null);
		...
		Resenias resenia180 = new Resenias("Lo real inverosímil, pesado, reiterativo, poco desarrollado, repitiendo una y otra vez las mismas situaciones teniendo un material tan rico, surgido de la propia crónica negra: esto es El polaquito, que no sigue la tradición iniciada por Pixote, de Babenco, también argentino pero radicado en Brasil.", "", usuario37, null);
		...
		Resenias resenia183 = new Resenias("No pensaba escribir una crítica, pero mientras leía las ajenas se activaron ciertos botones que no pude negar.Tenía algo de información sobre la película, viene premiada por varios festivales, había visto el Trailer y en mí cuerpo corría cierta incomodidad previa.", "", usuario17, null);
		...
		Resenias resenia185 = new Resenias("¿O no…?Si hay algo en el cine argentino que me atrae son sus actores. Parecen tocados por una barita mágica. Esta es una película puramente actoral y de muy alto nivel.La trama se fundamenta en una idea, tan genial como sencilla.", "", usuario21, null);
		...
		Resenias resenia187 = new Resenias("Últimamente tiendo a ordenar mentalmente el cine en tres categorías:1) Populista: Aquel que trata de saciar los instintos más primarios de un espectador al que en realidad el cine no le interesa. Por ejemplo el Hollywood más descerebrado, las españoladas o Bollywood.", "", usuario5, null);
		Resenias resenia188 = new Resenias("Película estrenada en el año 2000, en blanco y negro, con actores desconocidos y bajo presupuesto, apenas 52000 dolares.Este Film se sale del molde y nos cuenta una original historia en 3 épocas de Buenos aires.Son 3 amigos que desde adolescentes, están obsesionados por una actriz de teatro de revistas, que se van metiendo en &quot;quilombos&quot;, y van mostrando lo peor de los argentinos, el mundo de la noche, la droga, las mafias y la historia y las crisis que se repiten década a década.", "", usuario33, null);
		Resenias resenia189 = new Resenias("En está semana con la oportunidad de ir al cine y ver propuestas en la segunda Muestra Internacional de Cine en México me he topado curiosamente con cuatro películas de crítica social a personajes ubicados como el pilar de la familia: la madre. La visión ha girado 180º y la descomposición parte de ellas, gracias al desencanto con el que viven y con el cual han construido su destino, colocándolas como la escoria de una sociedad supuestamente funcional.", "", usuario32, null);
		Resenias resenia190 = new Resenias("&quot;No me gusta trabajar&quot;, esgrime Florencia, protagonista principal de esta obra que conmueve, divierte y hace pensar. Son las vicisitudes femeninas, sus contradicciones, enfrentamientos de clase y familiares y demás detalles de la vida cotidiana los que se nos presentan de una manera que nos permite mantener el interés durante su desarrollo.", "", usuario11, null);
		Resenias resenia191 = new Resenias("La nena hace lo que puede, pero su actuación es muy sobre actuada . Con la musica de los bobosónicos que son insoportables. Es una comedia dramática, pero de comedia no tiene nada, nunca te hace reir. La madre hace de cocainómana y llega ser adicta a la idiotez.", "", usuario16, null);
		Resenias resenia192 = new Resenias("Aceptable film argentino que comienza de un modo exultante, con diálogos y escenas motivantes pero que a medida que transcurre la película se va cayendo poco a poco, (comienza con suerte y acaba sin fortuna) llegando a tener un desenlace absurdo no creíble.", "", usuario28, null);
		Resenias resenia193 = new Resenias("Felipe (Marcelo Mazzarello) un actor desempleado y Guillermo (Gastón Pauls) despedido de su trabajo y abandonado por su novia, son dos medio hermanos muy diferentes, hacen años que no se ven, pero vuelven a reunirse para complacer a su moribundo padre en su último deseo antes de morir.", "", usuario27, null);
		Resenias resenia194 = new Resenias("De nuevo una película argentina entrañable. La suerte está ahí, y en muchas ocasiones hay un hilo muy fino que separa la mala de la buena. Nuestro querido protagonista no se resigna a ser un perdedor toda su vida y tendrá que luchar para que su suerte y la de quien le rodea cambie a mejor.", "", usuario8, null);
		...
		Resenias resenia208 = new Resenias("Luego de ver las películas anteriores de Pablo Trapero se puede decir que va disminuyedo la intensidad con la que abordaba diferentes temas sangrantes de la Argentina. Aún así, en El Clan, logra llevar al cine una novela aterradora que sucedió en la década del 80 en este país.", "", usuario18, null);
		Resenias resenia209 = new Resenias("Recomendable por la crudeza de las situaciones, con contadas escenas de violencia explícita pero sin exceso de gore, lo cual la hará más o menos difícil de tragar según la susceptibilidad de cada uno.Cualquier persona con un poco de humanidad, sentirá rechazo y repudio hacia los Puccio, que realizaban secuestros extorsivos para cobrar abundantes sumas de dinero, aunque siempre ejecutaban a sus víctimas, en vez de devolverlas sanas y salvas a sus familias.", "", usuario1, null);
		Resenias resenia210 = new Resenias("“Medianeras” es una historia de amor aunque habla sobre todo de su ausencia, en tiempos de fobias sociales y en el marco de una sociedad progresivamente deshumanizada, tanto en su arquitectura como en su sofisticada tecnología. El problema que plantea es universal: en las macrociudades actuales todos se cruzan sin conocerse.", "", usuario5, null);
		Resenias resenia211 = new Resenias("Náufragos en un océano sin apenas islas, viven en Buenos Aires, dentro de sus respectivas cáscaras de nuez, dos jóvenes. Él, diseñador de páginas web, con poca suerte y pocas ganas de buscarla. Ella, arquitecta, metida a decoradora de escaparates por aquello de la crisis, empeñada en localizar a Wally en la ciudad.", "", usuario28, null);
		Resenias resenia212 = new Resenias("Medianeras cierra un 2011 de muy buen cine argentino. Aún cuando todavía me queda por ver varios films del producción nacional del 2011 (De caravana y Las Acacias, principalmente) ya puedo destacar varios de ellos: Fase 7, La vieja de Atrás, El Estudiante y ahora Medianeras.", "", usuario20, null);
		Resenias resenia213 = new Resenias("&quot;Buenos Aires crece descontrolada e imperfecta, una ciudad en la que se yerguen miles y miles de edificios sin ningún criterio. Al lado de uno muy alto hay uno muy bajo, al lado de uno racionalista, uno irracional. Probablemente estas irregularidades estéticas y éticas nos reflejen perfectamente.", "", usuario13, null);
		Resenias resenia214 = new Resenias("Son almas gemelas, pero no se conocen... A pesar de vivir en la misma calle y coincidir en ella y hasta en la piscina. Él ha pasado dos años encerrado en casa, haciendo todo en Internet, desde la compra hasta el sexo. Ella ha cortado recientemente una relación de cuatro años.", "", usuario14, null);
		Resenias resenia215 = new Resenias("Les cuento: hace una semana ví El Ciudadano Ilustre (también con Oscar Martinez como protagonista) y me encantó. Recién termino de ver Inseparables, y la verdad es que no tiene ni punto de comparación. Nunca me imaginé que éste hombre fuera a hacer una americanada así (aunque sea una remake de cine francés), tan obvia, liviana, previsible y cursi.", "", usuario12, null);
		Resenias resenia216 = new Resenias("A diferencia de lo que pensé, es muy divertida, fui con mis hijos de 27 y 22 años y también les gustó- escuchaba sus carcajadas en el cine- Rodrigo de la Serna está espectacular, y Oscar Martinez,  excelente. Muy argentina, en los modismos y lenguaje.", "", usuario14, null);
		...
		Resenias resenia229 = new Resenias("Pequeña joya del cine independiente argentino. Original y divertida, es una mezcla entre el cine de Tim Burton y el de Jean-Pierre Jeunet con algunas gotas de Lynch y una estética cómic muy lograda. La película nos situa en una ciudad imaginaria, alegoría de un futuro en el que los seres humanos han perdido el don del habla y viven al son  de un magnate de la televisión, un tirano que pretende controlar sus mentes (una metafora muy actual del mundo de las grandes empresas de comunicación).", "", usuario20, null);
		Resenias resenia230 = new Resenias("En España la TV es una caja donde se emiten programas que a nadie gustan, pero que, como el 6 espirílico e hipnótico de la película argentina, nos atraen y no dejamos de verlos. Además, la presencia de la publicidad es cada vez mayor, y ya incluso los programas se convierten en escaparates al más puro estilo del teletienda.", "", usuario0, null);
		Resenias resenia231 = new Resenias("Me he quedado alucinado con esta película. Sin palabras; han sabido chupar de fuentes clásicas de la historia del cine pero le dan un toque personal que nunca llega a dar ni un ligero tono pedante.Tiene ritmo,guión de cuento, buenos actores (hasta los niños están bien), un diseño de producción deslumbrante, muy de la época de Al Capone, estética de comic, surrealismo, humor, ternura, historias dentro de otras historias, la música es espectacular, te mete dentro de la peli y no te suelta; Cada pequeño detalle es deslumbrante y no me voy a enrrollar más, simplemente voy a recomendar a la gente con rigor y una cierta cultura de cine que vayan, paguen los siete euros y disfruten porque este espectáculo no se ve muy fecuentemente.", "", usuario26, null);
		...
		Resenias resenia240 = new Resenias("Hawaii es la tercer película del director argentino Marco Berger (Plan B, Ausente) que compite en la categoría de Largometrajes Nacionales.Una historia de amor. Así presentan esta película que trata sobre Martín y Eugenio. Martín debe pasar el verano sobreviviendo, no tiene un lugar donde quedarse y se hace algunos pesos como puede.", "", usuario29, null);
		...
		Resenias resenia242 = new Resenias("En la primera parte de la película Marco Berger consigue despertar el interés del espectador mediante la mirada de los protagonistas, inquieta, variante, como buscando algo o temiendo algo. A partir del encuentro de los dos protagonistas, las miradas cambian, ahora son de interés personal y hasta de análisis físico, cada uno por el cuerpo del otro.", "", usuario31, null);
		Resenias resenia243 = new Resenias("Las relaciones entre hombres son una constante en el cine del director argentino Marco Berger. Desde sus primeros cortos hasta sus largometrajes ‘Plan B’ y ‘Ausente’, Berger muestra como dos chicos se conocen y se atraen.Martín hace algunas chambitas para pasar el verano antes de volver a Buenos Aires para asentarse ahí, Eugenio está cuidando la casa de un tío mientras escribe una novela y decide contratarlo, más por atracción hacia Martín que por verdadera necesidad.", "", usuario10, null);
		Resenias resenia244 = new Resenias("El Zapa es un pobre cerrajero que se ve implicado en un robo. En el pueblo todos le conocen y saben que no es mal chico, por lo que todo se arregla para que viaje a Buenos Aires con una recomendación para incorporarse al cuerpo de la Bonaerense.El Zapa se va dando cuenta, poco a poco, de que la policía se mueve corruptamente por los bajos fondos.", "", usuario8, null);
		Resenias resenia245 = new Resenias("Pablo Trapero nos muestra una realidad cruda, sin edición y sin ornamentos, de una institución tan cuestionada en la Argentina como lo es la Policía Bonaerense, enmarcando las historias personales en un país en plena crisis económica. Lejos están en esta película, los irreales sueños primermundistas de la Argentina de los 90´.", "", usuario27, null);
		Resenias resenia246 = new Resenias("Coproducción argentino-chilena que cuenta la historia de un hombre que por circunstancias ajenas a él se verá en la necesidad de dedicarse a ser policía en la capital argentina.Posee una dirección artística mediocre, con pésimas actuaciones de los protagonistas principales y aún peores de los secundarios (a la madre de Zapa sólo le falta mirar a la cámara y mandar saludos).", "", usuario6, null);
		Resenias resenia247 = new Resenias("Más que &quot;Trapero&quot; este hombre podría ser &quot;modisto de Alta Costura&quot;,  posiblemente sea la película argentina de los últimos años que más poso deja tras verla. Escenas memorables y sutilmente inolvidables.Magnífico Trapero.", "", usuario25, null);
		Resenias resenia248 = new Resenias("Esta película quizás no tenga el super-argumento, pero nos demuestra lo más profundo de la realidad de la Policia Bonaerense: corrupción, prostitución, oficiales excedidos de edad que entran por los &quot;amiguismos&quot;, y demás cosas. Sin dudas el protagonista es un inutil, que lo pasan por arriba (por decirlo en criollo), unas 2 veces en la película.", "", usuario34, null);
		Resenias resenia249 = new Resenias("Escondido cine  argentino, que  al igual que decenas de películas  que no llegan a nuestras carteleras, no deja de ser un  cine interesante, sea cual fuere su procedencia. Su trasfondo es el del abandono,  el de la soledad y la muerte; una solución de búsqueda que  acompaña al protagonista y a todo al que la ve, que trasluce el ámbito del cine independiente para hacerse aún más desgraciadamente olvidado.", "", usuario32, null);
		...
		Resenias resenia251 = new Resenias("Cine antropológico pero no autocéntrico (y por ahí el aficionado no encontrará punto de apoyo en una personalidad o una empatía motor del metraje); aquí el protagonista no se presenta en el centro de una ficción construida por y para él (clásico sujeto volitivo de introducción-nudo-desenlace) sino que el contexto emerge estructuralista como suma de elementos sin retórica del “yo”.", "", usuario12, null);
		Resenias resenia252 = new Resenias("Segundo intento, segunda parte, continuación con intermedio o vayan ustedes a saber. Lo cierto es que esta vez, arrancamos (de nuevo) con un intenso plano-secuencia de los momentos anteriores al asesinato. Sirve este inicio como prolegómeno, como resumen y también, aunque no se vea, como conclusión.", "", usuario28, null);
		Resenias resenia253 = new Resenias("Existen grandes películas, que se construyen con diálogos ingeniosos, bien elaborados, que son del disfrute para los amantes del buen cine, pero también existen películas en donde los diálogos son practicamente inexistentes, en el cual el uso de la cámara es importante, el cine es un arte y la cámara es el instrumento, la cámara nos habla nos muestra, sin necesidad de la palabra, tan solo que con el movimiento de esta, siendo grandes representantes de este cine Andrei Tarkovsky, Bresson y más contemporáneo Bela Tarr, pero latinoamerica también tiene su representante con Lisandro Alonso.", "", usuario8, null);
		...
		Resenias resenia256 = new Resenias("Sorprendente thriller dramático argentino en donde las cosas se han realizado con verdadera pericia, esto sin desmerecer nuestro cine pero aquí la eficacia ha alcanzado niveles como sólo veo en contadas pelis de nuestro país. Desde luego, el título es irónico, pero vamos a la peli.", "", usuario9, null);
		Resenias resenia257 = new Resenias("Muchos quedamos sorprendidos al ver el palmarés de la pasada SEMINCI, en la que se alzaron con la Espiga de Oro ex aequo 'Copia certificada', de Abbas Kiarostami y 'Sin retorno', de Miguel Cohan. La primera es para el que esto escribe la mejor película de 2010, por lo que el hueco en lo más alto lo tenía de sobra merecido.", "", usuario34, null);
		...
		Resenias resenia271 = new Resenias("No hay lugar para la ampulosidad en El último Elvis; ni para la joda ni para la caricaturización. Sobria como pocas, justamente por tratar de un  tema como el que trata, lo que sorprende es la seriedad de la propuesta y el como desarrollarla apenas teniendo en cuenta el devenir psicológico del personaje principal.", "", usuario27, null);
		Resenias resenia272 = new Resenias("Historia pausada, intimista, con una camara omnipresente que sigue a nuestro ¿ídolo? en cada momento vital. La historia de un hombre que se transforma en el único y ¿legítimo? continuador de Elvis Presley...o así lo entiende él.", "", usuario26, null);
		Resenias resenia273 = new Resenias("Película intrigante, de esas con las que piensas una vez salido del cine y meses después. Una reflexión perfecta entre la obsesión y la realidad de un auténtico fan. Merece la pena verla, sin duda una de las mejores películas que pueden salir en verano.", "", usuario8, null);
		...
		Resenias resenia275 = new Resenias("Hace más de veinte años que Eliseo Subiela cuenta variaciones de una historia parecida. Si algo lo distingue como cineasta es la fidelidad a   sus ideas, a su mundo personal que tiene una estética cinematográfica  reconocible, con adeptos y detractores.", "", usuario20, null);
		Resenias resenia276 = new Resenias("Me gustó. Es una historia de amor con enseñanza, que nos muestra los valores fundamentales del ser humano: amor desinteresado, lealtad en los malos momentos, generosidad, inocencia, confianza en uno mismo, piedad, etc.Mabel y Martín encarnan muy bien estos valores y nos hacen partícipes de su ternura.", "", usuario0, null);
		Resenias resenia277 = new Resenias("Cuando alguien está empeñado en contar algo para que llegue al gran público, tiene que saber el grado de sinceridad de sí mismo quiere que impregne en su obra. La necesidad de hacer una exposición no comercial de una idea y que llegue al mayor número de personas posibles, es arto difícil.", "", usuario15, null);
		Resenias resenia278 = new Resenias("Es un film que trata de hacer pensar sobre la vida sin caer en el didactismo, por lo cual, los dos protagonistas, si son ejemplo, lo son con sus simples actos, que son de libertad y de amor: son personas atípicas precisamente porque hacen uso de tal libertad, la que todos tenemos y quizás no usamos.", "", usuario30, null);
		Resenias resenia279 = new Resenias("Pelicula muy en la línea de Historias Mínimas, (es prácticamente un calco muy bien hecho). Se nos muestra la realidad de un país, de un amplio sector de la sociedad argentina que permanece agarrada a  unos sueños, a unos ideales que permanecen muy arraigados.", "", usuario18, null);
		Resenias resenia280 = new Resenias("“El camino de San Diego” (2006), merecidísimo Gran Premio del Jurado en el Festival de San Sebastián, es el quinto largometraje del argentino Carlos Sorin. Como en la mayor parte de sus trabajos anteriores -”Eterna sonrisa en New Jersey” (1989), “Historias mínimas” (2002), “Bombón, el perro” (2004).", "", usuario10, null);
		Resenias resenia281 = new Resenias("Que es el Diego para parte del pueblo argentino. Para esa parte del pueblo separado por la línea de la General Paz del Buenos Aires cosmopolita (aunque también ahí tiene sus fans, y muchos), y que define a La Otra, a la Otra Argentina que nunca ha podido demostrarse a si misma que El Dorado existía.", "", usuario37, null);
		Resenias resenia282 = new Resenias("A modo de falso documental, se nos presenta a Tati Benitez, un joven animado y jovial, fanático de Maradona. Su vida da un vuelco cuando se queda sin empleo y, casi al mismo tiempo, su ídolo máximo es ingresado en una clínica por un problema cardíaco.", "", usuario33, null);
		Resenias resenia283 = new Resenias("Carlos Sorin vuelve a convencer en esta reciente película que sigue el esquema de una road movie, como también ocurría en “Bombón, el perro”. Y vuelve a utilizar un personaje lleno de dignidad que a pesar de su pobreza disfruta de las cosas de la vida.", "", usuario16, null);
		Resenias resenia284 = new Resenias("Tulio y Susana (Leandro Castello y Mercedes Scápola), un hombre de edad incierta (¿envejecido?), deteriorado por su circunstancia, y su sobrina llegan a Buenos Aires desde un pueblo del interior. Acaban de ser empujados del rancho en el que vivían, rodeados de gallinas y chivos.", "", usuario18, null);
		Resenias resenia285 = new Resenias("Es interesante encontrarse con un película como esta, que en momentos nos lleva a la reflexión; hacía rato que no me reía con los personajes muy bien elaborados, (tal vez tulio tendría que estar mas envejecido), la fotografía excelente. Por vivir en un pueblo bastante similar a lo que puede se Nogolí, me puedo identificar con partes de la película que son tristemente ciertas.", "", usuario19, null);
		...
		Resenias resenia300 = new Resenias("Versión del Martín Fierro en animación, si bien matizada para un público de menor edad, no se toma demasiadas libertades poéticas y representa fielmente el poema de José Hernandez. Con dibujos dirigidos por Fontanarrosa, esta trabajada de una manera muy interesante la imagen.", "", usuario30, null);
		...
		Resenias resenia312 = new Resenias("Filmación de un día de naturaleza pampera y de naturaleza humana, ambas en simbiosis. Lisandro Alonso es un maestro en filmar la soledad, el comportamiento, el ir y venir de seres humanos solitarios; así lo ha dejado patente en varias de sus obras.", "", usuario4, null);
		...
		Resenias resenia319 = new Resenias("Realmente no es una mala película... Entonces ¿Por qué esa nota tan baja?  Porque este tipo de trabajos son tan predecibles que no mantienen la tensión dramática, se sustentan únicamente sobre la emocional, de ella se nutren y avanzan.   Cuando veo alguna película, serie, corto, me interesa su desarrollo, su planteamiento y.", "", usuario19, null);
		...
		Resenias resenia321 = new Resenias("No sé por qué hablar siempre sólo de Hitler cuando EEUU -Kissinger- hizo cosas peores que Mengele. Qué si no es eliminar una generación tirando a muchos de ellos desde aviones al mar, -los vuelos de la muerte-  y dar los bebés a parejas afines a la dictadura.", "", usuario1, null);
		Resenias resenia322 = new Resenias("Sin duda una película para cinéfilos. Para el que no busque ni acción ni sustos, y que si disfrute de tramas inteligentes. Después de la original y primera película “Nueve Reinas”, este director y guionista nos trae una historia mucho más relajada, más oscura y con un ritmo bastante más lento, además de mucho más profunda e inteligente; una trama que va creciendo en intensidad y suspense conforme van pasando los minutos; te mete dentro de la mente del personaje principal (superior interpretación de Ricardo Darín) y no te deja tranquilo en ningún momento.", "", usuario4, null);
		...
		Resenias resenia324 = new Resenias("Película de suspense, engancha desde el primer momento. La fotografía y el clima que es capaz de generar, lo más destacable. La pareja Darín-Bielinsky repite tras &quot;Nueve Reinas&quot;.", "", usuario26, null);
		...
		Resenias resenia334 = new Resenias("Desde el punto de vista puramente cinematrográfico es una película humilde, con golpes bajos por momentos innecesarios, elaborada con tesón pero con algunas fallas fílmicas grandes y notorias. Pero perdón, no puedo dejar de decir algo desde el corazón.", "", usuario30, null);
		Resenias resenia335 = new Resenias("Podría haber sido mejor si no se hubiese hecho la historia mirando con un solo ojo. Como película bélica hay que tener en cuenta que es Argentina y como tal (presupuesto y efectos especiales por medio) no llega a las alturas de ningún filme norteamericano, pero independientemente las escenas bélicas matizan un poco la película.", "", usuario22, null);
		Resenias resenia336 = new Resenias("PREMIOS:San Sebastián: Premio Especial del Jurado Premio Goya por mejor película extranjera de habla hispana==================HECHOS (por Wikipedia):Los propios ex combatientes de Malvinas han expuesto su desacuerdo con la película, que fue presentada como una historia real cuando los hechos parecen indicar que Esteban Leguizamón no fue partícipe de las acciones como las relata la obra.", "", usuario8, null);
		Resenias resenia337 = new Resenias("“Cuestión de principios” combina varias líneas narrativas que circulan por los canales de la comedia dramática. Estética y narrativamente, es una película convencionalmente clásica, que se parece a los valores que encarna su protagonista principal, un impecable Federico Luppi que apela a su no tan frecuente costado de comediante.", "", usuario18, null);
		...
		Resenias resenia346 = new Resenias("Gran actuación de Marrales. La película va de menor a mayor. Lo único que he escuchado por ahí, es que la verdadera obra del padre Mario es gigantesca e imposible de resumir en una pelicula de hora y media. Nos quitamos el sombrero ante Doria. Queremos más cine de esta calidad.", "", usuario7, null);
		Resenias resenia347 = new Resenias("La leyenda dice que el ave Fenix resucita de sus propias cenizas. El ciclo interminable de la vida y la muerte. En este caso el ave es reemplazada por la mosca, que puede hundirse y ahogarse en el agua pero la ceniza la devolverá a la vida. La mosca.", "", usuario6, null);
		Resenias resenia348 = new Resenias("Ví la película &quot;La Mosca En La Ceniza&quot; y es buena pero por momentos no me atrapó mucho.El comienzo me pareció entretenido y luego atrapante pero me esperaba otra cosa mejor.La historia realista está bien contada pero se pudo haber mejorado.", "", usuario35, null);
		Resenias resenia349 = new Resenias("Parece que algo va a pasar en cualquier momento. El dolor sostenido de la protagonista es tan fuerte como las imágenes en blanco y negro inspiradas en Bergman o en el Allen de Interiores. Ese algo que va a pasar es lo que sigue al final de la película.", "", usuario32, null);
		...
		Resenias resenia355 = new Resenias("Cine under argentino, simple y contundente. Teniendo fresquito el recuerdo de &quot;La 21, Barracas&quot;, Vikingo se engrandece en la comparación. Es que de todo lo que La 21 adolesce, Vikingo hace su mayor mérito. Vikingo es un personaje craso, rudo, pero mucho más sensible que lo que habría de esperarse.", "", usuario25, null);
		Resenias resenia356 = new Resenias("Me fascina el cine de Lucrecia Martel. Adoro su manera de contar, de filmar, la dirección perfecta que tiene sobre sus actores (es la única directora que puede hacer actuar a un muerto) su obsesión por contar lo que parece no interesar a nadie. Sus pequeñas grandes historias de su Salta natal.", "", usuario24, null);
		Resenias resenia357 = new Resenias("Vuelta a las andadas de Lucrecia Martel, una directora con un estilo inconfundible: estupendo manejo de la cámara, buena fotografía, gran dirección de actores, personajes problemáticos, punto de vista femenino aunque otorgando bastante protagonismo a los personajes masculinos.", "", usuario16, null);
		Resenias resenia358 = new Resenias("Lucrecia Martel es una gran directora, y sus películas constituyen exquisito arte. Puro placer estético. Su cine es un cine de climas, de sensaciones. Qué maravilla que los recursos del cine y el talento de una directora puedan permitir estas composiciones.", "", usuario17, null);
		Resenias resenia359 = new Resenias("Apadrinada por los hermanos Almodóvar, la argentina Lucrecia Martel ambienta su segunda película &quot;La Niña Santa&quot; en un hotel donde se celebra un congreso de medicina y donde conviven unas adolscentes que reciben adoctrinamiento religioso.", "", usuario34, null);
		...
		Resenias resenia367 = new Resenias("Marco Berger logra en este largometraje lo qué otro no podría haber conseguido en un cortometraje.Plan B es una historia honesta, donde su director la construye con piezas sencillas pero sólidas, construye la historia desde su silencios, desde sus stop y sus pausa la construye desde un trabajo actoral más qué destacado de Manuel Vignau y Lucas Ferrero (a los qué la historia los toma por sorpresa pero no parecería tanto) el film se construye como una pirámide sólida desde el arranque pero tambalea cuando se esta acercando a la cima (hablo de lo argumental y no del declive del film); Berger pone el corte justo, los títulos aparecen en el preciso momento que deben aparecer, ni uno más ni uno menos.", "", usuario22, null);
		Resenias resenia368 = new Resenias("Adorable película de temática gay del cine argentino. Con personajes creíbles, sinceros, honestos. Son personajes que te enamoran. Deseas ser amigos de ellos, porque no tienen mas pretenciones que ser ellos mismos. Me encantó,  me enamore de esta película, el guión, la dirección, los actores, todos se complementan y nos ofrecen el nacimiento de una historia de amor urbano, sin pretenciones.", "", usuario6, null);
		Resenias resenia369 = new Resenias("Es cierto que abusa de las pausas pero le dan el ritmo a la película. No me pareció en absoluto larga,  todo lo contrario, me pareció diferente y muy valiente. Lo bueno es que es una historia en la que da igual la orientación sexual de los personajes, te los crees de principio a fin.", "", usuario32, null);
		Resenias resenia370 = new Resenias("El ritmo no es una novedad, las pausas tampoco, ni la ausencia de música. Pero todo contribuye a lo mismo, al tema de la película: la tensión de Pablo, el único que no juega, que se explora, que se permite vivir sin prisa ni miedo al resultado, consciente de poseer prejuicios que no le impiden nada.", "", usuario18, null);
		Resenias resenia371 = new Resenias("El binomio Burman-Hendler regresa ahora con una película de tono más gentil que &quot;El abrazo partido&quot;, ese film que muchos denominaban comedia cuando el drama le salía por los poros. &quot;Derecho de familia&quot; reincide en las relaciones familiares, en los problemas de comunicación y si en &quot;El abrazo partido&quot; no eran muy buenas esas relaciones aquí se demuestra que aún siendo buenas nos quedamos cortos.", "", usuario9, null);
		Resenias resenia372 = new Resenias("Esta no es una película de género, aunque circule entre la comedia y el drama ligero, a la manera de algunas películas de Truffaut, de quien Burman se diferencia en acentuar menos la poesía que los matices del humor en situaciones extremadamente simples.", "", usuario13, null);
		...
		Resenias resenia375 = new Resenias("Si, tiene un arranque bastante bueno y la relación padre-hijo tiene muchos matices, pero en general la película me pareció falta de vida, sosa y reiterativa. Por su tono tan frío me es difícil emocionarme con ella, porque ni funciona como comedia ni como drama, y si lo hace, aunque, a medias, es como análisis en torno a las relaciones de pareja, la madurez y el paso del tiempo.", "", usuario32, null);
		Resenias resenia376 = new Resenias("El asaltante parece un fragmento de otra película mayor. Todos sabemos cómo se estructura  una película tipo; ésta se divide en tres partes: presentación, nudo y desenlace. Pues imaginen una película diseccionada sobre la mesa de edición. Tomamos la presentación y la arrojamos a la basura, tomamos el desenlace y hacemos lo mismo: nos quedamos sólo y exclusivamente con el nudo.", "", usuario36, null);
		Resenias resenia377 = new Resenias("Cabe recordar, que a partir de manifiestos como el Ulises de James Joyce, el esquema ático “presentación-nudo-desenlace” ha sido despojado de su primado y puesto en paridad. Es solamente un modo del ser, no uno de sus trascendentales. De manera que, corroer una trama por sospechar que se consuma nudamente, como pulpa expuesta, sin las tapas, sin el pecho y el rabo de uso, no es más que consumar un juicio epocalmente impropio.", "", usuario37, null);
		Resenias resenia378 = new Resenias("La acción transcurre prácticamente en tiempo real. El protagonista es un ladrón de guante blanco que roba colegios privados sin disparar un sólo tiro, interpretado por Arturo Goetz, con el porte necesario para pasar desapercibido ante sus víctimas.", "", usuario19, null);
		...
		Resenias resenia380 = new Resenias("Es cruda. Un baño de humildad. Es lo que nos espera.David Burgos interpreta magistralmente su papel.Es darwinismo social, solo los más fuertes sobreviven y el ejemplo: &quot;Perú&quot; es el buscavidas perfecto pero.... por encima de él está la mujer, Yekaterina, con sus artes (con sus armas) lo lleva al huerto y consigue sobrevivir a su costa.", "", usuario24, null);
		...
		Resenias resenia383 = new Resenias("Confieso que he esperado esta película con mucha expectativa. Me predispuse de la mejor forma para degustarla pero finalizada la misma el paladar me quedo adormecido, como después de masticar hielo. La película no es mala, es cierto, pero prometía mucho más.", "", usuario28, null);
		Resenias resenia384 = new Resenias("A priori, se podría ubicar a este film dentro del mismo género que “Belgrano: la película” ya que en ambos casos se trata de reconstruir una parte de la historia de nuestro país pero con un enfoque basado en la personalidad del personaje principal, José de San Martín en este caso.", "", usuario37, null);
		...
		Resenias resenia389 = new Resenias("Lo siento, pero después de ver tanto cine bueno (dentro de la propia Argentina, además) no me vale con un puñado de moralinas y cuatro escenas cómicas para decir que algo es, por lo menos, interesante. La parte inicial de la película es ramplona y está mal sujeta por el elenco joven que la interpreta, y aunque es verdad que el guión se va entonando y al final hasta consigue enternecer un poco al espectador, lo cierto es que eso no es suficiente para salvar la película.", "", usuario36, null);
		Resenias resenia390 = new Resenias("Me pareció una película bastante ocurrente para ser argentina... Me gustó mucho el lazo que se genera entre el pibe y el fantasma, quien parece ser muy rudo, pero al final se termina quebrando ante las situaciones que no supo ver y que se entero muchos años después.", "", usuario15, null);
		Resenias resenia391 = new Resenias("Este cuarto largometraje de la realizadora María Victoria Menis es una bienaventurada rareza en el cine argentino actual, no sólo porque prescinde de actores conocidos pero que igualmente demuestran un sólido oficio forjado en el teatro independiente, sino por su apuesta temática y narrativa, a contracorriente de buena parte de la producción nacional.", "", usuario4, null);
		Resenias resenia392 = new Resenias("María Cristina Menis demuestra cómo se hace un excelente cine a partir de una historia aparentemente sencilla. &quot;La cámara oscura&quot; es una película de esas que hay ver nueva vez. De manera sutil te va llevando a un reconocimiento de los valores esenciales del ser, a mirar con ojos atentos lo importante de este mundo.", "", usuario17, null);
		...
		Resenias resenia397 = new Resenias("La película es buena, las actuaciones están bien y la historia es buena y fue real. Un par de detalles erróneos en el comentario es la locación de la historia; se dice sucedió en Buenos Aires, cuando los hechos ocurrieron en el correccional penal de Punta Carretas, en la ciudad de Montevideo, Uruguay; la otra diferencia es que sólo fueron 3 los escapados, y eran todos anarquistas.", "", usuario37, null);
		Resenias resenia398 = new Resenias("A mi modesto criterio, esta película es un libro de fotografías demodé, más que un film....Resultón gasto de producción para la ambientación y tal, pero fallida historia, a la que no se le encontra nunca la razón y el sentido entre las situaciones deslabazadas.", "", usuario7, null);
		Resenias resenia399 = new Resenias("Pues a mí me ha gustado, y mucho, &quot;La fuga&quot; de Eduardo Mignogna. Libertades históricas aparte (Buenos Aires en lugar de Montevideo y siete fugados en lugar de los tres que en realidad fueron) la película es muy sólida y con magníficos giros de guión que sorprenden y hacen más atractiva la cinta.", "", usuario19, null);
		Resenias resenia400 = new Resenias("Terminé de ver &quot;Mía&quot; con la sensación incomparable de haber asistido a un espectáculo maravilloso. Más allá de su mirada social y de su profundo compromiso artístico, &quot;Mía&quot; resume el encanto de las cosas bien hechas. Un guión contundente, unas actuaciones a medida y una sensibilidad que se desprende de su piel como un ejercicio mágico.", "", usuario37, null);
		Resenias resenia401 = new Resenias("El asadito trata de unos amigos que se reúnen para comer el 30 de Diciembre de 1999. La acción transcurre en la ciudad de Rosario, Argentina. Cada uno de los personajes encarna un cierto rol muy delimitado, sin demasiada profundidad y en algunos casos de manera un tanto histriónica.", "", usuario7, null);
		Resenias resenia402 = new Resenias("Los siete amigos que vemos en este film tienen algo en común. Nacieron entre las décadas del 60/70. Llegado el día del rodaje, en 1999, ya varios pelan canas, arrugas, miradas de desencanto y un considerable camino andado por sus respectivas vidas.", "", usuario36, null);
		Resenias resenia403 = new Resenias("Cuando vi el título, leí la trama y conocí su duración me dije, tengo que ver esta película. No me defraudó, un film interesante y que ayuda a pasar el rato. Las actitudes, gestos, palabras son para mí (argentino) conocidas y por ello más de una vez graciosas.", "", usuario23, null);
		...
		Resenias resenia405 = new Resenias("Con lo que se gasta una europea en venir desde su país hasta Argentina, la estancia larga ahí y luego el pago por llevarse un bebé (todo de manera ilegal y tratando con desalmados  intermediarios cuyo negocio es la venta de seres humanos), es decir unos 30.", "", usuario17, null);
		Resenias resenia406 = new Resenias("Interesante peli argentina sobre la adopción ilegal de niños, tráfico de lo más espinoso porque nadie garantiza las buenas intenciones del “comprador” (al que no se le hacen demasiadas preguntas cuando desembolsa la friolera de 20 o 30.000 euros por un niño), de manera que pueden acabar siendo pasto de la prostitución infantil o la venta de órganos.", "", usuario10, null);
		Resenias resenia407 = new Resenias("Con la intención de desocultar una realidad que muchos no conocen, Juan Solanas (ver spoiler), elige un tema doloroso y encubierto en la Argentina: el tráfico de niños vinculado con la adopción ilegal pero también con el negocio de órganos y la prostitución infantil.", "", usuario11, null);
		Resenias resenia408 = new Resenias("Nordeste trata el tema de la adopción internacional de niños, en este caso en Argentina, y sigue las peripecias de una ejecutiva francesa soltera y de mediana edad en su búsqueda de un bebé. Formaría una buana trilogía con La Casa del los Babys de John Sayles y la más reciente La Pequeña Lola de Bertrand Tavernier, pero se distancia de ellos en la forma de contar la historia, muy pausada y sin hacer partícipe a la cámara de la intensidad emocional que vive los personajes (en contraste con el exceso de cámara en mano del que hacía uso Tavernier).", "", usuario24, null);
		Resenias resenia409 = new Resenias("Es el nordeste argentino, lugar donde está contextualizada la ópera prima de Juan Solanas, una de las regiones más deprimidas del país sudamericano. Esta descarnada historia, que bebe del realismo social más aguerrido, denuncia sin paliativos ni edulcorantes la adopción ilegal de infantes en las zonas más depauperadas del globo.", "", usuario22, null);
		Resenias resenia410 = new Resenias("&quot;No sos vos, soy yo&quot; o lo que es lo mismo; &quot;no eres tú, soy yo&quot;; es una frase tan vieja como habitual en el día a día de la especie humana. Hoy le toca al amigo, mañana al vecino y pasado te toca a ti. Y Taratuto sin duda sabe de qué está hablando.", "", usuario20, null);
		Resenias resenia411 = new Resenias("En el ranking de las tres frases más jodidas que puede decirte el amor de tu vida están las que siguen:- &quot;Tenemos que hablar&quot;.- &quot;Eres como un hermano/a para mí&quot;- &quot;Sí, me lo he follado&quot;.", "", usuario5, null);
		Resenias resenia412 = new Resenias("Qué condenadamente jodidas pueden ser las relaciones. Lo realmente malo es que tenemos la manía de ilusionarnos, de empezar a pensar en mañana. El ser humano tiene la estúpida obsesión de creer que, en cuanto alguien le ofrece unas migajas, ya sus manos van a pasear unidas por los oleajes del tiempo durante toda la eternidad.", "", usuario3, null);
		Resenias resenia413 = new Resenias("En esta opera prima de Juan Taruto la historia es todo un drama, pero el guión le da un delicioso clima de comedia que el director saca adelante con altas dosis de ironía, agilidad y, por supuesto, humor. Presentar el terrible conflicto del protagonista con una sonrisa es el gran mérito de este trabajo.", "", usuario31, null);
		...
		Resenias resenia417 = new Resenias("Las crisis por decreto de intereses es el modus vivendi con el que las últimas generaciones en Latinoamérica hemos sido acondicionadas, irremediablemente conferidas de nacimiento. Acá las crisis algunos las viven, otros la soportan y la mayoría las sufre.", "", usuario0, null);
		Resenias resenia418 = new Resenias("La novelista y directora argentina Lucía Puenzo se caracteriza por abordar temas que atraviesan la biología y la sexualidad en la adolescencia, con un punto de vista que rescata lo natural y espontáneo de esa etapa de cruce hacia el mundo adulto, tal como se evidencia en sus películas anteriores como “XXY” o “El Niño Pez.", "", usuario21, null);
		Resenias resenia419 = new Resenias("Realmente me hubiera gustado ponerle más puntaje a esta peli, porque está muy bien filmada, tiene actuaciones solidas y un tema más que atrayente. Pero resulta la verdad que salí del cine con una sensación de gusto a poco y, después de rumiar un rato más, la sigo teniendo.", "", usuario30, null);
		Resenias resenia420 = new Resenias("Tercera película de la directora argentina Lucía Puenzo, que adapta su propia novela, que a su vez se basa en la historia real de Josef Mengele: un despiadado criminal Nazi, que tras la Segunda Guerra Mundial se refugio en Sudamérica, donde continuo con sus experimentos en animales y niños.", "", usuario37, null);
		...
		Resenias resenia422 = new Resenias("Con una destacable realización y unas interpretaciones que sostienen la trama, el &quot;Médico alemán&quot; quizás adolece de querer ser demasiado sutil en el desarrollo del suspense. Tanto que roza la pérdida del interés del espectador en algunos momentos.", "", usuario5, null);
		Resenias resenia423 = new Resenias("Hay una mancha de humedad en tu departamento, puedes hacer de cuenta que no está allí pero, como dice el dicho, &quot;acuéstate con chicos y amanecerás mojado&quot;.Lo sorprendente de La mala verdad es su capacidad para implotar, en vez de explotar.", "", usuario20, null);
		...
		Resenias resenia439 = new Resenias("La flamante remake del clásico de Daniel Tinayre , realizado en 1960, justifica la actualización de su propuesta, que incorpora la actualidad de su propio tiempo y a su vez interpela hasta qué punto nos hemos desacostumbrado a los dilemas éticos y su consecuente dialéctica para defender ideas y consecuencias.", "", usuario17, null);
		Resenias resenia440 = new Resenias("La película de Mitre es un profundo despropósito. Pretende hacer un análisis moral de la sociedad occidental pero para ello utiliza un guión poco o nada creíble. La película no desgrana las motivaciones que conducen a los actos de la protagonista.", "", usuario12, null);
		Resenias resenia441 = new Resenias("Estamos ante un retrato poderoso de un personaje femenino que marca su independencia, que se enfrenta a su padre y a su novio, se rebela contra una previsible carrera exitosa en la judicatura y se revuelve contra las decisiones que otros toman por ella, colisionando con los convencionalismos al uso y demostrando que la integridad moral no conoce de vínculos afectivos, ni de servilismos trasnochados, ni de sumisiones tácitas o expresas.", "", usuario20, null);
		Resenias resenia442 = new Resenias("En su segundo largometraje –un remake de «La patota» de Daniel Tinayre–, el argentino Santiago Mitre construye un drama de gran fuerza emotiva que se sostiene completamente sobre los hombros de su complejo personaje protagonista, Paulina, una joven idealista que será víctima de una violación.", "", usuario27, null);
		Resenias resenia443 = new Resenias("Hermosísima película. Endemoniadamente compleja, interesante y bien hecha.Todos sabemos que las grandes causas, los idearios bellos, los discursos al viento, todo el entramado de frases, sentencias, normas, leyes, derechos..., y demás reglas del juego son, en la medida en que se acercan a la cruda realidad, no más que un pálido reflejo de su celestial intención inicial.", "", usuario6, null);
		Resenias resenia444 = new Resenias("Un treinteañero, que hace 10 años era un joven que vivía al día, sólo pensando en sí mismo y sin importarle lo que pensara la gente, se encuentra con una extraña situaciòn:ahora que ya tiene su vida hecha pero continúa inseguro en sus relaciones, resulta que una niña de 10 años le hace descubrir que la vida puede tener otro sentido menos frívolo y más gratificante.", "", usuario6, null);
		Resenias resenia445 = new Resenias("Nacionalidad: argentina. Los argentinos no dejan de sorprender con su cine, ya sea comedia, construyendo historias al uso o con este cine pausado. Rubén es un camionero que viaja de Paraguay a Buenos Aires, 1500 km. En este viaje, por petición de su jefe, debe llevar con él a una mujer paraguaya, Jacinta, que además va acompañada de su bebé, una niñita sorprendente.", "", usuario7, null);
		Resenias resenia446 = new Resenias("Entrañable y optimista película capaz de hacernos recordar  que siempre se puede volver a empezar, que no todo es igual per secula seculorum. Es una película radical en su desarrollo, no da concesiones a la galería, pero por la fuerza de sus imágenes y el tratamiento de las situaciones y personajes,  logra que te llegues a  sentirte dentro de esa cabina, a sentir y comprender los sentimientos de los dos personajes adultos, a deleitarte con la alegría de vida de la beba tan indiferente –por otra parte- a lo que ocurre en esa cabina de camión.", "", usuario25, null);
		Resenias resenia447 = new Resenias("Mientras transcurría la película me lo pregunté varias veces: ¿Cómo una película puede ser lenta, con pocos diálogos, sin música y  con planos fijos y, sin embargo, generar una sensación de incomodidad, de tensión constante?¿Cómo pueden tres personajes que hablan muy poco (o nada) meterse adentro del corazón del espectador y lograr que uno se sienta identificado con ellos?La respuesta: así.", "", usuario3, null);
		Resenias resenia448 = new Resenias("Aunque esta película no desprenda el nivelazo al que me tiene acostumbrada el cine argentino, se trata igualmente de una historia agradable de ver. Transcurre de manera sosegada (quizá demasiado). Los actores estan muy bien y basicamente podemos intuir el resurgir de un sentimiento escondido, el deseo de volver a estar en compañía, querer y ser querido.", "", usuario36, null);
		...
		Resenias resenia455 = new Resenias("Vista en perspectiva histórica de su estreno en el 2004 pocas veces en Argentina se había aventurado al género de la comedia romantica. Pero con El amor (Primera Parte) se llega a un género que en comparación a posteriores películas como las de Juan Taratuto (especialmente) es más de un estilo de ensayo sobre el amor, con elementos de una historia de ficción suaves tamizadas por momentos de lecciones acerca de la experiencia del amor desde un punto de vista cientificista, racional que sirve esto último para darle un toque de humor, para sazonarla y descubrir su divague intelectual de estos cuatro directores.", "", usuario35, null);
		Resenias resenia456 = new Resenias("No voy a hacer una crítica detallada. Sólo voy a decir que la vi hace poquito y me hizo acordar mucho a Blue Valentine y a 500 Días juntos (500 Days with Summer). Un poco me indignó el parecido, ya que ambas me habían gustado, pero esto ya me parecía una copia.", "", usuario26, null);
		...
		Resenias resenia459 = new Resenias("Al margen de sus valores cinematográficos, tal vez el principal mérito de esta película sea el de introducir al espectador en el fascinante -y para muchos supongo que exótico- mundo del Zen. Y lo hace sin rubor, sus personajes tienen inquietudes espirituales (¿espiri.", "", usuario31, null);
		...
		Resenias resenia468 = new Resenias("Este humilde, sencillo pero exquisito retrato de los avatares de una familia argentina de barrio me ha llegado desde el minuto uno. Suena un tema de Bersuit: &quot;Qué linda que estás, sos un caramelo, te veo en el recreo y me vuelvo loco.", "", usuario37, null);
		Resenias resenia469 = new Resenias("Como ya demostrara en su interesante &quot;No sabe / No contesta&quot;, Fernando Musa sabe llegar a nosotros con un estilo despojado de cualquier artificio, con buenos diálogos, sencillez y unos personajes muy cercanos.El humor vuelve a estar presente, acompañado muchas veces de una invitación a la reflexión, lo que por momentos le da un toque agridulce.", "", usuario30, null);
		Resenias resenia470 = new Resenias("Una hermosa y engreida mujer Andrea Galante (preciosa) se enamora de un niño más inmaduro que ella aún y el resultado es que van a tener un hijo. Sin idea alguna de lo que quieren para sus vidas y con un futuro incierto desde todo punto de vista, se desarrolla la trama del film, el cual tiene un final inesperado y estoy seguro que daras gracias a Dios, ya que fue lo mejor que pudo suceder, tierna, graciosa por momentos y precisa en su dosis de drama, para mi una obra muy digna de apreciarse la cual no te defrauda a pesar de un lógico rechazo a este tipo de historias.", "", usuario26, null);
		...
		Resenias resenia514 = new Resenias("Ni Dios, ni patrón, ni marido es una historia generada a partir de un personaje real, Virginia Bolten (1870-1960?), redactora de la primera publicación feminista latinoamericana denominada “La voz de la mujer”, cuyo lema era “Ni Dios, ni patrón ni marido”, que durante 9 números (editados en la clandestinidad entre 1896 y 1897), dió una perspectiva anarcofeminista en la defensa de los derechos elementales de la mujer y los trabajadores.", "", usuario9, null);
		Resenias resenia515 = new Resenias("He de confesar que suelo ser bastante escéptico ante cualquier película revisionista, de corte político o de trasfondo histórico y ante la visión de ésta, y que no me pasase como con &quot;Las Hurdes&quot;, preferí documentarme antes y, efectivamente, salvo algún nimio detalle está púlcramente construida.", "", usuario5, null);
		Resenias resenia516 = new Resenias("Decía el pianista Franz Listz que “La música es el corazón de la vida. Por ella habla el amor, sin ella no hay bien posible y con ella todo es hermoso” Una frase que cala muy hondo en el director Gabriel Nesci, que nos presenta en su primer largometraje una historia que habla de música, de amor, de amistad, de belleza y de vida.", "", usuario17, null);
		...
		Resenias resenia518 = new Resenias("Días de vinilo es una comedia romántica un tanto previsible que narra las peripecias vitales de cuatro tipos unidos por la música y una larga amistad. Tiene, no obstante, un arranque notable, con una atractiva puesta en escena a la que rápidamente suceden unos diálogos, chistes y situaciones chispeantes, sin duda lo mejor de la película.", "", usuario18, null);
		Resenias resenia519 = new Resenias("Si bien son incomparables en cuanto a realización concierne, ambas centran sus atractivos principales sobre el amor y la música. Musicalmente hablando Hi-Fi está sin dudas por encima, pero respecto a la transferencia de valores en sí, tenemos una indiscutida ganadora.", "", usuario10, null);
		Resenias resenia520 = new Resenias("Aclaro que soy fanático de la serie para televisión TODOS CONTRA JUAN, en sus dos temporadas, programa que me encantó y me encandiló como uno de los mejor realizados hasta la fecha en Argentina. Así es como me encuentro con esta película, la cual parece un genial apéndice cinematográfico de aquella gran serie protagonizada igualmente por Gastón Pauls.", "", usuario3, null);
		Resenias resenia521 = new Resenias("Una vez más caí en una “historia chiquita” que tanto provoca al cine argentino. Ópera prima de Diego Lerman (2002), blanco y negro, actrices desconocidas, en fin… pero debo agregar que no resultó un embole como suele suceder en este género.", "", usuario9, null);
		Resenias resenia522 = new Resenias("La película es interesante, a ratos intensa. El gran fallo son los personajes, en especial el de la chica que va a por la protagonista. Su actitud no parece creíble o convincente, aunque las actuaciones sí dan la talla. Es un problema, parece, de guión.", "", usuario32, null);
		...
		Resenias resenia531 = new Resenias("Y es que no tiene absolutamente nada. Primero como película, no tiene una puesta en escena o dirección con personalidad tan siquiera, esas imágenes genéricas de telenovela. No hay buenas actuaciones y tal vez, lo que podría haber sido también queda en ridículo por el absurdo guión.", "", usuario34, null);
		Resenias resenia532 = new Resenias("¿Vale la pena verla? Yo creo que sí. Una película que te hace reír, emocionar y que da elementos para pensar ya vale la pena. ¿Tiene fallas? Algunas sí, es un poco previsible, la música es demasiado protagonista. Pero las actuaciones son Excelentes, muy buenos trabajos de todos los actores, da gusto ver cómo desarrollan sus personajes.", "", usuario6, null);
		Resenias resenia533 = new Resenias("Es la historia de varias pequeñas historias de pequeños personajes de la gran urbe de Buenos Aires, que se llegan a cruzar de alguna manera y en algún momento, con el trasfondo evidente de la terrible crisis económica reciente de nuestros hermanos argentinos.", "", usuario17, null);
		Resenias resenia534 = new Resenias("Historias que se encuentran en ése cruce común a todos que es la búsqueda de amar y ser amado, de escuchar y de que te escuchen.Con el trasfondo común a varios de sus trabajos, el judaismo, Burman hace un retrato de personajes en constante búsqueda, creíbles y humanos.", "", usuario7, null);
		Resenias resenia535 = new Resenias("Daniel Burman empieza a alinearse en las peliculas de autor con Esperando al Mesias. De la misma manera que sus personajes en sus películas (posibles alter ego) el busca su propia manera de filmar, su temática, su toma de posición ante la cuestión y la identidad argentina .", "", usuario21, null);
		Resenias resenia536 = new Resenias("Burman es un director a tomar en cuenta. Ya nos sorprendió en &quot;Derechos de familia&quot;. Es un director que sabe tratar &quot;esa dura condición humana&quot;. Hace que revisemos, nos invita a eso...", "", usuario12, null);
		Resenias resenia537 = new Resenias("Vi la película porque soy fan de Sbaraglia y me encantan todas sus pelis, pero en cuanto vi a Norma Aleandro me quede totalmente impresionado. Es la primera vez en mi vida que me entran ganas de llorar con cada escena que tiene una actriz, da igual lo que esté haciendo.", "", usuario29, null);
		...
		Peliculas pelicula28 = new Peliculas("Camino a La Paz",2015,"",92,"Sebastián (Rodrigo de la Serna) es un joven recién casado, fanático de Vox Dei. El protagonista, motivado por una necesidad económica, comienza a trabajar de remisero con su Peugeot 505. En este trabajo conoce a Khalil (Ernesto Suarez), un anciano poco gentil. Juntos emprenderán un largo viaje desde Buenos Aires hasta La Paz (Bolivia), donde se pondrá a prueba la relación de los dos protagonistas.",0,"imgs/peliculas/28.jpg","rGI1fFi8BHM",actorespelicula,director21,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula29 = new Peliculas("El artista",2008,"",91,"Jorge (Sergio Pángaro) es un enfermero que pasa de cuidar ancianos en un geriátrico a convertirse en el nuevo niño mimado de la escena artística bonaerense. Tras presentar como propias unas pinturas de uno de los ancianos, su vida simple y monótona se transforma de repente en un constante peregrinar por galerías de arte, universidades, programas de televisión, y reuniones con artistas e intelectuales.",0,"imgs/peliculas/29.jpg","OPnrG9veqpo",actorespelicula,director5,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula35 = new Peliculas("Whisky Romeo Zulu",2004,"",107,"Whisky Romeo Zulu narra la historia previa al accidente del Boeing 737 de LAPA que, el 31 de agosto de 1999, se incendió tras impactar contra un terraplén en pleno centro de Buenos Aires, provocando la muerte de 67 personas. La catástrofe cambió la historia de la aviación civil y comercial en Argentina, y la película relata, desde la óptica del director -un ex piloto de líneas aéreas- cómo en algunos países la seguridad de los vuelos es increíblemente precaria.",0,"imgs/peliculas/35.jpg","Xf-NdiKSyY",actorespelicula,director26,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula37 = new Peliculas("El polaquito",2003,"",92,"Un chico de la calle, de 13 años de edad, se gana la vida cantando tangos en los trenes de la estación central de Buenos Aires. Imita a Polaco Goyeneche, el famoso cantante de tangos, por lo que la gente le conoce como &quot;El Polaquito&quot; (Abel Ayala). El Polaquito conoce a &quot;Pelu&quot; (Marina Glezer), una joven prostituta que también trabaja en la estación de Constitución, de la cual queda inmediatamente prendado y a la que intenta rescatar de la mafia que la explota.",0,"imgs/peliculas/37.jpg","PEVIHud1gXs",actorespelicula,director28,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula44 = new Peliculas("El clan",2015,"",110,"La historia se basa en el caso policial del Clan Puccio, que conmocionó a la sociedad argentina a principios de los 80. Tras la aparente normalidad de la familia Puccio se oculta un siniestro clan dedicado al secuestro y al asesinato. Arquímedes, el patriarca, miembro del Servicio de Inteligencia desde la dictadura, lidera y planifica las operaciones.",0,"imgs/peliculas/44.jpg","n7kpI79cPBk",actorespelicula,director17,reseniaspelicula,usuario,genero0, true);
		...
		Peliculas pelicula47 = new Peliculas("El abrazo partido",2003,"",100,"Narra la historia de un &quot;adolescente tardío&quot; que busca un pasaporte para huir de Argentina pero al que el regreso de su padre, que abandonó a la familia por un ideal, le trastoca los planes. Pese a ello, y gracias a este reencuentro, el hijo buscará a través de su padre su propia identidad.",0,"imgs/peliculas/47.jpg","qHvys9ERRkg",actorespelicula,director34,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula56 = new Peliculas("Nueces para el amor",2001,"",103,"En 1975, unos meses antes del comienzo de la dictadura militar argentina, Alicia y Marcelo se conocen en un concierto de rock. El amor surge inmediatamente entre ellos, pero el retorno del novio de Alicia provoca la separación. En 1982, en Madrid, sus caminos vuelven a cruzarse. Tras el encuentro, se dan cuenta de que, a pesar de que el amor sigue latente, sus destinos discurren por rumbos separados.",0,"imgs/peliculas/56.jpg","LuqlNpSN1eM",actorespelicula,director33,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula57 = new Peliculas("El último Elvis",2012,"",92,"Carlos Gutiérrez, &quot;Elvis&quot;, es un cantante separado que vive en un olvidado barrio de Buenos Aires y que tiene una pequeña hija llamada Lisa Marie, a la que no ve muy seguido. Siempre vivió su vida como si fuese la reencarnación de Elvis Presley, negándose a aceptar su realidad. Pero está a punto de cumplir los años que su ídolo tenía al morir y su futuro se muestra vacío.",0,"imgs/peliculas/57.jpg","kGZ1ysL8rAc",actorespelicula,director40,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula61 = new Peliculas("No sabe, no contesta",2002,"",90,"No sabe, no contesta cuenta la historia de Joaquín, que estudia cine y le gusta Laura. Tres días en cuatro capítulos en cuatro historias de cuatro amigos. Tres días en la historia de Joaquín que tiene tres amigos. Marcos, que tiene una novia que queda embarazada de otro. Damián, que tiene una novia que se acuesta con otro. David, que se acuesta con la novia de Damián.",0,"imgs/peliculas/61.jpg","yASVmxAaXIg",actorespelicula,director43,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula63 = new Peliculas("Martín Fierro, la película",2007,"",88,"Martín Fierro es un renegado que lucha contra la corrupción que intenta someterlo y quitarle lo más preciado de su vida: La libertad.",0,"imgs/peliculas/63.jpg","3kIWUqcukdE",actorespelicula,director45,reseniaspelicula,usuario,genero7, true);
		...
		Peliculas pelicula64 = new Peliculas("Carancho",2010,"",107,"Después de haber perdido su licencia, el abogado Sosa (Ricardo Darín) ingresa en una sociedad ilegal que se encarga de provocar accidentes automovilísticos para estafar a las aseguradoras. El destino hace que un día Sosa conozca a Luján (Martina Gusmán), una médica de un hospital de Buenos Aires.",0,"imgs/peliculas/64.jpg","geZmmTil9fM",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula65 = new Peliculas("El último verano de la Boyita",2009,"",93,"La Boyita es una casa rodante que tiene la mágica capacidad de flotar. Una especie de anfibio doméstico, un refugio para Jorgelina, una niña que está a punto de alcanzar la adolescencia. Cuando va a pasar las vacaciones al campo junto a su papá, conoce a Mario, un niño que le plantea a Jorgelina dudas que no sabe cómo afrontar.",0,"imgs/peliculas/65.jpg","JqEDh3FZ3sU",actorespelicula,director46,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula69 = new Peliculas("Los paranoicos",2008,"",102,"&quot;Los paranoicos&quot; cuenta la historia de Gauna (Daniel Hendler), un joven que escribe pero nunca tuvo el coraje de enseñar su obra. Un hombre que en la intimidad expone una personalidad que parece censurar en su escasa vida social. La aparición de un viejo amigo, Manuel, que llega desde España embriagado por el suceso de una serie televisiva cuyo protagonista tiene un nombre que remite a él, provoca el enfrentamiento de Gauna con aquello que desea -aunque sea la novia de su amigo- y la reafirmación de sus principios.",0,"imgs/peliculas/69.jpg","4-GTqlZQPpE",actorespelicula,director48,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula70 = new Peliculas("La larga noche de Francisco Sanctis",2016,"",78,"Adaptación de la novela homónima de Humberto Costantini, situada en Buenos Aires en 1977. Un hombre recibe, en plena dictadura, la información del paradero de dos personas buscadas por los militares. Ahora tiene la posibilidad de salvarlas, aunque eso implica arriesgar su propia vida.",0,"imgs/peliculas/70.jpg","j_3eIV4bj1k",actorespelicula,director49,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula73 = new Peliculas("Las manos",2006,"",119,"El sacerdote Mario Pantaleo descubre que tiene cierto poder para diagnosticar y curar enfermedades por medio de la imposición de las manos. Pero la policía y la jerarquía eclesiástica se pondrán en su contra.",0,"imgs/peliculas/73.jpg","E5k4i6A0VUc",actorespelicula,director51,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula74 = new Peliculas("La mosca en la ceniza",2009,"",98,"El film trata sobre dos amigas íntimas que llegan a Buenos Aires desde el Noroeste buscando un futuro mejor, pero son víctimas de un engaño y deben trabajar en un prostíbulo. Allí, una se adaptará para sobrevivir y la otra intentará huir.",0,"imgs/peliculas/74.jpg","JKes7oGQYKk",actorespelicula,director52,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula77 = new Peliculas("Vikingo",2009,"",90,"Vikingo es un respetado motociclista de vida licenciosa pero, paradójicamente, rígido en lo que hace a la aplicación de ciertos preceptos morales. El honor y el respeto son sus códigos, aunque no estén presentes coherentemente en todas las dimensiones de su vida.",0,"imgs/peliculas/77.jpg","AHNs2m2eViE",actorespelicula,director55,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula89 = new Peliculas("El asadito",2000,"",71,"El 30 de diciembre de 1999 se encuentran a comer un asado siete amigos (más un invitado sorpresa) en la terraza de Tito, el anfitrión. La reunión se prolonga hasta las primeras horas del último día del fin del milenio.",0,"imgs/peliculas/89.jpg","62WvoJcFxl8",actorespelicula,director62,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula100 = new Peliculas("Ánima Buenos Aires",2011,"",95,"Largometraje animado integrado por cuatro historias que revelan el increíble universo que encierran barrios y rincones de la ciudad de Buenos Aires.",0,"imgs/peliculas/100.jpg","G8-7z3uJWug",actorespelicula,director69,reseniaspelicula,usuario,genero7, true);
		...
		Peliculas pelicula112 = new Peliculas("Elefante blanco",2012,"",106,"Narra la historia de amistad de dos curas, Julián y Nicolás, que tras sobrevivir a un intento de asesinato por parte del ejército durante su trabajo en Centroamérica, se asientan en una barriada de Buenos Aires para desarrollar su apostolado y labor social. Allí conocen a Luciana, con quien lucharán codo con codo contra la corrupción, un mal endémico de la zona.",0,"imgs/peliculas/112.jpg","Lz1K55C-dUw",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula130 = new Peliculas("Juana a los 12",2014,"",75,"Juana va a un colegio inglés del conurbano bonaerense. Tras la preocupación de sus maestras por su bajo rendimiento, su madre comienza a buscar ayuda externa. Juana lidia los desafíos académicos y sociales con una aparente indiferencia mientras transita una edad de mucha incertidumbre.",0,"imgs/peliculas/130.jpg","6LGLOoFjnT8",actorespelicula,director87,reseniaspelicula,usuario,genero1, true);
