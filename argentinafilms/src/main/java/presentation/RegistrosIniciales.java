...
public class RegistrosIniciales extends HttpServlet{
	...
	private void crearDatos(){
		...
		Actores actor258 = new Actores("Sergio", "Pángaro", 0, true);
		Actores actor259 = new Actores("Andrés", "Duprat", 0, true);
		...
		Actores actor264 = new Actores("Martín", "Adjeiman", 0, true);
		...
		Actores actor281 = new Actores("Facundo", "Giménez", 0, true);
		Actores actor282 = new Actores("Ariel", "Croce", 0, true);
		Actores actor283 = new Actores("Cristóbal", "Pinto", 0, true);
		Actores actor284 = new Actores("Adrián", "Witzke", 0, true);
		Actores actor285 = new Actores("Julieta", "Díaz", 0, true);
		...
		Actores actor337 = new Actores("Inés", "Popovich", 0, true);
		Actores actor338 = new Actores("Gastón", "Cocchiarale", 0, true);
		...
		Actores actor352 = new Actores("Malena", "Sánchez", 0, true);
		...
		Actores actor357 = new Actores("Jorge", "D'Elía", 0, true);
		...
		Actores actor361 = new Actores("Juan", "Minujín", 0, true);
		...
		Actores actor419 = new Actores("Nicolás", "Pauls", 0, true);
		...
		Actores actor423 = new Actores("Margarita", "López", 0, true);
		Actores actor424 = new Actores("Rocío", "Presedo", 0, true);
		...
		Actores actor446 = new Actores("Martín", "Piroyansky", 0, true);
		Actores actor447 = new Actores("Germán", "Palacios", 0, true);
		...
		Actores actor451 = new Actores("Darío", "Valenzuela", 0, true);
		Actores actor452 = new Actores("Carlos", "Weber", 0, true);
		Actores actor453 = new Actores("José", "Arias", 0, true);
		Actores actor454 = new Actores("Loren", "Acuña", 0, true);
		Actores actor455 = new Actores("Gabriel", "Almirón", 0, true);
		Actores actor456 = new Actores("José", "Espeche", 0, true);
		Actores actor457 = new Actores("Guadalupe", "Alonso", 0, true);
		Actores actor458 = new Actores("María", "Merendino", 0, true);
		Actores actor459 = new Actores("Mirella", "Pascual", 0, true);
		Actores actor460 = new Actores("Silvia", "Tavcar", 0, true);
		Actores actor461 = new Actores("Nicolás", "Treise", 0, true);
		...
		Actores actor467 = new Actores("Bárbara", "Lombardo", 0, true);
		...
		Actores actor472 = new Actores("Silvia", "Baylé", 0, true);
		Actores actor473 = new Actores("Dolores", "Fonzi", 0, true);
		Actores actor474 = new Actores("Walter", "Reyno", 0, true);
		Actores actor475 = new Actores("Jorge", "D´Elía", 0, true);
		Actores actor476 = new Actores("Nahuel", "Biscayart", 0, true);
		Actores actor477 = new Actores("Jazmín", "Stuart", 0, true);
		Actores actor478 = new Actores("Martín", "Feldman", 0, true);
		Actores actor479 = new Actores("Miguel", "Dedovich", 0, true);
		Actores actor480 = new Actores("Juan", "Leyrado", 0, true);
		Actores actor481 = new Actores("Virginia", "Inocenti", 0, true);
		Actores actor482 = new Actores("Arturo", "Bonín", 0, true);
		Actores actor483 = new Actores("Laura", "Paredes", 0, true);
		Actores actor484 = new Actores("Valeria", "Lois", 0, true);
		Actores actor485 = new Actores("Marcelo", "Subiotto", 0, true);
		Actores actor486 = new Actores("Rafael", "Federman", 0, true);
		...
		Actores actor493 = new Actores("Belén", "Blanco", 0, true);
		Actores actor494 = new Actores("Esteban", "Pérez", 0, true);
		Actores actor495 = new Actores("Duilio", "Marzio", 0, true);
		Actores actor496 = new Actores("Jean", "Reguerraz", 0, true);
		Actores actor497 = new Actores("Mónica", "Cabrera", 0, true);
		Actores actor498 = new Actores("Luís", "Machín", 0, true);
		Actores actor499 = new Actores("Cecilia", "Rosetto", 0, true);
		Actores actor500 = new Actores("Luciano", "Cáceres", 0, true);
		...
		Actores actor577 = new Actores("Tito", "Gómez", 0, true);
		Actores actor578 = new Actores("Gerardo", "Dayub", 0, true);
		Actores actor579 = new Actores("Héctor", "Molina", 0, true);
		Actores actor580 = new Actores("Raúl", "Calandra", 0, true);
		...
		Actores actor701 = new Actores("Martín", "Rena", 0, true);
		Actores actor702 = new Actores("Rodrigo", "Savina", 0, true);
		Actores actor703 = new Actores("Gustavo", "Almada", 0, true);
		Actores actor704 = new Actores("María", "Villar", 0, true);
		Actores actor705 = new Actores("Agustina", "Muñoz", 0, true);
		Actores actor706 = new Actores("Gabi", "Saidón", 0, true);
		Actores actor707 = new Actores("Julia", "Rubio", 0, true);
		Actores actor708 = new Actores("Esteban", "Bigliardi", 0, true);
		Actores actor709 = new Actores("Julián", "Tello", 0, true);
		...
		Actores actor764 = new Actores("Martín", "Aguilar", 0, true);
		...
		Actores actor774 = new Actores("Matías", "Castelli", 0, true);
		...
		Actores actor779 = new Actores("Dolores", "Solá", 0, true);
		...
		Directores director2 = new Directores("Damián", "Szifrón", 0);
		...
		Directores director9 = new Directores("Lorena", "Muñoz", 0);
		...
		Directores director13 = new Directores("Adrián", "Caetano", 0);
		...
		Directores director16 = new Directores("Marcelo", "Piñeyro", 0);
		...
		Directores director23 = new Directores("María", "Menis", 0);
		...
		Directores director25 = new Directores("Paula", "Hernández", 0);
		this.directorService.add(director25);
		Directores director26 = new Directores("Enrique", "Piñeyro", 0);
		this.directorService.add(director26);
		Directores director27 = new Directores("Sebastián", "Schindel", 0);
		...
		Directores director31 = new Directores("Sebastián", "Borensztein", 0);
		...
		Directores director35 = new Directores("Benjamín", "Ávila", 0);
		...
		Directores director44 = new Directores("Lucía", "Puenzo", 0);
		...
		Directores director47 = new Directores("Gastón", "Biraben", 0);
		...
		Directores director49 = new Directores("Tristán", "Bauer", 0);
		this.directorService.add(director49);
		Directores director50 = new Directores("Andrea", "Márquez", 0);
		...
		Directores director55 = new Directores("José", "Campusano", 0);
		...
		Directores director58 = new Directores("Rodrigo", "Fürth", 0);
		this.directorService.add(director58);
		Directores director59 = new Directores("Leandro", "Ipiña", 0);
		...
		Directores director65 = new Directores("Nicolás", "Tuozzo", 0);
		...
		Directores director69 = new Directores("María", "Ramírez", 0);
		this.directorService.add(director69);
		Directores director70 = new Directores("Lucía", "Cedrón", 0);
		this.directorService.add(director70);
		Directores director71 = new Directores("Gaspar", "Gómez", 0);
		...
		Directores director73 = new Directores("Hernán", "Goldfrid", 0);
		...
		Directores director79 = new Directores("Martín", "Rejtman", 0);
		...
		Directores director81 = new Directores("Matías", "Piñeiro", 0);
		...
		Directores director83 = new Directores("Nicolás", "Lavedra", 0);
		this.directorService.add(director83);
		Directores director84 = new Directores("Laura", "Mañá", 0);
		...
		Resenias resenia67 = new Resenias("Magnífica película, sin duda una inesperada y grata sorpresa la que me he llevado con este film, me ha encantado de principio a fin. Además de entretener adquiere formas sentimentales y muchas secuencias de gran carácter poético, tan profundo que van directamente al corazón.", "", usuario34, null);
		Resenias resenia68 = new Resenias("Apegado a narraciones intimistas, como las que mostrara en El Faro o Sol de Otoño, admirador de Akira Kurosawa, &quot;porque se anima a llegar a un lugar del alma donde no muchos se atreven&quot;, el escritor y cineasta argentino Eduardo Mignona nos ofrece una historia sobriamente emotiva, que tiene como eje la reconstrucción del vínculo afectivo entre un abuelo y su nieta.", "", usuario8, null);
		Resenias resenia69 = new Resenias("Después de ver últimamente tanto cine adocenado (hecho en Hollywood o mirando a Hollywood), por no hablar de la larga lista de filmes en los que el volumen de efectos especiales es inversamente proporcional a la calidad del guión y de comedias (¿comedias?) de una zafiedad prácticamente insultante, resulta absolutamente estimulante ir a ver una obra como &quot;El viento&quot;.", "", usuario28, null);
		...
		Resenias resenia83 = new Resenias("El realizador argentino Carlos Sorin revisita los terrenos y códigos que abarcó en la entrañable Historias mínimas. Nuevamente en el marco de los amplios horizontes y pueblos perdidos de las tierras patagónicas, registra a actores no profesionales interpretando a personajes cuyas vidas bien pueden ser las de ellos mismos: en este caso un hombre maduro, humilde y desempleado, vislumbra nuevas esperanzas cuando por azar termina siendo dueño de un perro dogo que bien podría ser un campeón en exposiciones.", "", usuario34, null);
		...
		Resenias resenia85 = new Resenias("Manolo es pequeño, peludo, suave; tan blando por fuera, que se diría todo de algodón. Manolo es mi perro y no es un burro. Y por si hubiera alguna duda, yo tampoco soy Juan Ramón Jiménez.Si hubiera visto esta película hace un año probablemente me habría aburrido.", "", usuario24, null);
		Resenias resenia86 = new Resenias("Excelente película que transcurre con el lento ritmo de la Patagonia, la lucha por la supervivencia, las necesidades de un hombre humilde que pueden ser satisfechas por el azar de recibir como regalo un perro, perro que no cumple con lo que se espera de él.", "", usuario30, null);
		Resenias resenia87 = new Resenias("Un problema de desempleo con una aparente solución inusual, el Sr. Juan Villegas la verdad, ha hecho un trabajo de interpretación muy bueno, al igual que el resto, no sabía que no eran profesionales o por lo menos no han tenido gran cantidad de trabajos.", "", usuario1, null);
		Resenias resenia88 = new Resenias("La película desprende sencillez y ternura por todas partes, a medio camino entre la sonrisa y la tristeza, entre la dulzura (la experiencia y la sabiduría de las personas mayores) y la acidez (en la vejez casi todos los pensamientos viajan hacia atrás, los sueños son muy cortos y la esperanza se hace cada vez más pequeña), donde el director no quiere ahondar nunca en el drama y nos muestra la historia con naturalidad.", "", usuario1, null);
		Resenias resenia89 = new Resenias("Sublime China Zorrila. ¿Puede una actriz ser más adorable, talentosa y creíble que la inmensa uruguaya?. No por supuesto, porque todo lo que haga China tiene su toque mágico único. En Conversaciones con mamá está impresionante y Eduardo Blanco como su hijo no se queda atrás, juntos tienen unos diálogos que son de antología.", "", usuario6, null);
		Resenias resenia90 = new Resenias("Es una de las mejores películas que he visto en los últimos cinco años, sin duda. Un maravilloso guión interpretado de forma magistral por todos los actores sin excepción. Eduardo Blanco se ha colocado merecidamente en uno de los mejores actores que he visto.", "", usuario20, null);
		Resenias resenia91 = new Resenias("...muy realista y humana. Una relación madre e hijo bien dirigida da para mucho, como en ésta película. Realmente no puede ser más sencilla, pero a la vez llena de la propia vida de mucha gente.", "", usuario8, null);
		...
		Resenias resenia229 = new Resenias("Pequeña joya del cine independiente argentino. Original y divertida, es una mezcla entre el cine de Tim Burton y el de Jean-Pierre Jeunet con algunas gotas de Lynch y una estética cómic muy lograda. La película nos situa en una ciudad imaginaria, alegoría de un futuro en el que los seres humanos han perdido el don del habla y viven al son  de un magnate de la televisión, un tirano que pretende controlar sus mentes (una metafora muy actual del mundo de las grandes empresas de comunicación).", "", usuario15, null);
		Resenias resenia230 = new Resenias("En España la TV es una caja donde se emiten programas que a nadie gustan, pero que, como el 6 espirílico e hipnótico de la película argentina, nos atraen y no dejamos de verlos. Además, la presencia de la publicidad es cada vez mayor, y ya incluso los programas se convierten en escaparates al más puro estilo del teletienda.", "", usuario33, null);
		Resenias resenia231 = new Resenias("Me he quedado alucinado con esta película. Sin palabras; han sabido chupar de fuentes clásicas de la historia del cine pero le dan un toque personal que nunca llega a dar ni un ligero tono pedante.Tiene ritmo,guión de cuento, buenos actores (hasta los niños están bien), un diseño de producción deslumbrante, muy de la época de Al Capone, estética de comic, surrealismo, humor, ternura, historias dentro de otras historias, la música es espectacular, te mete dentro de la peli y no te suelta; Cada pequeño detalle es deslumbrante y no me voy a enrrollar más.", "", usuario20, null);
		...
		Resenias resenia240 = new Resenias("Hawaii es la tercer película del director argentino Marco Berger (Plan B, Ausente) que compite en la categoría de Largometrajes Nacionales.Una historia de amor. Así presentan esta película que trata sobre Martín y Eugenio. Martín debe pasar el verano sobreviviendo, no tiene un lugar donde quedarse y se hace algunos pesos como puede.", "", usuario9, null);
		...
		Resenias resenia242 = new Resenias("En la primera parte de la película Marco Berger consigue despertar el interés del espectador mediante la mirada de los protagonistas, inquieta, variante, como buscando algo o temiendo algo. A partir del encuentro de los dos protagonistas, las miradas cambian, ahora son de interés personal y hasta de análisis físico, cada uno por el cuerpo del otro.", "", usuario8, null);
		Resenias resenia243 = new Resenias("Las relaciones entre hombres son una constante en el cine del director argentino Marco Berger. Desde sus primeros cortos hasta sus largometrajes ‘Plan B’ y ‘Ausente’, Berger muestra como dos chicos se conocen y se atraen.Martín hace algunas chambitas para pasar el verano antes de volver a Buenos Aires para asentarse ahí, Eugenio está cuidando la casa de un tío mientras escribe una novela y decide contratarlo, más por atracción hacia Martín que por verdadera necesidad.", "", usuario11, null);
		Resenias resenia244 = new Resenias("El Zapa es un pobre cerrajero que se ve implicado en un robo. En el pueblo todos le conocen y saben que no es mal chico, por lo que todo se arregla para que viaje a Buenos Aires con una recomendación para incorporarse al cuerpo de la Bonaerense.El Zapa se va dando cuenta, poco a poco, de que la policía se mueve corruptamente por los bajos fondos.", "", usuario6, null);
		Resenias resenia245 = new Resenias("Pablo Trapero nos muestra una realidad cruda, sin edición y sin ornamentos, de una institución tan cuestionada en la Argentina como lo es la Policía Bonaerense, enmarcando las historias personales en un país en plena crisis económica. Lejos están en esta película, los irreales sueños primermundistas de la Argentina de los 90´.", "", usuario28, null);
		...
		Resenias resenia247 = new Resenias("Más que &quot;Trapero&quot; este hombre podría ser &quot;modisto de Alta Costura&quot;,  posiblemente sea la película argentina de los últimos años que más poso deja tras verla. Escenas memorables y sutilmente inolvidables.Magnífico Trapero.", "", usuario1, null);
		Resenias resenia248 = new Resenias("Esta película quizás no tenga el super-argumento, pero nos demuestra lo más profundo de la realidad de la Policia Bonaerense: corrupción, prostitución, oficiales excedidos de edad que entran por los &quot;amiguismos&quot;, y demás cosas. Sin dudas el protagonista es un inutil, que lo pasan por arriba (por decirlo en criollo), unas 2 veces en la película.", "", usuario11, null);
		Resenias resenia249 = new Resenias("Escondido cine  argentino, que  al igual que decenas de películas  que no llegan a nuestras carteleras, no deja de ser un  cine interesante, sea cual fuere su procedencia. Su trasfondo es el del abandono,  el de la soledad y la muerte; una solución de búsqueda que  acompaña al protagonista y a todo al que la ve, que trasluce el ámbito del cine independiente para hacerse aún más desgraciadamente olvidado.", "", usuario23, null);
		...
		Resenias resenia261 = new Resenias("Una road movie por naturaleza, argentina a más nos poder por su alto contenido realista e intimista. Brinda una radiografía, o más bien una tomografía, de los pormenores que aquejan el día a día a una familia tipo.Un viaje hacia el norte del país para asistir a un casamiento será la excusa ideal para que Trapero nos describa con mucha agudeza y naturalismo las miserias y los pesares propios del ser humano, pero con las improntas propia de la realidad socioeconómica de la Argentina más popular y folclórica.", "", usuario16, null);
		Resenias resenia262 = new Resenias("Es posible que los creadores de &quot;Pequeña Miss Sunshine&quot; vieran &quot;Familia rodante&quot;, ya que es en esencia la misma idea. Una famila que viaja en una carabana durante muchos quilómetros para que un miembro de la famila cumpla un sueño o deseo.", "", usuario32, null);
		Resenias resenia263 = new Resenias("Presenta un buen entramado de relaciones principalmente de dos a dos (en especial la de los dos cuñados). Aceptables y coherentes algunos personajes (el gordo conductor, por ejemplo); aunque menos logrados y ni siquiera mínimamente explicados otros (el novio de la moto).", "", usuario19, null);
		Resenias resenia264 = new Resenias("Una película a la que me acerqué sin saber nada de ella, que cautiva desde el inicio gracias a la excelente química de la pareja protagonista. Sin saber muy bien por qué su historia de amor te engancha, quizá muchos puedan sentirse identificados con ese amor que nunca cuajó, pero que no se olvida con los años.", "", usuario16, null);
		Resenias resenia265 = new Resenias("Esta película cuenta una bonita historia de amor, encuentros y desencuentros con la historia coétanea de Argentina de fondo. A veces tiene bajones, algunas lagunas narrativas, pero en su conjunto esta película de curioso y bonito título está llevada con sensibilidad y dignidad.", "", usuario13, null);
		Resenias resenia266 = new Resenias("Para decir algo sobre &quot;Nueces para el amor&quot;, es imprescindible darle una definición; en ese sentido considero esta película como la historia de amor más grande del cine hispanoamericano. Su historia, sus actuaciones, su musicalización, su lenguaje narrativo, y todo los demás elementos cinematográficos forman un conjunto sui generis en la historia del cine.", "", usuario9, null);
		Resenias resenia267 = new Resenias("Entretenida y romántica, una trama clásica de historia de amor a lo largo de los años, con el aliciente de unos diálogos excelentes. Creo que es innecesaria la actuación de Nicolás Pauls, se parece tanto a su hermano que con un poco más de pelo el papel lo podía haber hecho Gastón sin problema.", "", usuario32, null);
		Resenias resenia268 = new Resenias("Sólida y completa coproducción hispanoargentina que une muy bien la soltura, animosidad y capacidad de transmitir sentimientos del cine argentino, con la templanza y equilibrio que le da una producción de cabeza clara detrás.&quot;Nueces para el amor&quot; es la triste, díficil, hermosa y común historia de amor entre Marcelo y Alicia, a través de los años y con ella del repaso histórico de acontecimientos: la dictadura argentina, la guerra de las Malvinas, el Mundial del 82, Maradona, etc.", "", usuario17, null);
		Resenias resenia269 = new Resenias("Habitar la piel de otro es una experiencia común para los artistas y particularmente para los imitadores, aunque en este último caso están más atados a un personaje que a veces puede devorarlos y alejarlos de su propia realidad. Esta situación, llevada al extremo, es la que plantea la historia de Carlos Gutiérrez, quien de día trabaja como obrero en una ruidosa fábrica de electrodomésticos y de noche imita a Elvis Presley en fiestas familiares, bares y bingos del conurbano porteño.", "", usuario33, null);
		Resenias resenia270 = new Resenias("El último Elvis logra llevar en andas al ángel de los perdedores, ese qué viene de los callejones, donde solo campeonan los peores; esos callejones donde nuestros sueños son solo nuestros y las luces de un escenario (sin espectadores) iluminan solo nuestras sombras.", "", usuario26, null);
		Resenias resenia271 = new Resenias("No hay lugar para la ampulosidad en El último Elvis; ni para la joda ni para la caricaturización. Sobria como pocas, justamente por tratar de un  tema como el que trata, lo que sorprende es la seriedad de la propuesta y el como desarrollarla apenas teniendo en cuenta el devenir psicológico del personaje principal.", "", usuario31, null);
		Resenias resenia272 = new Resenias("Historia pausada, intimista, con una camara omnipresente que sigue a nuestro ¿ídolo? en cada momento vital. La historia de un hombre que se transforma en el único y ¿legítimo? continuador de Elvis Presley...o así lo entiende él.", "", usuario7, null);
		Resenias resenia273 = new Resenias("Película intrigante, de esas con las que piensas una vez salido del cine y meses después. Una reflexión perfecta entre la obsesión y la realidad de un auténtico fan. Merece la pena verla, sin duda una de las mejores películas que pueden salir en verano.", "", usuario30, null);
		Resenias resenia274 = new Resenias("La vida es ese gran camino regado con momentos dulces y amargos, de sonrisas y llantos, de lágrimas de amor y de dolor, de flores y espinas, de miradas compartidas y caminares solitarios...  El destino hace que Martín y Mabel se conozcan, ese destino caprichoso que no controlamos, ese guiño que el futuro nos brinda en forma de aliento inesperado.", "", usuario9, null);
		Resenias resenia275 = new Resenias("Hace más de veinte años que Eliseo Subiela cuenta variaciones de una historia parecida. Si algo lo distingue como cineasta es la fidelidad a   sus ideas, a su mundo personal que tiene una estética cinematográfica  reconocible, con adeptos y detractores.", "", usuario28, null);
		Resenias resenia276 = new Resenias("Me gustó. Es una historia de amor con enseñanza, que nos muestra los valores fundamentales del ser humano: amor desinteresado, lealtad en los malos momentos, generosidad, inocencia, confianza en uno mismo, piedad, etc.Mabel y Martín encarnan muy bien estos valores y nos hacen partícipes de su ternura.", "", usuario22, null);
		Resenias resenia277 = new Resenias("Cuando alguien está empeñado en contar algo para que llegue al gran público, tiene que saber el grado de sinceridad de sí mismo quiere que impregne en su obra. La necesidad de hacer una exposición no comercial de una idea y que llegue al mayor número de personas posibles, es arto difícil.", "", usuario25, null);
		Resenias resenia278 = new Resenias("Es un film que trata de hacer pensar sobre la vida sin caer en el didactismo, por lo cual, los dos protagonistas, si son ejemplo, lo son con sus simples actos, que son de libertad y de amor: son personas atípicas precisamente porque hacen uso de tal libertad, la que todos tenemos y quizás no usamos.", "", usuario7, null);
		Resenias resenia279 = new Resenias("Pelicula muy en la línea de Historias Mínimas, (es prácticamente un calco muy bien hecho). Se nos muestra la realidad de un país, de un amplio sector de la sociedad argentina que permanece agarrada a  unos sueños, a unos ideales que permanecen muy arraigados.", "", usuario16, null);
		Resenias resenia280 = new Resenias("“El camino de San Diego” (2006), merecidísimo Gran Premio del Jurado en el Festival de San Sebastián, es el quinto largometraje del argentino Carlos Sorin. Como en la mayor parte de sus trabajos anteriores -”Eterna sonrisa en New Jersey” (1989), “Historias mínimas” (2002), “Bombón, el perro” (2004).", "", usuario2, null);
		Resenias resenia281 = new Resenias("Que es el Diego para parte del pueblo argentino. Para esa parte del pueblo separado por la línea de la General Paz del Buenos Aires cosmopolita (aunque también ahí tiene sus fans, y muchos), y que define a La Otra, a la Otra Argentina que nunca ha podido demostrarse a si misma que El Dorado existía.", "", usuario19, null);
		Resenias resenia282 = new Resenias("A modo de falso documental, se nos presenta a Tati Benitez, un joven animado y jovial, fanático de Maradona. Su vida da un vuelco cuando se queda sin empleo y, casi al mismo tiempo, su ídolo máximo es ingresado en una clínica por un problema cardíaco.", "", usuario30, null);
		Resenias resenia283 = new Resenias("Carlos Sorin vuelve a convencer en esta reciente película que sigue el esquema de una road movie, como también ocurría en “Bombón, el perro”. Y vuelve a utilizar un personaje lleno de dignidad que a pesar de su pobreza disfruta de las cosas de la vida.", "", usuario27, null);
		Resenias resenia284 = new Resenias("Tulio y Susana (Leandro Castello y Mercedes Scápola), un hombre de edad incierta (¿envejecido?), deteriorado por su circunstancia, y su sobrina llegan a Buenos Aires desde un pueblo del interior. Acaban de ser empujados del rancho en el que vivían, rodeados de gallinas y chivos.", "", usuario22, null);
		Resenias resenia285 = new Resenias("Es interesante encontrarse con un película como esta, que en momentos nos lleva a la reflexión; hacía rato que no me reía con los personajes muy bien elaborados, (tal vez tulio tendría que estar mas envejecido), la fotografía excelente. Por vivir en un pueblo bastante similar a lo que puede se Nogolí, me puedo identificar con partes de la película que son tristemente ciertas.", "", usuario36, null);
		...
		Resenias resenia293 = new Resenias("Fernando Musa sí sabe y contesta a la tendencia que asola a las comedia juveniles, género característico por atrofiar cualquier dechado de seriedad, muchas veces justificado por tónica brindada a este tipo de cintas. La sencillez del argumento en este caso, recorre las preocupaciones de varios sujetos que se toman la vida entre cigarrillos y chacota sin tomar en cuenta el fondo de sus decisiones y como les afectan a terceros.", "", usuario21, null);
		Resenias resenia294 = new Resenias("&quot;XXY&quot; no es precisamente una película que se dedica a explotar desde el lado morboso o sensacionalista el tema de la intersexualidad. El hermafroditismo de la joven protagonista que compone Inés Efron es el disparador para reflexionar sobre algo que está detrás y es más profundo: la libertad de elección.", "", usuario4, null);
		Resenias resenia295 = new Resenias("—¡Nos fuimos de Buenos Aires para alejarnos de cierta clase de gente, y ahora los tenemos sentados a nuestra mesa!Kraken, emigrado con mujer e hija a un pueblo costero uruguayo, lamenta la actitud de unos invitados: una compañera de infancia de la mujer, su marido cirujano y el hijo por éste despreciado al considerarlo poco hombre.", "", usuario9, null);
		Resenias resenia296 = new Resenias("Pareciera exagerado el título de la crítica, pero en realidad no lo es tanto ya que en pleno siglo XXI las personas con alguna diferencia sea cual fuere siguen siendo agredidas y sobajadas por algo fuera de control, donde la naturaleza asigna y el hombre “corrige” sin permitir el poder de elección de quien vive esa alteración en cromosomas.", "", usuario27, null);
		Resenias resenia297 = new Resenias("Este drama de un ser humano que padece el dolor de navegar entre dos aguas pisando ambas y ninguna, el drama de una familia que se enfrenta a una diferencia que la sociedad señala con crueldad (como ocurre con cualquier aspecto que se salga de la &quot;normalidad&quot;), me ha llegado muy adentro.", "", usuario14, null);
		Resenias resenia298 = new Resenias("Era esta película de Lucía Puenzo una historia que no me atrajo en su estreno. A pesar de los premios, del Goya y las críticas favorables que leía no llegaba a despertar en mí demasiada curiosidad. Y eso que soy hombre curioso. Fue por tanto, una agradable sorpresa descubrir este admirable y provechoso trabajo de Puenzo donde sabe narrar una historia a la vieja usanza: sugiriendo, no mostrando.", "", usuario17, null);
		Resenias resenia299 = new Resenias("Bella recreación fílmica del poema gauchesco homónimo, se basa en la primera parte de la obra de José Hernández, Martín Fierro, un gaucho privado de su libertad para ser llevado a la frontera a luchar contra los indios. En formato de dibujos animados, creados por el gran Roberto Fontanarrosa, quien le dio color a esta historia.", "", usuario17, null);
		Resenias resenia300 = new Resenias("Versión del Martín Fierro en animación, si bien matizada para un público de menor edad, no se toma demasiadas libertades poéticas y representa fielmente el poema de José Hernandez. Con dibujos dirigidos por Fontanarrosa, esta trabajada de una manera muy interesante la imagen.", "", usuario7, null);
		Resenias resenia301 = new Resenias("Montada sobre los dibujos del famoso autor gráfico y escritor Roberto Fontanarrosa, la obra se inspira en los célebres versos del poema &quot;Martin Fierro&quot;, de la pluma de Jose Hernández, considerado por algunos el mayor exponente de la literatura gauchesca y argentina, en general, que convocó, incluso, la admiración de Borges.", "", usuario6, null);
		Resenias resenia302 = new Resenias("La película se inicia con inquietantes cifras sobre los miles de muertos y heridos por accidentes de tránsito en la Argentina (un promedio de veintidós víctimas fatales por día). Alrededor de estas estadísticas se maneja el dinero de indemnizaciones, gastos médicos y legales que genera un mercado donde se mueven muchas aves de rapiña con diferentes ganancias de acuerdo con su poder.", "", usuario2, null);
		Resenias resenia303 = new Resenias("Carancho es una película con pulso, con rabia, de esas que te mantienen pegado a la pantalla casi sin pestañear, tan urbana y con tanto nervio como cualquiera de algún gran director del momento. Darín, como siempre, magistral, esta vez acompañado de una chica que, además de ser la mujer del director, tampoco desentona en su papel de médico del servicio de emergencias.", "", usuario0, null);
		Resenias resenia304 = new Resenias("No es una película que maneje grandes conceptos, ésa no es su intención; su objetivo es contar una historia con un estilo sencillo, funcional y fluído que cede el protagonismo a quien debe tenerlo: el actor. El uso de la cámara es digno de los mejores directores: todas escenas se resuelven con planos fijos y planos-escena cortos que recuerdan a Kieslowski o a Lucrecia Martel.", "", usuario26, null);
		Resenias resenia305 = new Resenias("Carancho es un policial oscuro con una historia de amor en el medio. Debe su nombre a un ave rapaz que anda merodeando, atento para cazar a su víctima. Eso es lo que hace el personaje de Ricardo Darín (Sosa), un abogado oportunista devenido a menos, sin matrícula que merodea los hospitales en búsqueda de clientes para “ayudarlos”.", "", usuario11, null);
		Resenias resenia306 = new Resenias("Los accidentes de tráfico se sitúan entre las principales causas mundiales de muertes masivas, imagino que no muy por detrás de las guerras, la pobreza extrema, las hambrunas, el terrorismo, las enfermedades y las catástrofes naturales. La carretera es escenario de innumerables tragedias anuales.", "", usuario20, null);
		Resenias resenia307 = new Resenias("Muy bella película, que nos acerca al laberíntico mundo del cambio de las edades y  más concretamente sobre lo difícil que puede llegar a ser el abandono de la infancia, y a veces, entrar en la adolescencia. Cambios en lo que no sólo asumes problemas derivaos de cambalaches fisiológicos naturales, sino que también te hacer portador de un sinfín de problemas  nuevos y desconocidos –o antes triviales-, que a veces, serán compañeros fieles de por vida.", "", usuario9, null);
		Resenias resenia308 = new Resenias("Ayer por la noche hacía mucho frío. Afortunadamente, &quot;Versión Española&quot; emitía la película &quot;El último verano de la boyita&quot;, de la directora argentina Julia Solomonoff.Gracias a eso, me teletransporté a la Argentina más calurosa y me olvidé del frío.", "", usuario35, null);
		...
		Resenias resenia310 = new Resenias("&quot;El último verano de la boyita&quot; es una pequeña joya del reciente cine argentino, sobre el tortuoso paso hacia la adolescencia y el despertar sexual, a través de una historia de amistad diferente y rodada con extremada sensibilidad por Julia Solomonoff (&quot;Hermanas&quot;), con una pareja de niños protagonistas que otorga gran credibilidad a lo que se nos cuenta.", "", usuario31, null);
		Resenias resenia311 = new Resenias("Sensible, lo cual no quiere decir aburrido, largometraje argentino, donde -escapándose en adoptar líneas académicas ni mucho menos adornadas-, se cuentan los días decisivos para un adolescente y una amiga, una niña que aprende, a través de su amigo, los secretos de la adolescencia, bajo una sorpresa de guión que no estorba el cuidado cuento que trata.", "", usuario20, null);
		Resenias resenia312 = new Resenias("Filmación de un día de naturaleza pampera y de naturaleza humana, ambas en simbiosis. Lisandro Alonso es un maestro en filmar la soledad, el comportamiento, el ir y venir de seres humanos solitarios; así lo ha dejado patente en varias de sus obras.", "", usuario10, null);
		Resenias resenia313 = new Resenias("¿Es realmente un &quot;drama&quot; una película que insiste los 73 minutos en presentarnos a un personaje -un personaje que en realidad es una persona- rodeado de árboles, trabajando, cocinando, fumando, durmiendo? ¿Se puede hablar de una película, tal como la concebimos, como nos hicieron creer que era una película cuando nos enfrentamos ante La libertad? ¿Dónde está el drama?", "", usuario17, null);
		Resenias resenia314 = new Resenias("Frédéric Back realizó un cortometraje donde narraba como un humilde pastor de ovejas se dedica a recoger bellotas, para luego plantarlas en una tierra yerma, y convertir con el paso del tiempo un desolado valle en un hermoso bosque. Casi quince años después, la cámara de Alonso regresa a esas tierras y graba un día en la vida de  Misael, un humilde pastor del tiempo que se dedica a cortar los árboles y venderlos para su sustento.", "", usuario19, null);
		Resenias resenia315 = new Resenias("Si nos atenemos a la definición de Tarkovski -esculpir en el tiempo- &quot;La Libertad&quot; es cine en estado puro. Una película completamente ajena al teatro y a la literatura -y a otras artes- en la que la realidad por sí misma se revela como fuente de conflicto o de aquello que nos incumbe como seres humanos.", "", usuario31, null);
		Resenias resenia316 = new Resenias("En Las Palmas de G.C. algunos han tenido la oportunidad y otros la desgracia de poder visionar en los Multicines Monopol esta cinta argentina. Y comento esto porque entre otras cosas me ha hecho mucha gracia al término de la misma, la diversidad de opiniones sobre la obra, en especial la de un individuo que manifestaba su desencanto, ridiculez y tomadura de pelo hacia el espectador, el hombre se encontraba tremendamente indignado con el resultado de la misma.", "", usuario16, null);
		Resenias resenia317 = new Resenias("Cautiva, la película argentina, es simplemente brillante, una historia dura contada con profundidad, crudeza, y a la vez ternura. La historia de la apropiación de menores durante la dictadura militar en Argentina ha tenido diferentes relatos, ya sea en forma documental como en otros géneros.", "", usuario19, null);
		Resenias resenia318 = new Resenias("Película necesaria la de Gastón Birabén que ahonda en el destino de los hijos de los desaparecidos, y que narra el descubrimiento de la verdad desde la óptica de la adolescente protagonista (estupenda Bárbara Lombardo). El mayor mérito de la película es el punto de vista, que se centra en las víctimas contemporáneas de aquella masacre: esos jóvenes de hoy día a los que se les arrebató la verdad para crearles una vida ficticia.", "", usuario20, null);
		Resenias resenia319 = new Resenias("Realmente no es una mala película... Entonces ¿Por qué esa nota tan baja?  Porque este tipo de trabajos son tan predecibles que no mantienen la tensión dramática, se sustentan únicamente sobre la emocional, de ella se nutren y avanzan.   Cuando veo alguna película, serie, corto, me interesa su desarrollo, su planteamiento y.", "", usuario26, null);
		Resenias resenia320 = new Resenias("Es una historia conmovedora acerca de la “Apropiación Ilegal de Menores”, cuando los padres se hallaban ilegalmente detenidos, durante la dictadura militar que azotó la Argentina.Cristina, una joven que descubre a los 15 años que es hija de una pareja de arquitectos detenidos y desaparecidos durante la dictadura militar que azotó la Argentina entre 1976 y 1983.", "", usuario32, null);
		Resenias resenia321 = new Resenias("No sé por qué hablar siempre sólo de Hitler cuando EEUU -Kissinger- hizo cosas peores que Mengele. Qué si no es eliminar una generación tirando a muchos de ellos desde aviones al mar, -los vuelos de la muerte-  y dar los bebés a parejas afines a la dictadura.", "", usuario23, null);
		Resenias resenia322 = new Resenias("Sin duda una película para cinéfilos. Para el que no busque ni acción ni sustos, y que si disfrute de tramas inteligentes. Después de la original y primera película “Nueve Reinas”, este director y guionista nos trae una historia mucho más relajada, más oscura y con un ritmo bastante más lento, además de mucho más profunda e inteligente; una trama que va creciendo en intensidad y suspense conforme van pasando los minutos; te mete dentro de la mente del personaje principal (superior interpretación de Ricardo Darín) y no te deja tranquilo en ningún momento.", "", usuario22, null);
		Resenias resenia323 = new Resenias("&quot;El aura&quot; es una película de atmósferas y personajes antes que de género, aunque es  evidente el manejo de los códigos cinematográficos y el brillante oficio para combinar todas las piezas. La original historia tiene como protagonista a un epiléptico, introvertido y parco, con el oficio nada frecuente de embalsamar animales.", "", usuario17, null);
		Resenias resenia324 = new Resenias("Película de suspense, engancha desde el primer momento. La fotografía y el clima que es capaz de generar, lo más destacable. La pareja Darín-Bielinsky repite tras &quot;Nueve Reinas&quot;.", "", usuario37, null);
		Resenias resenia325 = new Resenias("Se agradece, y mucho, poder contemplar -de vez en cuando- un thriller que no se desarrolle en un contexto urbanita y, sobre todo, que no se haya rodado en Hollywood. Se agradece muy mucho porque los aficionados al thriller empezamos a estar hasta las mismísimas pelotas de que, una y otra vez, nos la metan doblada con peliculillas tan prefabricadas que, a los cinco minutos, ya nos han saturado la mollera con un bombardeo de “deja vu” absolutamente insoportable.", "", usuario32, null);
		Resenias resenia326 = new Resenias("Quise ir a verla por varios motivos. En primer lugar, leí en esta página las críticas existentes y todas le daban buena nota, a parte de que contaba con un 8,4 de nota (escribiendo estas líneas tiene un 8,2). También influía que la dirigía Fabián Bielinsky cuya película  &quot;Nueve Reinas&quot; me pareció soberbia y además, igual que con aquella contaba con un gran actor como Ricardo Darín.", "", usuario35, null);
		Resenias resenia327 = new Resenias("La cosa dicen que es así: Gabriel Medina, el debutante director de Los Paranoicos, supo ser asistente de dirección de Damián Szifrón, realizador que pergeñó un par de éxitos de TV en Argentina luego exportados a España: Los Simuladores y Hermanos y Detectives.", "", usuario35, null);
		Resenias resenia328 = new Resenias("Los paranoicos expone un excelente desarrollo de caracteres psicológicos al servicio de una trama tan interesante como sencilla. Hendler cumple un papel más que correcto, la lejanía/imposibilidad afectiva del personaje está trazada bajo tonos humorísticos, aunque hay mucho de tragedia ahi detrás unida a una cierta melancolía, un cierto estancamiento.", "", usuario30, null);
		Resenias resenia329 = new Resenias("Entretenida película que trata sobre la rivalidad entre dos “amigos” guionistas. La verdad es que la película me ha gustado principalmente, pero luego, hay cierta parte que parece un poco cogida con pinzas… (no puedo seguir, sin destripar parte de la película, así que continúo en el spoiler).", "", usuario31, null);
		Resenias resenia330 = new Resenias("Un personaje interesantisimo el protagonizado por Hendler, Gauna, en esta peli, es lo más rescatable de la misma, un personaje lleno de miedos, de excentricidades y de contradicciones. Así vemos, como el mundo al rededor ve a este sujeto, a Gauna, como lo interpretan, como lo burlan, o tratan de entenderlo sobre todo stuart.", "", usuario8, null);
		Resenias resenia331 = new Resenias("Tenía gran ilusión en visionar esta película Argentina, ya que es un cine bastante interesante y que ha realizado grandes películas, y en los aspectos culturales tenemos características en común, y pienso que es a mi parecer recomendable que nos preocupemos por conocer su cultura, costumbres, ya que en estos momentos convivimos con una población argentina considerable y sería bueno que el hecho de que nos conozcamos no lleve a un mejor entendimiento, y como es sabido la diversidad es enriquecedora.", "", usuario29, null);
		Resenias resenia332 = new Resenias("Muchas de las críticas negativas que recibió esta pelicula cometen el error de utilizar parámetros comúnmente utilizados para evaluar películas bélicas. Si bien la guerra es el tema central, el significado pasa por otro lado. Lamentablemente, esto es algo muy claro para un argentino, tal vez también para otros latinoamericanos, pero no lo es para otro público.", "", usuario23, null);
		Resenias resenia333 = new Resenias("Desde el punto de vista puramente cinematrográfico es una película humilde, con golpes bajos por momentos innecesarios, elaborada con tesón pero con algunas fallas fílmicas grandes y notorias. Pero perdón, no puedo dejar de decir algo desde el corazón.", "", usuario28, null);
		Resenias resenia334 = new Resenias("Podría haber sido mejor si no se hubiese hecho la historia mirando con un solo ojo. Como película bélica hay que tener en cuenta que es Argentina y como tal (presupuesto y efectos especiales por medio) no llega a las alturas de ningún filme norteamericano, pero independientemente las escenas bélicas matizan un poco la película.", "", usuario1, null);
		Resenias resenia335 = new Resenias("PREMIOS:San Sebastián: Premio Especial del Jurado Premio Goya por mejor película extranjera de habla hispana==================HECHOS (por Wikipedia):Los propios ex combatientes de Malvinas han expuesto su desacuerdo con la película, que fue presentada como una historia real cuando los hechos parecen indicar que Esteban Leguizamón no fue partícipe de las acciones como las relata la obra.", "", usuario33, null);
		Resenias resenia336 = new Resenias("http://filmicas.comEn la Buenos Aires de los 70s, Francisco Sanctis desayuna con su familia, camina al trabajo, intenta conseguir un ascenso, termina su día laboral y regresa a casa. Podría haber sido un día rutinario, pero desde el comienzo de &quot;La larga noche de Francisco Sanctis&quot; sentimos que hay algo podrido en alguna parte y que es cuestión de esperar a que se destape.", "", usuario30, null);
		Resenias resenia337 = new Resenias("“Cuestión de principios” combina varias líneas narrativas que circulan por los canales de la comedia dramática. Estética y narrativamente, es una película convencionalmente clásica, que se parece a los valores que encarna su protagonista principal, un impecable Federico Luppi que apela a su no tan frecuente costado de comediante.", "", usuario26, null);
		Resenias resenia338 = new Resenias("Muy grata sopresa.El film trata temas como los principios y valores, el peso de las convicciones de las personas en el desarrollo de la vida y la diferencia generacional. El punto de inicio del film parte del conflicto entre el abuelito de la empresa, trabajador, moral y de pensamientos casi caballerescos y el joven jefe, con poder y dinero que cree poder comprar todo, incluyendo a las personas a base de talonario.", "", usuario31, null);
		Resenias resenia339 = new Resenias("La primera escena de 'Cuestión de principios', película basada en el popular cuento del escritor y dibujante argentino Roberto Fontanarrosa, muy al estilo del mítico camarote de los hermanos Marx, presagia ya cuál va a ser la pauta a seguir. En un mundo tecnológicamente hablando cada vez más desarrollado y más superpoblado, los espacios se han reducido mucho, quizás demasiado.", "", usuario11, null);
		Resenias resenia340 = new Resenias("El cine argentino vive una época excelente, no paran de llegarnos nuevos trabajos del país de Messi y Maradona y a cual de ellos más interesante. Y es que no sólo destaca este enorme país que ahora llora a su ex presidente del gobierno los jugadores de fútbol mundialmente reconocidos, sino que también cuenta el país del tango con una gran hornada de actores y actrices que interpretan de maravilla.", "", usuario6, null);
		Resenias resenia341 = new Resenias("El paso del estado literario (cuento corto) al estado fílmico (largometraje) no le quitó muchos méritos a esta agradable fábula sobre los principios y la (post)modernidad. La película se disfruta por momentos y por otros se balancea peligrosamente cerca de los abismos de aquél viejo cine popular argentino, ese que lejos de pretender ser culto, quería convocar masivamente valiéndose de clichés y actuaciones vergonzantes.", "", usuario2, null);
		Resenias resenia342 = new Resenias("La película está inspirada en la figura del padre Giuseppe Mario Pantaleo (Pistoia, 1915-Buenos Aires, 1992), un sacerdote salesiano que alcanzó popularidad por su don de diagnosticar y -en ocasiones- curar por imposición de manos, padecimientos físicos incurables desde la mirada científica.", "", usuario3, null);
		Resenias resenia343 = new Resenias("Algunos pueden considerar un auténtico milagro y dignificar el Goya que recibió “Las manos” como mejor película extranjera del 2006 de habla hispana. Sería una cuestión de fe. Algo que ha olvidado el veterano director argentino, autor de la estupenda “Esperando la carroza”, al enfrentarse a la vida y milagros del Padre Mario Pantaleo.", "", usuario11, null);
		Resenias resenia344 = new Resenias("Las manos de quien escribe y adapta guiones transparentes en la Argentina de hoy están dotadas de talento y magnetismo para atraernos y contemplar las obras de este país. Es así como el trabajo de Alejandro Doria y Juan Bautista permite que conozcamos la historia de unas manos con el don de la cura, a enfermedades que la ciencia diagnostica como terminales.", "", usuario25, null);
		Resenias resenia345 = new Resenias("Siempre me han conmovido las historias sobre curas sanadores. En esta no se siguen los caminos trillados: buscar la grandilocuencia o la lágrima fácil, cuando resulta tentador y existen todas las posibilidades para hacerlo. Tampoco se exaltan los milagros de un cura infalible y ganador.", "", usuario27, null);
		Resenias resenia346 = new Resenias("Gran actuación de Marrales. La película va de menor a mayor. Lo único que he escuchado por ahí, es que la verdadera obra del padre Mario es gigantesca e imposible de resumir en una pelicula de hora y media. Nos quitamos el sombrero ante Doria. Queremos más cine de esta calidad.", "", usuario14, null);
		Resenias resenia347 = new Resenias("La leyenda dice que el ave Fenix resucita de sus propias cenizas. El ciclo interminable de la vida y la muerte. En este caso el ave es reemplazada por la mosca, que puede hundirse y ahogarse en el agua pero la ceniza la devolverá a la vida. La mosca.", "", usuario2, null);
		Resenias resenia348 = new Resenias("Ví la película &quot;La Mosca En La Ceniza&quot; y es buena pero por momentos no me atrapó mucho.El comienzo me pareció entretenido y luego atrapante pero me esperaba otra cosa mejor.La historia realista está bien contada pero se pudo haber mejorado.", "", usuario36, null);
		Resenias resenia349 = new Resenias("Parece que algo va a pasar en cualquier momento. El dolor sostenido de la protagonista es tan fuerte como las imágenes en blanco y negro inspiradas en Bergman o en el Allen de Interiores. Ese algo que va a pasar es lo que sigue al final de la película.", "", usuario10, null);
		Resenias resenia350 = new Resenias("Estoy confundido y no sé bien qué pensar de esta película. No le creo al protagonista, no me convence, no dice dos frases interesantes o que justifiquen el lugar que progresivamente va ocupando. Mueve los hilos importantes pero no se le ve pasta de intrigante, más bien lo es en los hechos pero no en la carnadura del personaje.", "", usuario14, null);
		Resenias resenia351 = new Resenias("Interesante intento por construir una reflexión contemporánea y rioplatense sobre las características malsanas del poder, de la toxicidad visceral de la política, de la anemia de escrúpulos que preside los tejemanejes del mundo universitario, politiqueos de salón, arribistas de cloacas varias.", "", usuario21, null);
		Resenias resenia352 = new Resenias("Luego de ser co-guionista en Leonera y Carancho (ambas de Pablo Trapero), Santiago Mitre dirige, solo, su opera prima.El estudiante es un film potente, soberbio, dirigido con una solvencia (y una mirada) tan real como efectiva, un drama con formato de Thriller en el qué abunda lo documental, un film independiente.", "", usuario11, null);
		Resenias resenia353 = new Resenias("Película presentada en la Competencia Oficial del FICCI. “El Estudiante”, es una de las que me llamaron mucho la atención desde que la vi en el listado. Precisamente, resultó ganadora como Mejor Película de la Competencia Oficial del FICCI, junto con los premios al Mejor Actor y el Premios de la Crítica Internacional (FIPRESCI).", "", usuario28, null);
		...
		Resenias resenia367 = new Resenias("Marco Berger logra en este largometraje lo qué otro no podría haber conseguido en un cortometraje.Plan B es una historia honesta, donde su director la construye con piezas sencillas pero sólidas, construye la historia desde su silencios, desde sus stop y sus pausa la construye desde un trabajo actoral más qué destacado de Manuel Vignau y Lucas Ferrero (a los qué la historia los toma por sorpresa pero no parecería tanto) el film se construye como una pirámide sólida desde el arranque pero tambalea cuando se esta acercando a la cima (hablo de lo argumental y no del declive del film); Berger pone el corte justo, los títulos aparecen en el preciso momento que deben aparecer, ni uno más ni uno menos.", "", usuario7, null);
		Resenias resenia368 = new Resenias("Adorable película de temática gay del cine argentino. Con personajes creíbles, sinceros, honestos. Son personajes que te enamoran. Deseas ser amigos de ellos, porque no tienen mas pretenciones que ser ellos mismos. Me encantó,  me enamore de esta película, el guión, la dirección, los actores, todos se complementan y nos ofrecen el nacimiento de una historia de amor urbano, sin pretenciones.", "", usuario36, null);
		Resenias resenia369 = new Resenias("Es cierto que abusa de las pausas pero le dan el ritmo a la película. No me pareció en absoluto larga,  todo lo contrario, me pareció diferente y muy valiente. Lo bueno es que es una historia en la que da igual la orientación sexual de los personajes, te los crees de principio a fin.", "", usuario4, null);
		Resenias resenia370 = new Resenias("El ritmo no es una novedad, las pausas tampoco, ni la ausencia de música. Pero todo contribuye a lo mismo, al tema de la película: la tensión de Pablo, el único que no juega, que se explora, que se permite vivir sin prisa ni miedo al resultado, consciente de poseer prejuicios que no le impiden nada.", "", usuario37, null);
		Resenias resenia371 = new Resenias("El binomio Burman-Hendler regresa ahora con una película de tono más gentil que &quot;El abrazo partido&quot;, ese film que muchos denominaban comedia cuando el drama le salía por los poros. &quot;Derecho de familia&quot; reincide en las relaciones familiares, en los problemas de comunicación y si en &quot;El abrazo partido&quot; no eran muy buenas esas relaciones aquí se demuestra que aún siendo buenas nos quedamos cortos.", "", usuario18, null);
		Resenias resenia372 = new Resenias("Esta no es una película de género, aunque circule entre la comedia y el drama ligero, a la manera de algunas películas de Truffaut, de quien Burman se diferencia en acentuar menos la poesía que los matices del humor en situaciones extremadamente simples.", "", usuario1, null);
		...
		Resenias resenia374 = new Resenias("Más madura que El abrazo partido, menos alleniana también, inferior asimismo. Buen, muy buen Hendler, dispersa a la hora de equilibrar los distintos aspectos de la vida del protagonista: acertadísima la parte del padre, algo menos la familiar, buena la sub-historia de la facultad y sus chistes.", "", usuario11, null);
		Resenias resenia375 = new Resenias("Si, tiene un arranque bastante bueno y la relación padre-hijo tiene muchos matices, pero en general la película me pareció falta de vida, sosa y reiterativa. Por su tono tan frío me es difícil emocionarme con ella, porque ni funciona como comedia ni como drama, y si lo hace, aunque, a medias, es como análisis en torno a las relaciones de pareja, la madurez y el paso del tiempo.", "", usuario10, null);
		Resenias resenia376 = new Resenias("El asaltante parece un fragmento de otra película mayor. Todos sabemos cómo se estructura  una película tipo; ésta se divide en tres partes: presentación, nudo y desenlace. Pues imaginen una película diseccionada sobre la mesa de edición. Tomamos la presentación y la arrojamos a la basura, tomamos el desenlace y hacemos lo mismo: nos quedamos sólo y exclusivamente con el nudo.", "", usuario27, null);
		Resenias resenia377 = new Resenias("Cabe recordar, que a partir de manifiestos como el Ulises de James Joyce, el esquema ático “presentación-nudo-desenlace” ha sido despojado de su primado y puesto en paridad. Es solamente un modo del ser, no uno de sus trascendentales. De manera que, corroer una trama por sospechar que se consuma nudamente, como pulpa expuesta, sin las tapas, sin el pecho y el rabo de uso, no es más que consumar un juicio epocalmente impropio.", "", usuario32, null);
		Resenias resenia378 = new Resenias("La acción transcurre prácticamente en tiempo real. El protagonista es un ladrón de guante blanco que roba colegios privados sin disparar un sólo tiro, interpretado por Arturo Goetz, con el porte necesario para pasar desapercibido ante sus víctimas.", "", usuario34, null);
		Resenias resenia379 = new Resenias("Si uno quiere imaginar la soledad más absoluta, el desamparo y la desazón sólo tiene que mirar esta película. El director nos muestra en este film despojado, realista y contundente lo que el desarraigo y el destino puede depararle a una persona. Si a eso le sumamos un cuadro costumbrista de una ciudad extranjera pero al mismo tiempo extremadamente familiar, como es la Nueva York tan conocida por múltiples películas, aunque visitada en una forma inusual por la mirada de un argentino, obtenemos por resultado este film entrañable, oscuro, pero al mismo tiempo enormemente humano y, dentro de todo lo dramático y desolado de la historia, con un dejo de optimismo final.", "", usuario25, null);
		Resenias resenia380 = new Resenias("Es cruda. Un baño de humildad. Es lo que nos espera.David Burgos interpreta magistralmente su papel.Es darwinismo social, solo los más fuertes sobreviven y el ejemplo: &quot;Perú&quot; es el buscavidas perfecto pero.... por encima de él está la mujer, Yekaterina, con sus artes (con sus armas) lo lleva al huerto y consigue sobrevivir a su costa.", "", usuario17, null);
		Resenias resenia381 = new Resenias("El bienvenido y creciente interés de las nuevas generaciones por el conocimiento de los protagonistas que construyeron al país, ya demostrado con el auge de la novela histórica y el ensayo más desprejuiciado sobre próceres y acontecimientos autóctonos, se ha trasladado al cine, favorecido al calor de la conmemoración del bicentenario y el interés de las autoridades actuales en revisitar la historia argentina.", "", usuario37, null);
		Resenias resenia382 = new Resenias("¿Que es la Patria? Esta es una de las preguntas que le hace Esteban de Corvalan uno de los pocos veteranos que quedan de la gesta libertadora al periodista que lo entrevista con motivo del retorno de los restos del General San Martin a Buenos Aires en 1880.", "", usuario6, null);
		Resenias resenia383 = new Resenias("Confieso que he esperado esta película con mucha expectativa. Me predispuse de la mejor forma para degustarla pero finalizada la misma el paladar me quedo adormecido, como después de masticar hielo. La película no es mala, es cierto, pero prometía mucho más.", "", usuario21, null);
		Resenias resenia384 = new Resenias("A priori, se podría ubicar a este film dentro del mismo género que “Belgrano: la película” ya que en ambos casos se trata de reconstruir una parte de la historia de nuestro país pero con un enfoque basado en la personalidad del personaje principal, José de San Martín en este caso.", "", usuario5, null);
		Resenias resenia385 = new Resenias("Las películas basadas en la vida de próceres o líderes de poder cometen muchas veces el mismo error: ser formales y suntuosas. Quien haya visto varias películas históricas en los últimos tiempos podrá darme la razón. Ya no puedo recordar la diferencia entre Elizabeth, La Duquesa, Maria Antonieta, Las hermanas Bolena.", "", usuario2, null);
		Resenias resenia386 = new Resenias("El cine argentino, siempre desparejo y a veces sorprendente, está atravesando un época muy activa, seguramente favorecido por el compromiso institucional que le sirve de apoyo a lo largo de estos años. Muchos son los estrenos y otros los filmes que llegan al público editados en formatos de uso hogareño, inclusive sin haber pasado por una sala.", "", usuario23, null);
		Resenias resenia387 = new Resenias("Siempre las críticas son distantes, como si uno no se quisiera involucrarse demasiado con la película que se comenta... Yo quiero hacer todo lo contrario, quiero agradecer a su director y a sus actores por hacerme olvidar por un tiempo de los problemas cotidianos, quiero confesarles con toda sinceridad, qué gran trabajo han hecho, siéntanse muy orgullosos de esta obra que tiene un latido profundo y cercano.", "", usuario1, null);
		Resenias resenia388 = new Resenias("La idea de mixturar realidad con ficción, actualidad con historia, y jóvenes supuestamente blandos con guapos violentos, a la par de atractiva podía resultar fallida.Fantasma de Buenos Aires tiene algunos problemas a la hora de resolver guión con actuación, pero es un esfuerzo que merece ser visto y recomendado.", "", usuario37, null);
		Resenias resenia389 = new Resenias("Lo siento, pero después de ver tanto cine bueno (dentro de la propia Argentina, además) no me vale con un puñado de moralinas y cuatro escenas cómicas para decir que algo es, por lo menos, interesante. La parte inicial de la película es ramplona y está mal sujeta por el elenco joven que la interpreta, y aunque es verdad que el guión se va entonando y al final hasta consigue enternecer un poco al espectador, lo cierto es que eso no es suficiente para salvar la película.", "", usuario20, null);
		Resenias resenia390 = new Resenias("Me pareció una película bastante ocurrente para ser argentina... Me gustó mucho el lazo que se genera entre el pibe y el fantasma, quien parece ser muy rudo, pero al final se termina quebrando ante las situaciones que no supo ver y que se entero muchos años después.", "", usuario33, null);
		Resenias resenia391 = new Resenias("Este cuarto largometraje de la realizadora María Victoria Menis es una bienaventurada rareza en el cine argentino actual, no sólo porque prescinde de actores conocidos pero que igualmente demuestran un sólido oficio forjado en el teatro independiente, sino por su apuesta temática y narrativa, a contracorriente de buena parte de la producción nacional.", "", usuario1, null);
		Resenias resenia392 = new Resenias("María Cristina Menis demuestra cómo se hace un excelente cine a partir de una historia aparentemente sencilla. &quot;La cámara oscura&quot; es una película de esas que hay ver nueva vez. De manera sutil te va llevando a un reconocimiento de los valores esenciales del ser, a mirar con ojos atentos lo importante de este mundo.", "", usuario3, null);
		Resenias resenia393 = new Resenias("Película un tanto especial, de ritmo pausado y tono intimista, con muy pocos diálogos. Y aunque no es para nada aburrida, para mí el hecho de que haya tan pocos diálogos  hace que sea algo fría y distante. Me hubiera gustado saber más cosas de Gertrudis, su protagonista:  qué siente, qué desea hacer, qué está pensando, por qué no se rebela.", "", usuario11, null);
		Resenias resenia394 = new Resenias("Cuánta desilusión. La directora María Victoria Menis sabe cómo desperdiciar una buena idea y destrozarla en apenas los 20 primeros minutos del film. Realiza una película desangelada, con un guión que nunca avanza y actuaciones para el olvido; como la de Fernando Arman, que es tan mediocre en su papel que nunca llegamos a creer que sea el jefe de una familia de estancieros y más bien nos parece el hermano compinche de sus propios hijos, cosa muy improbable en la vida de campo de los inicios del siglo XX.", "", usuario10, null);
		Resenias resenia395 = new Resenias("Prefiero los dramas carcelarios en los que lo importante es el relato de la fuga o la descripción de los presos.Aquí han dado demasiada importancia a un artificioso (y artificial) montaje para intentar maquillar un guión flojo, aunque el potencial de la historia era prometedor.", "", usuario22, null);
		Resenias resenia396 = new Resenias("Mignona adaptó su propia novela, la cual narraba la fuga de 7 presos de una penitenciaría de Buenos Aires a finales de los años 20. Se rodeó para ello de un grupo estupendo de intérpretes, los cuales son capaces de transmitir con suma eficacia el caracter de sus personajes.", "", usuario24, null);
		Resenias resenia397 = new Resenias("La película es buena, las actuaciones están bien y la historia es buena y fue real. Un par de detalles erróneos en el comentario es la locación de la historia; se dice sucedió en Buenos Aires, cuando los hechos ocurrieron en el correccional penal de Punta Carretas, en la ciudad de Montevideo, Uruguay; la otra diferencia es que sólo fueron 3 los escapados, y eran todos anarquistas.", "", usuario34, null);
		Resenias resenia398 = new Resenias("A mi modesto criterio, esta película es un libro de fotografías demodé, más que un film....Resultón gasto de producción para la ambientación y tal, pero fallida historia, a la que no se le encontra nunca la razón y el sentido entre las situaciones deslabazadas.", "", usuario3, null);
		Resenias resenia399 = new Resenias("Pues a mí me ha gustado, y mucho, &quot;La fuga&quot; de Eduardo Mignogna. Libertades históricas aparte (Buenos Aires en lugar de Montevideo y siete fugados en lugar de los tres que en realidad fueron) la película es muy sólida y con magníficos giros de guión que sorprenden y hacen más atractiva la cinta.", "", usuario14, null);
		Resenias resenia400 = new Resenias("Terminé de ver &quot;Mía&quot; con la sensación incomparable de haber asistido a un espectáculo maravilloso. Más allá de su mirada social y de su profundo compromiso artístico, &quot;Mía&quot; resume el encanto de las cosas bien hechas. Un guión contundente, unas actuaciones a medida y una sensibilidad que se desprende de su piel como un ejercicio mágico.", "", usuario8, null);
		Resenias resenia401 = new Resenias("El asadito trata de unos amigos que se reúnen para comer el 30 de Diciembre de 1999. La acción transcurre en la ciudad de Rosario, Argentina. Cada uno de los personajes encarna un cierto rol muy delimitado, sin demasiada profundidad y en algunos casos de manera un tanto histriónica.", "", usuario31, null);
		Resenias resenia402 = new Resenias("Los siete amigos que vemos en este film tienen algo en común. Nacieron entre las décadas del 60/70. Llegado el día del rodaje, en 1999, ya varios pelan canas, arrugas, miradas de desencanto y un considerable camino andado por sus respectivas vidas.", "", usuario7, null);
		Resenias resenia403 = new Resenias("Cuando vi el título, leí la trama y conocí su duración me dije, tengo que ver esta película. No me defraudó, un film interesante y que ayuda a pasar el rato. Las actitudes, gestos, palabras son para mí (argentino) conocidas y por ello más de una vez graciosas.", "", usuario26, null);
		Resenias resenia404 = new Resenias("Otra mas. Y eso me pone bien. Saber que en mi país se hizo buen cine. Como en realidad por momentos se sigue haciendo. Y esta película que se trata de un simple asadito (como su título lo indica) en una terraza de Rosario se hace un viaje hermoso a las costumbres argentinas.", "", usuario15, null);
		Resenias resenia405 = new Resenias("Con lo que se gasta una europea en venir desde su país hasta Argentina, la estancia larga ahí y luego el pago por llevarse un bebé (todo de manera ilegal y tratando con desalmados  intermediarios cuyo negocio es la venta de seres humanos), es decir unos 30.", "", usuario36, null);
		Resenias resenia406 = new Resenias("Interesante peli argentina sobre la adopción ilegal de niños, tráfico de lo más espinoso porque nadie garantiza las buenas intenciones del “comprador” (al que no se le hacen demasiadas preguntas cuando desembolsa la friolera de 20 o 30.000 euros por un niño), de manera que pueden acabar siendo pasto de la prostitución infantil o la venta de órganos.", "", usuario12, null);
		Resenias resenia407 = new Resenias("Con la intención de desocultar una realidad que muchos no conocen, Juan Solanas (ver spoiler), elige un tema doloroso y encubierto en la Argentina: el tráfico de niños vinculado con la adopción ilegal pero también con el negocio de órganos y la prostitución infantil.", "", usuario33, null);
		Resenias resenia408 = new Resenias("Nordeste trata el tema de la adopción internacional de niños, en este caso en Argentina, y sigue las peripecias de una ejecutiva francesa soltera y de mediana edad en su búsqueda de un bebé. Formaría una buana trilogía con La Casa del los Babys de John Sayles y la más reciente La Pequeña Lola de Bertrand Tavernier, pero se distancia de ellos en la forma de contar la historia, muy pausada y sin hacer partícipe a la cámara de la intensidad emocional que vive los personajes (en contraste con el exceso de cámara en mano del que hacía uso Tavernier).", "", usuario10, null);
		Resenias resenia409 = new Resenias("Es el nordeste argentino, lugar donde está contextualizada la ópera prima de Juan Solanas, una de las regiones más deprimidas del país sudamericano. Esta descarnada historia, que bebe del realismo social más aguerrido, denuncia sin paliativos ni edulcorantes la adopción ilegal de infantes en las zonas más depauperadas del globo.", "", usuario0, null);
		Resenias resenia410 = new Resenias("&quot;No sos vos, soy yo&quot; o lo que es lo mismo; &quot;no eres tú, soy yo&quot;; es una frase tan vieja como habitual en el día a día de la especie humana. Hoy le toca al amigo, mañana al vecino y pasado te toca a ti. Y Taratuto sin duda sabe de qué está hablando.", "", usuario7, null);
		Resenias resenia411 = new Resenias("En el ranking de las tres frases más jodidas que puede decirte el amor de tu vida están las que siguen:- &quot;Tenemos que hablar&quot;.- &quot;Eres como un hermano/a para mí&quot;- &quot;Sí, me lo he follado&quot;.", "", usuario25, null);
		Resenias resenia412 = new Resenias("Qué condenadamente jodidas pueden ser las relaciones. Lo realmente malo es que tenemos la manía de ilusionarnos, de empezar a pensar en mañana. El ser humano tiene la estúpida obsesión de creer que, en cuanto alguien le ofrece unas migajas, ya sus manos van a pasear unidas por los oleajes del tiempo durante toda la eternidad.", "", usuario10, null);
		Resenias resenia413 = new Resenias("En esta opera prima de Juan Taruto la historia es todo un drama, pero el guión le da un delicioso clima de comedia que el director saca adelante con altas dosis de ironía, agilidad y, por supuesto, humor. Presentar el terrible conflicto del protagonista con una sonrisa es el gran mérito de este trabajo.", "", usuario36, null);
		Resenias resenia414 = new Resenias("De las pocas películas, que yo recuerde, cuyo tema principal sea el amor-desamor, que me haya gustado, tal vez por el tono tragicómico que derrocha, o por lo entrañable del protagonista o por todo en general.Una muestra mas de la calidad del cine Argentino.", "", usuario29, null);
		Resenias resenia415 = new Resenias("&quot;Todo el bien del mundo&quot; no es de esas películas que perduran en la memoria, tiende a desdibujarse si dejas pasar unos días desde que la ves. Y esa sensación de que se escurre en la memoria se debe a que es una película irregular, irregular en diálogos (algunos son destacables, y otros resbalan por el oído sin dejar huella) e irregular en situaciones (no es un argumento bien trabado, con situaciones construidas con un ritmo regular, fluido).", "", usuario22, null);
		...
		Resenias resenia429 = new Resenias("Un niño, testigo silencioso que todo lo ve, todo lo oye, de todo se entera, presencia que pasa desapercibida pero todo lo devora, perenne esencia volteada como maleta sin equipaje a quien nadie pregunta, todo en su cabeza, engullido y mezclado, difícil saber qué piensa, cómo se siente realmente, lo único claro es lo que le hace daño, lo que le perjudica, lo mucho que no entiende y lo poco que sí sabe, que su papá pega a su mamá, que su mamá llora, que no puede volver al colegio y que se perderá los cumpleaños de sus amigos, que siente mear la cama y que está cansado de correr.", "", usuario5, null);
		Resenias resenia430 = new Resenias("El film describe el doloroso aprendizaje y la creciente desesperación de una joven de clase media que decide prostituirse por una noche, recurriendo a una antigua amiga del colegio que se dedica al oficio más antiguo del mundo. Previsiblemente, todo le resultará mucho más difícil de lo que imagina.", "", usuario34, null);
		Resenias resenia431 = new Resenias("Aunque tengo el mismo gusto que Shandy por el cine argentino, no coincido exactamente con su crítica: no creo que sea tan mala. Es simplemente sobria. Cualquier intento de mostrar más hubiese caído en el dramatismo lacrimógeno.Me parece una película correcta, que curiosamente nos sitúa premeditadamente lejos de la protagonista.", "", usuario20, null);
		Resenias resenia432 = new Resenias("Pese a ser un casi incodicional de todo el cine argentino, poco o nada positivo he encontrado en esta película que al menos es breve; una multitud de planos subjetivos que no cuentan nada y que aburren, son intercalados entre las insulsas escenas de una película que no está mal hecha pero que no cuenta nada y cuyo personaje central no invita a la simpatía, no por una mala interpretación, sino por pura insuficiciencia del guión.", "", usuario8, null);
		Resenias resenia433 = new Resenias("Esta nueva película argentina está basada en un cuento inédito de Alberto Laiseca del mismo nombre.  En el original, un hombre está muy enamorado de su esposa y por miedo a perderla por falta de dinero hace un pacto con el diablo a cambio de un millón de dólares.", "", usuario0, null);
		Resenias resenia434 = new Resenias("Querida voy a comprar cigarrillos y vuelvo es una película inclasificable, ni cine popular ni cine para especialistas. La premisa es la siguiente: A nuestro antihéroe se le presenta la oportunidad de vivir diez años en su pasado conservando su mente actual a cambio de un millón de dólares.", "", usuario15, null);
		Resenias resenia435 = new Resenias("Cohn-Duprat tienen en su haber un par de films más que interesantes. A decir verdad no me gustó demasiado &quot;Yo Presidente&quot;. Sin embargo lo que vino después fue mejorando más que gradualmente. &quot;El Artista&quot; me dejó una gran impresión y fue la mejor carta de presentación para lo que vendría.", "", usuario36, null);
		Resenias resenia436 = new Resenias("“Cine de autor”, raro, particular, tal vez algo pretensioso, pero definitivamente una propuesta distinta. Basado en un cuento del escritor Alberto Laiseca, famoso por su obra &quot;Los sorias&quot;, considerada la obra más larga de la literatura argentina, y el cual se hizo un poco más conocido para el público general cuando condujo un ciclo de cuentos de terror en episodios de diez minutos en el canal I-SAT.", "", usuario14, null);
		Resenias resenia437 = new Resenias("&quot;Querida, voy a comprar cigarrillos y vuelvo&quot; es una comedia que mezcla el género dramático y la ciencia ficción dando lugar a una radiografía de una Argentina y de los argentinos. Basado en un cuento de ciencia ficción de Alberto Laiseca, quien ademas es narrador y explica las desventuras que hace el protagonista que interpreta en un papel dramático nunca visto de Emilio Disi cuando hace un pacto &quot;diabólico&quot; con un personaje chanta, sacado de una persona de cine bizarro, que le ofrece dinero a cambio de que retroceda, él y sólo él, diez años en el tiempo.", "", usuario30, null);
		Resenias resenia438 = new Resenias("Pequeña película de animación argentina totalmente irregular, aunque con puntos destacables.El film está compuesto por cuatro historias, contadas por distintos animadores/dibujantes, que tienen que ver con la Gran Buenos Aires. Lo desparejo de los segmentos atenta contra el resultado final, aunque constituye una rareza ver este tipo de films elaborado en el sur.", "", usuario14, null);
		Resenias resenia439 = new Resenias("La flamante remake del clásico de Daniel Tinayre , realizado en 1960, justifica la actualización de su propuesta, que incorpora la actualidad de su propio tiempo y a su vez interpela hasta qué punto nos hemos desacostumbrado a los dilemas éticos y su consecuente dialéctica para defender ideas y consecuencias.", "", usuario11, null);
		Resenias resenia440 = new Resenias("La película de Mitre es un profundo despropósito. Pretende hacer un análisis moral de la sociedad occidental pero para ello utiliza un guión poco o nada creíble. La película no desgrana las motivaciones que conducen a los actos de la protagonista.", "", usuario35, null);
		Resenias resenia441 = new Resenias("Estamos ante un retrato poderoso de un personaje femenino que marca su independencia, que se enfrenta a su padre y a su novio, se rebela contra una previsible carrera exitosa en la judicatura y se revuelve contra las decisiones que otros toman por ella, colisionando con los convencionalismos al uso y demostrando que la integridad moral no conoce de vínculos afectivos, ni de servilismos trasnochados, ni de sumisiones tácitas o expresas.", "", usuario27, null);
		Resenias resenia442 = new Resenias("En su segundo largometraje –un remake de «La patota» de Daniel Tinayre–, el argentino Santiago Mitre construye un drama de gran fuerza emotiva que se sostiene completamente sobre los hombros de su complejo personaje protagonista, Paulina, una joven idealista que será víctima de una violación.", "", usuario34, null);
		Resenias resenia443 = new Resenias("Hermosísima película. Endemoniadamente compleja, interesante y bien hecha.Todos sabemos que las grandes causas, los idearios bellos, los discursos al viento, todo el entramado de frases, sentencias, normas, leyes, derechos..., y demás reglas del juego son, en la medida en que se acercan a la cruda realidad, no más que un pálido reflejo de su celestial intención inicial.", "", usuario31, null);
		Resenias resenia444 = new Resenias("Un treinteañero, que hace 10 años era un joven que vivía al día, sólo pensando en sí mismo y sin importarle lo que pensara la gente, se encuentra con una extraña situaciòn:ahora que ya tiene su vida hecha pero continúa inseguro en sus relaciones, resulta que una niña de 10 años le hace descubrir que la vida puede tener otro sentido menos frívolo y más gratificante.", "", usuario7, null);
		Resenias resenia445 = new Resenias("Nacionalidad: argentina. Los argentinos no dejan de sorprender con su cine, ya sea comedia, construyendo historias al uso o con este cine pausado. Rubén es un camionero que viaja de Paraguay a Buenos Aires, 1500 km. En este viaje, por petición de su jefe, debe llevar con él a una mujer paraguaya, Jacinta, que además va acompañada de su bebé, una niñita sorprendente.", "", usuario16, null);
		Resenias resenia446 = new Resenias("Entrañable y optimista película capaz de hacernos recordar  que siempre se puede volver a empezar, que no todo es igual per secula seculorum. Es una película radical en su desarrollo, no da concesiones a la galería, pero por la fuerza de sus imágenes y el tratamiento de las situaciones y personajes,  logra que te llegues a  sentirte dentro de esa cabina, a sentir y comprender los sentimientos de los dos personajes adultos, a deleitarte con la alegría de vida de la beba tan indiferente –por otra parte- a lo que ocurre en esa cabina de camión.", "", usuario4, null);
		Resenias resenia447 = new Resenias("Mientras transcurría la película me lo pregunté varias veces: ¿Cómo una película puede ser lenta, con pocos diálogos, sin música y  con planos fijos y, sin embargo, generar una sensación de incomodidad, de tensión constante?¿Cómo pueden tres personajes que hablan muy poco (o nada) meterse adentro del corazón del espectador y lograr que uno se sienta identificado con ellos?La respuesta: así.", "", usuario35, null);
		Resenias resenia448 = new Resenias("Aunque esta película no desprenda el nivelazo al que me tiene acostumbrada el cine argentino, se trata igualmente de una historia agradable de ver. Transcurre de manera sosegada (quizá demasiado). Los actores estan muy bien y basicamente podemos intuir el resurgir de un sentimiento escondido, el deseo de volver a estar en compañía, querer y ser querido.", "", usuario33, null);
		Resenias resenia449 = new Resenias("Para los qué amamos el cine de Sorin, para los que disfrutamos de las “historias mínimas”, Las Acacias, ópera prima de Pablo Giorgeli, es una caricia, es una joya qué el cine nos regala y es un lujo del qué no debemos privarnos.Las Acacias, ganadora de la cámara de oro en el festival de Cannes mejor ópera prima, es una road movie en la cual hacemos el trayecto de la frontera con Paraguay hasta Buenos Aires, es un recorrido, como cualquiera.", "", usuario17, null);
		Resenias resenia450 = new Resenias("Soy argentino, pero si no lo fuera, o si fuera un argentino de los tantos que sólo leen las páginas de deportes de los diarios y mira notas policiales por TV, y me encontrara por casualidad con la sinopsis de esta película diría: ni loco voy al cine a ver eso.", "", usuario34, null);
		Resenias resenia451 = new Resenias("El infaltable azar vincula las diferentes historias de Ezequiel (Peretti) y Paula (Oreiro), cuya relación empezará mucho más cercana al odio que al amor a primera vista: el personaje central es un compositor de música para películas, momentáneamente falto de inspiración, que atraviesa un reciente divorcio y problemas económicos apremiantes.", "", usuario27, null);
		Resenias resenia452 = new Resenias("Seguramente mi desconocimiento del cine argentino, que no va mas allá de las siempre entretenidas y las mas de las ocasiones divertidas comedias que son estrenadas en España y aquellos desfases de Alberto Olmedo y Jorge Porcel  que nos llegaron en los 80 a los videoclubs patrios (con gran acogida por parte de la clientela, así era y así lo cuento) me impidan analizar con mas conocimiento esta película.", "", usuario4, null);
		Resenias resenia453 = new Resenias("Dos situaciones iniciales, dos urgencias, cómicamente desesperadas -la de un hombre y la de una mujer- que inopinadamente se agarran el uno al otro para ayudarse, casi a contrapelo,  y de ahí va naciendo al mismo tiempo , va fluyendo la cosa, a trancas y barrancas, con muchas complicaciones, pero fluyendo, hacia la musica cumplida y el amor que se hace y el niño que nace.", "", usuario28, null);
		Resenias resenia454 = new Resenias("Una película entretenida y muy agradable . Tiene buenos momentos graciosos y divertidos que harán pasar un buen rato en el cine con humor inteligente . El ritmo no decaee gracias al buen guión . Un lujo el elenco principal formado por Diego Peretti , Natalia Oreiro y Norma Aleandro .", "", usuario33, null);
		Resenias resenia455 = new Resenias("Vista en perspectiva histórica de su estreno en el 2004 pocas veces en Argentina se había aventurado al género de la comedia romantica. Pero con El amor (Primera Parte) se llega a un género que en comparación a posteriores películas como las de Juan Taratuto (especialmente) es más de un estilo de ensayo sobre el amor, con elementos de una historia de ficción suaves tamizadas por momentos de lecciones acerca de la experiencia del amor desde un punto de vista cientificista, racional que sirve esto último para darle un toque de humor, para sazonarla y descubrir su divague intelectual de estos cuatro directores.", "", usuario26, null);
		Resenias resenia456 = new Resenias("No voy a hacer una crítica detallada. Sólo voy a decir que la vi hace poquito y me hizo acordar mucho a Blue Valentine y a 500 Días juntos (500 Days with Summer). Un poco me indignó el parecido, ya que ambas me habían gustado, pero esto ya me parecía una copia.", "", usuario31, null);
		...
		Peliculas pelicula6 = new Peliculas("El ciudadano ilustre",2016,"",118,"Es la historia de un escritor argentino, Premio Nobel de Literatura, que hace cuarenta años abandonó su pueblo y partió hacia Europa, donde triunfó escribiendo sobre su localidad natal y sus personajes. En el pico de su carrera, el alcalde de ese pueblo donde nació le invita para nombrarle &quot;Ciudadano Ilustre&quot; del mismo, y él decide cancelar su apretada agenda y aceptar la invitación.",0,"imgs/peliculas/6.jpg","",actorespelicula,director5,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula13 = new Peliculas("Roma",2004,"",148,"La irrupción del periodista Manuel Cueto en la vida del escritor Joaquín Góñez, a instancias de la editorial para la que Joaquín está escribiendo su último libro, provocará un gran desasosiego en la solitaria vida de este hombre que vive de espaldas al mundo y rehuye sus propios recuerdos.",0,"imgs/peliculas/13.jpg","",actorespelicula,director3,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula22 = new Peliculas("Kamchatka",2002,"",104,"Los difíciles años de la dictadura militar argentina son contemplados por Harry, un niño de diez años que lo único que desea es jugar y hacer travesuras con su hermano pequeño. Sin embargo, en 1976, cuando su familia, perseguida por la dictadura, se ve obligada a esconderse en el campo, comienza para él una nueva vida que pondrá fin a su infancia.",0,"imgs/peliculas/22.jpg","",actorespelicula,director16,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula24 = new Peliculas("Leonera",2008,"",113,"Julia (Martina Gusman) es una joven acusada del asesinato de su novio. Aunque las circunstancias del crimen no están claras, acaba ingresando en prisión. Abatida y embarazada deberá adaptarse a su nueva vida en la cárcel, donde nacerá su hijo Tomás...",0,"imgs/peliculas/24.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula28 = new Peliculas("Camino a La Paz",2015,"",92,"Sebastián (Rodrigo de la Serna) es un joven recién casado, fanático de Vox Dei. El protagonista, motivado por una necesidad económica, comienza a trabajar de remisero con su Peugeot 505. En este trabajo conoce a Khalil (Ernesto Suarez), un anciano poco gentil. Juntos emprenderán un largo viaje desde Buenos Aires hasta La Paz (Bolivia), donde se pondrá a prueba la relación de los dos protagonistas.",0,"imgs/peliculas/28.jpg","",actorespelicula,director21,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula29 = new Peliculas("El artista",2008,"",91,"Jorge (Sergio Pángaro) es un enfermero que pasa de cuidar ancianos en un geriátrico a convertirse en el nuevo niño mimado de la escena artística bonaerense. Tras presentar como propias unas pinturas de uno de los ancianos, su vida simple y monótona se transforma de repente en un constante peregrinar por galerías de arte, universidades, programas de televisión, y reuniones con artistas e intelectuales.",0,"imgs/peliculas/29.jpg","",actorespelicula,director5,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula32 = new Peliculas("El cielito",2003,"",93,"Félix, un joven vagabundo de 20 años, llega a un pueblecito perdido del interior de Argentina. En la estación, se encuentra por casualidad con Roberto, un desocupado devenido en albañil, que le ofrece a Félix un trabajito en la chacra donde vive con su mujer, Mercedes, y su hijo Chango de apenas un año. Es ahí, en ese contexto de soledad, bajo el sol abrasador de La Pampa, donde Félix descubre poco a poco la tensión cotidiana, violenta y muda, en la cual ellos sobreviven.",0,"imgs/peliculas/32.jpg","",actorespelicula,director23,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula33 = new Peliculas("Al final del túnel",2016,"",120,"Joaquín está en silla de ruedas. Su casa, que conoció tiempos mejores, ahora es lúgubre y oscura. Berta, bailarina de striptease, y su hija Betty, llaman a su puerta respondiendo a un anuncio que puso Joaquín para alquilar una habitación. Su presencia alegra la casa y anima la vida de Joaquín. Una noche, mientras trabaja en su sótano, Joaquín escucha un ruido casi imperceptible.",0,"imgs/peliculas/33.jpg","",actorespelicula,director24,reseniaspelicula,usuario,genero0, true);
		...
		Peliculas pelicula36 = new Peliculas("El patrón, radiografía de un crimen",2014,"",99,"El patrón, radiografia de un crimen, se enfoca en un hecho criminal real sobre un hombre rural que llega a Buenos Aires en busca de trabajo y termina explotado por un siniestro patrón que lo obliga a vender carne podrida y que lo somete a una verdadera esclavitud, en el corazón de la Ciudad de Buenos Aires y en el siglo XXI.",0,"imgs/peliculas/36.jpg","",actorespelicula,director27,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula37 = new Peliculas("El polaquito",2003,"",92,"Un chico de la calle, de 13 años de edad, se gana la vida cantando tangos en los trenes de la estación central de Buenos Aires. Imita a Polaco Goyeneche, el famoso cantante de tangos, por lo que la gente le conoce como &quot;El Polaquito&quot; (Abel Ayala). El Polaquito conoce a &quot;Pelu&quot; (Marina Glezer), una joven prostituta que también trabaja en la estación de Constitución, de la cual queda inmediatamente prendado y a la que intenta rescatar de la mafia que la explota.",0,"imgs/peliculas/37.jpg","",actorespelicula,director28,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula41 = new Peliculas("La suerte está echada",2005,"",99,"Comedia que habla de la suerte, del destino y del afecto de dos hermanastros muy diferentes, que han vivido distanciados durante años. Es su padre quien los vuelve a unir en una circunstancia muy particular.",0,"imgs/peliculas/41.jpg","",actorespelicula,director31,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula44 = new Peliculas("El clan",2015,"",110,"La historia se basa en el caso policial del Clan Puccio, que conmocionó a la sociedad argentina a principios de los 80. Tras la aparente normalidad de la familia Puccio se oculta un siniestro clan dedicado al secuestro y al asesinato. Arquímedes, el patriarca, miembro del Servicio de Inteligencia desde la dictadura, lidera y planifica las operaciones.",0,"imgs/peliculas/44.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero0, true);
		...
		Peliculas pelicula45 = new Peliculas("Medianeras",2011,"",94,"Mariana y Martín viven en la misma manzana en diferentes edificios; pero, aunque sus caminos se cruzan, no llegan a encontrarse. Martín diseña páginas web. Mariana es arquitecta, pero trabaja como decoradora de vidrieras. Además de desilusiones recientes, los dos tienen muchas cosas en común. Viven en el centro de Buenos Aires. La ciudad los une y a la vez los separa.",0,"imgs/peliculas/45.jpg","",actorespelicula,director8,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula47 = new Peliculas("El abrazo partido",2003,"",100,"Narra la historia de un &quot;adolescente tardío&quot; que busca un pasaporte para huir de Argentina pero al que el regreso de su padre, que abandonó a la familia por un ideal, le trastoca los planes. Pese a ello, y gracias a este reencuentro, el hijo buscará a través de su padre su propia identidad.",0,"imgs/peliculas/47.jpg","",actorespelicula,director34,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula52 = new Peliculas("El bonaerense",2002,"",99,"EL Zapa es cerrajero en un pueblo pequeño de la Provincia de Buenos Aires. El pueblo es tranquilo, trabajo de cerrajería hay muy poco y las horas de trabajo pasan lentamente. El Polaco, el dueño del local lo envía a abrir una caja fuerte en una oficina. Al día siguiente cae preso como responsable del robo al lugar. Su tío Ismael, policía Bonaerense retirado, lo saca de la comisaría y lo envía al Gran Buenos Aires con una carta de recomendación.",0,"imgs/peliculas/52.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula55 = new Peliculas("Familia rodante",2004,"",103,"La abuela Emilia cumple 84 años... Muy emocionada, anuncia a toda su familia que su sobrina la ha elegido como madrina de su boda, que se celebrará a 1.500 kilómetros de allí. Para ese largo periplo de Buenos Aires a Misiones, lugar de su nacimiento, Emilia desea que todos la acompañen. Como nadie se atreve a negárselo, se ponen en marcha en una caravana.",0,"imgs/peliculas/55.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula56 = new Peliculas("Nueces para el amor",2001,"",103,"En 1975, unos meses antes del comienzo de la dictadura militar argentina, Alicia y Marcelo se conocen en un concierto de rock. El amor surge inmediatamente entre ellos, pero el retorno del novio de Alicia provoca la separación. En 1982, en Madrid, sus caminos vuelven a cruzarse. Tras el encuentro, se dan cuenta de que, a pesar de que el amor sigue latente, sus destinos discurren por rumbos separados.",0,"imgs/peliculas/56.jpg","",actorespelicula,director33,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula57 = new Peliculas("El último Elvis",2012,"",92,"Carlos Gutiérrez, &quot;Elvis&quot;, es un cantante separado que vive en un olvidado barrio de Buenos Aires y que tiene una pequeña hija llamada Lisa Marie, a la que no ve muy seguido. Siempre vivió su vida como si fuese la reencarnación de Elvis Presley, negándose a aceptar su realidad. Pero está a punto de cumplir los años que su ídolo tenía al morir y su futuro se muestra vacío.",0,"imgs/peliculas/57.jpg","",actorespelicula,director40,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula63 = new Peliculas("Martín Fierro, la película",2007,"",88,"Martín Fierro es un renegado que lucha contra la corrupción que intenta someterlo y quitarle lo más preciado de su vida: La libertad.",0,"imgs/peliculas/63.jpg","",actorespelicula,director45,reseniaspelicula,usuario,genero7, true);
		...
		Peliculas pelicula64 = new Peliculas("Carancho",2010,"",107,"Después de haber perdido su licencia, el abogado Sosa (Ricardo Darín) ingresa en una sociedad ilegal que se encarga de provocar accidentes automovilísticos para estafar a las aseguradoras. El destino hace que un día Sosa conozca a Luján (Martina Gusmán), una médica de un hospital de Buenos Aires.",0,"imgs/peliculas/64.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula65 = new Peliculas("El último verano de la Boyita",2009,"",93,"La Boyita es una casa rodante que tiene la mágica capacidad de flotar. Una especie de anfibio doméstico, un refugio para Jorgelina, una niña que está a punto de alcanzar la adolescencia. Cuando va a pasar las vacaciones al campo junto a su papá, conoce a Mario, un niño que le plantea a Jorgelina dudas que no sabe cómo afrontar.",0,"imgs/peliculas/65.jpg","",actorespelicula,director46,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula66 = new Peliculas("La libertad",2001,"",73,"Misael vive en la inmensidad del monte pampeano trabajando con su hacha. Sobrevive sólo con lo indispensable y casi sin contacto con otras personas. Vemos su vida minuto a minuto intentando descubrir a través de pequeños movimientos o acciones su manera de estar en el mundo.",0,"imgs/peliculas/66.jpg","",actorespelicula,director38,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula69 = new Peliculas("Los paranoicos",2008,"",102,"&quot;Los paranoicos&quot; cuenta la historia de Gauna (Daniel Hendler), un joven que escribe pero nunca tuvo el coraje de enseñar su obra. Un hombre que en la intimidad expone una personalidad que parece censurar en su escasa vida social. La aparición de un viejo amigo, Manuel, que llega desde España embriagado por el suceso de una serie televisiva cuyo protagonista tiene un nombre que remite a él, provoca el enfrentamiento de Gauna con aquello que desea -aunque sea la novia de su amigo- y la reafirmación de sus principios.",0,"imgs/peliculas/69.jpg","",actorespelicula,director48,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula71 = new Peliculas("La larga noche de Francisco Sanctis",2016,"",78,"Adaptación de la novela homónima de Humberto Costantini, situada en Buenos Aires en 1977. Un hombre recibe, en plena dictadura, la información del paradero de dos personas buscadas por los militares. Ahora tiene la posibilidad de salvarlas, aunque eso implica arriesgar su propia vida.",0,"imgs/peliculas/71.jpg","",actorespelicula,director50,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula73 = new Peliculas("Las manos",2006,"",119,"El sacerdote Mario Pantaleo descubre que tiene cierto poder para diagnosticar y curar enfermedades por medio de la imposición de las manos. Pero la policía y la jerarquía eclesiástica se pondrán en su contra.",0,"imgs/peliculas/73.jpg","",actorespelicula,director51,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula74 = new Peliculas("La mosca en la ceniza",2009,"",98,"El film trata sobre dos amigas íntimas que llegan a Buenos Aires desde el Noroeste buscando un futuro mejor, pero son víctimas de un engaño y deben trabajar en un prostíbulo. Allí, una se adaptará para sobrevivir y la otra intentará huir.",0,"imgs/peliculas/74.jpg","",actorespelicula,director52,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula85 = new Peliculas("Fantasma de Buenos Aires",2008,"",91,"Una historia fantástica con toques de comedia, sobre la relación entre un joven tímido de hoy y el fantasma de un malevo asesinado en 1920.",0,"imgs/peliculas/85.jpg","",actorespelicula,director60,reseniaspelicula,usuario,genero9, true);
		...
		Peliculas pelicula89 = new Peliculas("El asadito",2000,"",71,"El 30 de diciembre de 1999 se encuentran a comer un asado siete amigos (más un invitado sorpresa) en la terraza de Tito, el anfitrión. La reunión se prolonga hasta las primeras horas del último día del fin del milenio.",0,"imgs/peliculas/89.jpg","",actorespelicula,director62,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula100 = new Peliculas("Ánima Buenos Aires",2011,"",95,"Largometraje animado integrado por cuatro historias que revelan el increíble universo que encierran barrios y rincones de la ciudad de Buenos Aires.",0,"imgs/peliculas/100.jpg","",actorespelicula,director69,reseniaspelicula,usuario,genero7, true);
		...
		Peliculas pelicula101 = new Peliculas("La patota",2015,"",103,"Paulina es una joven abogada que regresa a su ciudad para dedicarse a labores sociales. Trabaja en un programa de defensa de los derechos humanos en zonas humildes de la periferia de la ciudad. Tras la segunda semana de trabajo, es interceptada y atacada por una patota. Remake del clásico del cine argentino del mismo nombre, que en 1961 dirigió Daniel Tinayre, con Mirtha Legrand como protagonista.",0,"imgs/peliculas/101.jpg","",actorespelicula,director54,reseniaspelicula,usuario,genero0, true);
		...
		Peliculas pelicula112 = new Peliculas("Elefante blanco",2012,"",106,"Narra la historia de amistad de dos curas, Julián y Nicolás, que tras sobrevivir a un intento de asesinato por parte del ejército durante su trabajo en Centroamérica, se asientan en una barriada de Buenos Aires para desarrollar su apostolado y labor social. Allí conocen a Luciana, con quien lucharán codo con codo contra la corrupción, un mal endémico de la zona.",0,"imgs/peliculas/112.jpg","",actorespelicula,director17,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula116 = new Peliculas("El lado oscuro del corazón 2",2001,"",108,"Diez años después, Oliverio sigue buscando a la mujer que sea capaz de volar. Tras varios intentos, en España conoce a una equilibrista, y con ella logra demorar el tiempo y vencer a la muerte",0,"imgs/peliculas/116.jpg","",actorespelicula,director41,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula119 = new Peliculas("Andrés no quiere dormir la siesta",2009,"",108,"Andrés (Conrado Valenzuela) vive con su madre (Celina Font) y su hermano mayor en Santa Fe. Ella está separada de su marido (Fabio Aste), y la relación con su ex se torna cada vez más tirante. A raíz de un accidente, ella muere de manera repentina, así que tanto Andrés como su hermano Armando tendrán que irse a vivir con su padre y la madre de él (Norma Aleandro).",0,"imgs/peliculas/119.jpg","",actorespelicula,director82,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula125 = new Peliculas("El frasco",2008,"",96,"Pérez, un conductor de autobús, rompe, sin querer, un frasco de orina que le ha entregado una maestra rural para que lo lleve a analizar. La idea que se le ocurre para solucionar el problema no puede ser más absurda, pero marca el comienzo de una entrañable historia de amor entre esos dos personajes.",0,"imgs/peliculas/125.jpg","",actorespelicula,director33,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula128 = new Peliculas("Cleopatra",2003,"",103,"Cleo, una maestra jubilada (Norma Aleandro), y Sandra (Natalia Oreiro), una popular actriz de telenovelas, hastiadas de sus rutinarias vidas, se lanzan a la carretera para vivir un fin de semana diferente que cambiará por completo sus destinos. En el trayecto, conocen a Carlos (Leonardo Sbaraglia), un campesino que se sumará a la aventura.",0,"imgs/peliculas/128.jpg","",actorespelicula,director11,reseniaspelicula,usuario,genero2, true);
		...
		Peliculas pelicula129 = new Peliculas("Cornelia frente al espejo",2012,"",103,"La joven Cornelia llega a la antigua casona paterna para quitarse la vida. Cuando intenta cumplir con su cometido es continuamente interrumpida por imprevistas apariciones: una misteriosa niña, un ladrón y un amante.",0,"imgs/peliculas/129.jpg","",actorespelicula,director86,reseniaspelicula,usuario,genero1, true);
		...
		Peliculas pelicula132 = new Peliculas("Excursiones",2009,"",80,"Marcos trabaja en una fábrica de golosinas; Martín es guionista de TV. Ambos fueron compañeros de escuela y grandes amigos, pero hace años que no se ven. Marcos consigue que un teatro quiera estrenar un unipersonal que creó en la escuela secundaria y le propone a su antiguo amigo que lo ayude a rescribir el texto.",0,"imgs/peliculas/132.jpg","",actorespelicula,director89,reseniaspelicula,usuario,genero1, true);
