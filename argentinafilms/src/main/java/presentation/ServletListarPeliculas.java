...
public class ServletListarPeliculas extends HttpServlet {
	...
	private void crearDatos(){
		Usuarios usuario = new Usuarios("Jocs", "Jose", "Hassan", "jose.h.utn@gmail.com", "admin", true);
		...
		/*Genero Actores*/
		Actores actor0 = new Actores("Ricardo", "Darín", 0);
		Actores actor1 = new Actores("Soledad", "Villamil", 0);
		Actores actor2 = new Actores("Pablo", "Rago", 0);
		Actores actor3 = new Actores("Javier", "Godino", 0);
		Actores actor4 = new Actores("Guillermo", "Francella", 0);
		Actores actor5 = new Actores("José", "Gioia", 0);
		Actores actor6 = new Actores("Mario", "Alarcón", 0);
		Actores actor7 = new Actores("Mariano", "Argento", 0);
		Actores actor8 = new Actores("Kiko", "Cerone", 0);
		Actores actor9 = new Actores("David", "Nápoli", 0);
		Actores actor10 = new Actores("Carla", "Quevedo", 0);
		Actores actor11 = new Actores("Federico", "Luppi", 0);
		Actores actor12 = new Actores("Cecilia", "Roth", 0);
		Actores actor13 = new Actores("José", "Sacristán", 0);
		Actores actor14 = new Actores("Leonor", "Benedetto", 0);
		Actores actor15 = new Actores("Gastón", "Batyi", 0);
		Actores actor16 = new Actores("Lito", "Cruz", 0);
		Actores actor17 = new Actores("Mariano", "Ortega", 0);
		Actores actor18 = new Actores("Rodolfo", "Ranni", 0);
		Actores actor19 = new Actores("Lorena", "Río", 0);
		Actores actor20 = new Actores("Hugo", "Arana", 0);
		Actores actor21 = new Actores("Mario", "Alarcón", 0);
		Actores actor22 = new Actores("Ricardo", "Darín", 0);
		Actores actor23 = new Actores("Gastón", "Pauls", 0);
		Actores actor24 = new Actores("Leticia", "Brédice", 0);
		Actores actor25 = new Actores("Tomás", "Fonzi", 0);
		Actores actor26 = new Actores("Ignasi", "Abadal", 0);
		Actores actor27 = new Actores("Roly", "Serrano", 0);
		Actores actor28 = new Actores("Alejandro", "Awada", 0);
		Actores actor29 = new Actores("Antonio", "Ugo", 0);
		Actores actor30 = new Actores("Elsa", "Berenguer", 0);
		Actores actor31 = new Actores("Celia", "Juárez", 0);
		Actores actor32 = new Actores("Leo", "Dyzen", 0);
		Actores actor33 = new Actores("Graciela", "Tenembaum", 0);
		Actores actor34 = new Actores("Oscar", "Núñez", 0);
		Actores actor35 = new Actores("María", "Villagra", 0);
		Actores actor36 = new Actores("Gabriel", "Correa", 0);
		Actores actor37 = new Actores("Luis", "Armesto", 0);
		Actores actor38 = new Actores("Pochi", "Ducasse", 0);
		Actores actor39 = new Actores("Ernesto", "Arias", 0);
		Actores actor40 = new Actores("Amancay", "Espíndola", 0);
		Actores actor41 = new Actores("Jorge", "Noya", 0);
		Actores actor42 = new Actores("Carlos", "Lanari", 0);
		Actores actor43 = new Actores("Roberto", "Rey", 0);
		Actores actor44 = new Actores("Carlos", "Falcone", 0);
		Actores actor45 = new Actores("Ricardo", "Mourelle", 0);
		Actores actor46 = new Actores("Emanuel", "Mercado", 0);
		Actores actor47 = new Actores("Ulises", "Celestino", 0);
		Actores actor48 = new Actores("Norberto", "Arcusín", 0);
		Actores actor49 = new Actores("Gabriel", "Molinelli", 0);
		Actores actor50 = new Actores("Claudio", "Rissi", 0);
		Actores actor51 = new Actores("Héctor", "Alterio", 0);
		Actores actor52 = new Actores("Norma", "Aleandro", 0);
		Actores actor53 = new Actores("Hugo", "Arana", 0);
		Actores actor54 = new Actores("Chunchuna", "Villafañe", 0);
		Actores actor55 = new Actores("Lidia", "Catalano", 0);
		Actores actor56 = new Actores("Chela", "Ruiz", 0);
		Actores actor57 = new Actores("Patricio", "Contreras", 0);
		Actores actor58 = new Actores("Guillermo", "Battaglia", 0);
		Actores actor59 = new Actores("Daniel", "Lago", 0);
		Actores actor60 = new Actores("Andrea", "Tenuta", 0);
		Actores actor61 = new Actores("Floria", "Bloise", 0);
		Actores actor62 = new Actores("Carlos", "Weber", 0);
		Actores actor63 = new Actores("Leal", "Rey", 0);
		Actores actor64 = new Actores("María", "Robledo", 0);
		Actores actor65 = new Actores("Laura", "Palmucci", 0);
		Actores actor66 = new Actores("Ricardo", "Darín", 0);
		Actores actor67 = new Actores("Héctor", "Alterio", 0);
		Actores actor68 = new Actores("Norma", "Aleandro", 0);
		Actores actor69 = new Actores("Natalia", "Verbeke", 0);
		Actores actor70 = new Actores("Eduardo", "Blanco", 0);
		Actores actor71 = new Actores("Gimena", "Nóbile", 0);
		Actores actor72 = new Actores("Claudia", "Fontán", 0);
		Actores actor73 = new Actores("David", "Masajnik", 0);
		Actores actor74 = new Actores("Atilio", "Pozzobon", 0);
		Actores actor75 = new Actores("Salo", "Pasik", 0);
		Actores actor76 = new Actores("Ricardo", "Darín", 0);
		Actores actor77 = new Actores("Darío", "Grandinetti", 0);
		Actores actor78 = new Actores("Leonardo", "Sbaraglia", 0);
		Actores actor79 = new Actores("Erica", "Rivas", 0);
		Actores actor80 = new Actores("Oscar", "Martínez", 0);
		Actores actor81 = new Actores("Julieta", "Zylberberg", 0);
		Actores actor82 = new Actores("Rita", "Cortese", 0);
		Actores actor83 = new Actores("María", "Onetto", 0);
		Actores actor84 = new Actores("Osmar", "Núñez", 0);
		Actores actor85 = new Actores("Nancy", "Dupláa", 0);
		Actores actor86 = new Actores("María", "Marull", 0);
		Actores actor87 = new Actores("Germán", "Silva", 0);
		Actores actor88 = new Actores("Marcelo", "Pozzi", 0);
		Actores actor89 = new Actores("Diego", "Gentile", 0);
		Actores actor90 = new Actores("Alan", "Daicz", 0);
		Actores actor91 = new Actores("Liliana", "Weimer", 0);
		Actores actor92 = new Actores("Claudio", "Delan", 0);
		Actores actor93 = new Actores("Lucila", "Mangone", 0);
		Actores actor94 = new Actores("Federico", "Liss", 0);
		Actores actor95 = new Actores("Walter", "Donado", 0);
		Actores actor96 = new Actores("Diego", "Velázquez", 0);
		Actores actor97 = new Actores("Margarita", "Molfino", 0);
		Actores actor98 = new Actores("César", "Bordón", 0);
		Actores actor99 = new Actores("Mónica", "Villa", 0);
		Actores actor100 = new Actores("Juan", "Linari", 0);
		Actores actor101 = new Actores("Juan", "Verdaguer", 0);
		Actores actor102 = new Actores("Susana", "Campos", 0);
		Actores actor103 = new Actores("María", "Robledo", 0);
		Actores actor104 = new Actores("Alberto", "Dalbés", 0);
		Actores actor105 = new Actores("Amalia", "Bernabé", 0);
		Actores actor106 = new Actores("Héctor", "Calcaño", 0);
		Actores actor107 = new Actores("María", "César", 0);
		Actores actor108 = new Actores("Nina", "Brian", 0);
		Actores actor109 = new Actores("Lili", "Gacel", 0);
		Actores actor110 = new Actores("Beto", "Gianola", 0);
		Actores actor111 = new Actores("Miguel", "Ligero", 0);
		Actores actor112 = new Actores("Enrique", "Kossi", 0);
		Actores actor113 = new Actores("Federico", "Luppi", 0);
		Actores actor114 = new Actores("Haydée", "Padilla", 0);
		Actores actor115 = new Actores("Julio", "Grazia", 0);
		Actores actor116 = new Actores("Ulises", "Dumont", 0);
		Actores actor117 = new Actores("Jofre", "Soares", 0);
		Actores actor118 = new Actores("Aldo", "Barbero", 0);
		Actores actor119 = new Actores("Enrique", "Liporace", 0);
		Actores actor120 = new Actores("Arturo", "Maly", 0);
		Actores actor121 = new Actores("Rodolfo", "Ranni", 0);
		Actores actor122 = new Actores("Jorge", "Hacker", 0);
		Actores actor123 = new Actores("Alberto", "Benegas", 0);
		Actores actor124 = new Actores("Federico", "Luppi", 0);
		Actores actor125 = new Actores("Mercedes", "Sampietro", 0);
		Actores actor126 = new Actores("Arturo", "Puig", 0);
		Actores actor127 = new Actores("Carlos", "Santamaría", 0);
		Actores actor128 = new Actores("Yael", "Bamatán", 0);
		Actores actor129 = new Actores("Valentina", "Bassi", 0);
		Actores actor130 = new Actores("María", "Fiorentino", 0);
		Actores actor131 = new Actores("Claudio", "Rissi", 0);
		Actores actor132 = new Actores("Carlos", "Roffé", 0);
		Actores actor133 = new Actores("Sergio", "Campos", 0);
		Actores actor134 = new Actores("Lorenzo", "Quinteros", 0);
		Actores actor135 = new Actores("Mirta", "Busnelli", 0);
		Actores actor136 = new Actores("Nathalie", "Casale", 0);
		Actores actor137 = new Actores("Daniel", "Burzaco", 0);
		Actores actor138 = new Actores("Guido", "Lauwaert", 0);
		Actores actor139 = new Actores("Antonio", "Gasalla", 0);
		Actores actor140 = new Actores("China", "Zorrilla", 0);
		Actores actor141 = new Actores("Luis", "Brandoni", 0);
		Actores actor142 = new Actores("Julio", "Grazia", 0);
		Actores actor143 = new Actores("Betiana", "Blum", 0);
		Actores actor144 = new Actores("Juan", "Tenuta", 0);
		Actores actor145 = new Actores("Mónica", "Villa", 0);
		Actores actor146 = new Actores("Cecilia", "Rossetto", 0);
		Actores actor147 = new Actores("Enrique", "Pinti", 0);
		Actores actor148 = new Actores("Andrea", "Tenuta", 0);
		Actores actor149 = new Actores("Darío", "Grandinetti", 0);
		Actores actor150 = new Actores("Lidia", "Catalano", 0);
		Actores actor151 = new Actores("Juan", "Acosta", 0);
		Actores actor152 = new Actores("Miguel", "Porro", 0);
		Actores actor153 = new Actores("Clotilde", "Borella", 0);
		Actores actor154 = new Actores("Hugo", "Soto", 0);
		Actores actor155 = new Actores("Lorenzo", "Quinteros", 0);
		Actores actor156 = new Actores("Inés", "Vernengo", 0);
		Actores actor157 = new Actores("Rubens", "Correa", 0);
		Actores actor158 = new Actores("David", "Edery", 0);
		Actores actor159 = new Actores("Tomás", "Voth", 0);
		Actores actor160 = new Actores("Rodolfo", "Rodas", 0);
		Actores actor161 = new Actores("Horacio", "Marasi", 0);
		Actores actor162 = new Actores("Jean", "Reguerraz", 0);
		Actores actor163 = new Actores("Héctor", "Alterio", 0);
		Actores actor164 = new Actores("Luis", "Brandoni", 0);
		Actores actor165 = new Actores("Federico", "Luppi", 0);
		Actores actor166 = new Actores("José", "Soriano", 0);
		Actores actor167 = new Actores("Pedro", "Aleandro", 0);
		Actores actor168 = new Actores("Jorge", "López", 0);
		Actores actor169 = new Actores("Osvaldo", "Terranova", 0);
		Actores actor170 = new Actores("Héctor", "Pellegrini", 0);
		Actores actor171 = new Actores("Maurice", "Jouvet", 0);
		Actores actor172 = new Actores("Alfredo", "Iglesias", 0);
		Actores actor173 = new Actores("José", "Gutiérrez", 0);
		Actores actor174 = new Actores("Carlos", "Muñoz", 0);
		Actores actor175 = new Actores("Héctor", "Olivera", 0);
		Actores actor176 = new Actores("Federico", "Luppi", 0);
		Actores actor177 = new Actores("Juan", "Botto", 0);
		Actores actor178 = new Actores("Eusebio", "Poncela", 0);
		Actores actor179 = new Actores("Cecilia", "Roth", 0);
		Actores actor180 = new Actores("Sancho", "Gracia", 0);
		Actores actor181 = new Actores("Ana", "Picchio", 0);
		Actores actor182 = new Actores("Enrique", "Liporace", 0);
		Actores actor183 = new Actores("José", "Sacristán", 0);
		Actores actor184 = new Actores("Leonora", "Balcarce", 0);
		Actores actor185 = new Actores("", "", 0);
		Actores actor186 = new Actores("Víctor", "Proncet", 0);
		Actores actor187 = new Actores("Raúl", "Fraire", 0);
		Actores actor188 = new Actores("Susana", "Lanteri", 0);
		Actores actor189 = new Actores("Mara", "Lasio", 0);
		Actores actor190 = new Actores("Mario", "Luciani", 0);
		Actores actor191 = new Actores("Lautaro", "Murúa", 0);
		Actores actor192 = new Actores("Walter", "Soubrie", 0);
		Actores actor193 = new Actores("Luis", "Politti", 0);
		Actores actor194 = new Actores("Osvaldo", "Santoro", 0);
		Actores actor195 = new Actores("Osvaldo", "Senatore", 0);
		Actores actor196 = new Actores("Klaus", "Dietze", 0);
		Actores actor197 = new Actores("Eduardo", "Iaccono", 0);
		Actores actor198 = new Actores("Walter", "Jakob", 0);
		Actores actor199 = new Actores("Mariano", "Llinás", 0);
		Actores actor200 = new Actores("Horacio", "Marassi", 0);
		Actores actor201 = new Actores("Agustín", "Mendilaharzu", 0);
		Actores actor202 = new Actores("Óscar", "Martínez", 0);
		Actores actor203 = new Actores("Dady", "Brieva", 0);
		Actores actor204 = new Actores("Andrea", "Frigerio", 0);
		Actores actor205 = new Actores("Belén", "Chavanne", 0);
		Actores actor206 = new Actores("Nora", "Navas", 0);
		Actores actor207 = new Actores("Iván", "Steinhardt", 0);
		Actores actor208 = new Actores("Manuel", "Vicente", 0);
		Actores actor209 = new Actores("Marcelo", "D'Andrea", 0);
		Actores actor210 = new Actores("Gustavo", "Garzón", 0);
		Actores actor211 = new Actores("Emma", "Rivera", 0);
		Actores actor212 = new Actores("Walter", "Vidarte", 0);
		Actores actor213 = new Actores("Graciela", "Borges", 0);
		Actores actor214 = new Actores("Nora", "Cullen", 0);
		Actores actor215 = new Actores("Fernando", "'Tacholas'", 0);
		Actores actor216 = new Actores("Martín", "Andrade", 0);
		Actores actor217 = new Actores("José", "Felicetti", 0);
		Actores actor218 = new Actores("Héctor", "Pellegrini", 0);
		Actores actor219 = new Actores("María", "Laurenz", 0);
		Actores actor220 = new Actores("Nelly", "Beltrán", 0);
		Actores actor221 = new Actores("Lautaro", "Murúa", 0);
		Actores actor222 = new Actores("Alberto", "Rosa", 0);
		Actores actor223 = new Actores("Maurice", "Jouvet", 0);
		Actores actor224 = new Actores("Beatriz", "Matar", 0);
		Actores actor225 = new Actores("Jorge", "López", 0);
		Actores actor226 = new Actores("Federico", "Luppi", 0);
		Actores actor227 = new Actores("Marta", "Gam", 0);
		Actores actor228 = new Actores("Alberto", "Barcel", 0);
		Actores actor229 = new Actores("Hugo", "Dargo", 0);
		Actores actor230 = new Actores("Zulema", "Katz", 0);
		Actores actor231 = new Actores("Orlando", "Bor", 0);
		Actores actor232 = new Actores("Fabiana", "Gavel", 0);
		Actores actor233 = new Actores("Darío", "Grandinetti", 0);
		Actores actor234 = new Actores("Sandra", "Ballesteros", 0);
		Actores actor235 = new Actores("Nacha", "Guevara", 0);
		Actores actor236 = new Actores("Mario", "Benedetti", 0);
		Actores actor237 = new Actores("André", "Melançon", 0);
		Actores actor238 = new Actores("Jean-Pierre", "Reguerraz", 0);
		Actores actor239 = new Actores("Inés", "Vernengo", 0);
		Actores actor240 = new Actores("Mónica", "Galán", 0);
		Actores actor241 = new Actores("Marisa", "Aguilera", 0);
		Actores actor242 = new Actores("Federico", "Luppi", 0);
		Actores actor243 = new Actores("Julio", "Grazia", 0);
		Actores actor244 = new Actores("Soledad", "Silveyra", 0);
		Actores actor245 = new Actores("Ulises", "Dumont", 0);
		Actores actor246 = new Actores("Carlos", "Ferreiro", 0);
		Actores actor247 = new Actores("Mónica", "Galán", 0);
		Actores actor248 = new Actores("Norma", "Kraider", 0);
		Actores actor249 = new Actores("Enrique", "Liporace", 0);
		Actores actor250 = new Actores("Arturo", "Maly", 0);
		Actores actor251 = new Actores("Noemi", "Morelli", 0);
		Actores actor252 = new Actores("Pablo", "Rago", 0);
		Actores actor253 = new Actores("China", "Zorrilla", 0);
		Actores actor254 = new Actores("Elena", "Tasisto", 0);
		Actores actor255 = new Actores("Héctor", "Alterio", 0);
		Actores actor256 = new Actores("Ana", "Picchio", 0);
		Actores actor257 = new Actores("Luis", "Brandoni", 0);
		Actores actor258 = new Actores("Marilina", "Ross", 0);
		Actores actor259 = new Actores("China", "Zorrilla", 0);
		Actores actor260 = new Actores("Cipe", "Lincovsky", 0);
		Actores actor261 = new Actores("Oscar", "Martínez", 0);
		Actores actor262 = new Actores("Luis", "Politti", 0);
		Actores actor263 = new Actores("Norma", "Aleandro", 0);
		Actores actor264 = new Actores("Antonio", "Gasalla", 0);
		Actores actor265 = new Actores("Federico", "Luppi", 0);
		Actores actor266 = new Actores("Norma", "Aleandro", 0);
		Actores actor267 = new Actores("Jorge", "Luz", 0);
		Actores actor268 = new Actores("Cecilia", "Rossetto", 0);
		Actores actor269 = new Actores("Gabriela", "Acher", 0);
		Actores actor270 = new Actores("Roberto", "Carnaghi", 0);
		Actores actor271 = new Actores("Erasmo", "Olivera", 0);
		Actores actor272 = new Actores("Nicolas", "Goldsmith", 0);
		Actores actor273 = new Actores("Javier", "Lombardo", 0);
		Actores actor274 = new Actores("Antonio", "Benedictis", 0);
		Actores actor275 = new Actores("Javiera", "Bravo", 0);
		Actores actor276 = new Actores("Laura", "Vagnoni", 0);
		Actores actor277 = new Actores("Mariela", "Díaz", 0);
		Actores actor278 = new Actores("Julia", "Solomonoff", 0);
		Actores actor279 = new Actores("Anibal", "Maldonado", 0);
		Actores actor280 = new Actores("Magín", "García", 0);
		Actores actor281 = new Actores("María", "Cianferoni", 0);
		Actores actor282 = new Actores("Carlos", "Monteros", 0);
		Actores actor283 = new Actores("Luis", "Brandoni", 0);
		Actores actor284 = new Actores("Dora", "Baret", 0);
		Actores actor285 = new Actores("Luisina", "Brando", 0);
		Actores actor286 = new Actores("Lito", "Cruz", 0);
		Actores actor287 = new Actores("Oscar", "Ferrigno", 0);
		Actores actor288 = new Actores("María", "Vaner", 0);
		Actores actor289 = new Actores("China", "Zorrilla", 0);
		Actores actor290 = new Actores("Darío", "Grandinetti", 0);
		Actores actor291 = new Actores("Fernando", "Álvarez", 0);
		Actores actor292 = new Actores("Clotilde", "Borella", 0);
		Actores actor293 = new Actores("Mónica", "Villa", 0);
		Actores actor294 = new Actores("Manuel", "Callau", 0);
		Actores actor295 = new Actores("Juan", "Corazza", 0);
		Actores actor296 = new Actores("Norberto", "Díaz", 0);
		Actores actor297 = new Actores("Gabriela", "Flores", 0);
		Actores actor298 = new Actores("Héctor", "Alterio", 0);
		Actores actor299 = new Actores("Juan", "Gené", 0);
		Actores actor300 = new Actores("Lautaro", "Murúa", 0);
		Actores actor301 = new Actores("Walter", "Vidarte", 0);
		Actores actor302 = new Actores("Héctor", "Pellegrini", 0);
		Actores actor303 = new Actores("Luis", "Aranda", 0);
		Actores actor304 = new Actores("Osvaldo", "Bonet", 0);
		Actores actor305 = new Actores("Diana", "Arias", 0);
		Actores actor306 = new Actores("Cipe", "Lincovsky", 0);
		Actores actor307 = new Actores("Sara", "Bonet", 0);
		Actores actor308 = new Actores("Luis", "Castro", 0);
		Actores actor309 = new Actores("Enzo", "Bai", 0);
		Actores actor310 = new Actores("Coco", "Fossati", 0);
		Actores actor311 = new Actores("Carlos", "Lasarte", 0);
		Actores actor312 = new Actores("Mario", "Luciani", 0);
		Actores actor313 = new Actores("Pacheco", "Fernández", 0);
		Actores actor314 = new Actores("Roberto", "Pieri", 0);
		Actores actor315 = new Actores("Héctor", "Biuchet", 0);
		Actores actor316 = new Actores("Natalio", "Hoxman", 0);
		Actores actor317 = new Actores("Marcos", "Mundstock", 0);
		Actores actor318 = new Actores("Arturo", "Córdova", 0);
		Actores actor319 = new Actores("Zully", "Moreno", 0);
		Actores actor320 = new Actores("Florindo", "Ferrario", 0);
		Actores actor321 = new Actores("Enrique", "Chaico", 0);
		Actores actor322 = new Actores("Federico", "Mansilla", 0);
		Actores actor323 = new Actores("Zoe", "Ducos", 0);
		Actores actor324 = new Actores("José", "Comellas", 0);
		Actores actor325 = new Actores("Roberto", "Bordoni", 0);
		Actores actor326 = new Actores("Ramón", "Garay", 0);
		Actores actor327 = new Actores("Tito", "Grassi", 0);
		Actores actor328 = new Actores("Adolfo", "Linvel", 0);
		Actores actor329 = new Actores("José", "Paonessa", 0);
		Actores actor330 = new Actores("Enrique", "Pedro", 0);
		Actores actor331 = new Actores("Nicolás", "Taricano", 0);
		Actores actor332 = new Actores("Aída", "Villadeamigo", 0);
		Actores actor333 = new Actores("Alejo", "Pintos", 0);
		Actores actor334 = new Actores("Vita", "Escardó", 0);
		Actores actor335 = new Actores("Pablo", "Novak", 0);
		Actores actor336 = new Actores("Adriana", "Salonia", 0);
		Actores actor337 = new Actores("Pablo", "Machado", 0);
		Actores actor338 = new Actores("José", "Monje", 0);
		Actores actor339 = new Actores("Leonardo", "Sbaraglia", 0);
		Actores actor340 = new Actores("Héctor", "Bidonde", 0);
		Actores actor341 = new Actores("Tina", "Serrano", 0);
		Actores actor342 = new Actores("Lorenzo", "Quinteros", 0);
		Actores actor343 = new Actores("Antonella", "Costa", 0);
		Actores actor344 = new Actores("Carlos", "Echevarría", 0);
		Actores actor345 = new Actores("Dominique", "Sanda", 0);
		Actores actor346 = new Actores("Chiara", "Caselli", 0);
		Actores actor347 = new Actores("Enrique", "Piñeyro", 0);
		Actores actor348 = new Actores("Gael", "Bernal", 0);
		Actores actor349 = new Actores("Rodrigo", "Serna", 0);
		Actores actor350 = new Actores("Mía", "Maestro", 0);
		Actores actor351 = new Actores("Mercedes", "Morán", 0);
		Actores actor352 = new Actores("Jorge", "Chiarella", 0);
		Actores actor353 = new Actores("Gabriela", "Aguilera", 0);
		Actores actor354 = new Actores("Natalia", "Oreiro", 0);
		Actores actor355 = new Actores("Lautaro", "Delgado", 0);
		Actores actor356 = new Actores("Javier", "Drolas", 0);
		Actores actor357 = new Actores("Susana", "Pampín", 0);
		Actores actor358 = new Actores("Roly", "Serrano", 0);
		Actores actor359 = new Actores("Daniel", "Melingo", 0);
		Actores actor360 = new Actores("Ángela", "Torres", 0);
		Actores actor361 = new Actores("Daniel", "Valenzuela", 0);
		Actores actor362 = new Actores("Vanesa", "Weinberg", 0);
		Actores actor363 = new Actores("Mariana", "Anghileri)", 0);
		Actores actor364 = new Actores("Javier", "Drolas", 0);
		Actores actor365 = new Actores("Valentina", "Liernud", 0);
		Actores actor366 = new Actores("Héctor", "Alterio", 0);
		Actores actor367 = new Actores("Leonardo", "Sbaraglia", 0);
		Actores actor368 = new Actores("Cecilia", "Roth", 0);
		Actores actor369 = new Actores("Daniel", "Kuzniecka", 0);
		Actores actor370 = new Actores("Leticia", "Brédice", 0);
		Actores actor371 = new Actores("Nicolás", "Abeles", 0);
		Actores actor372 = new Actores("Alejo", "Pintos", 0);
		Actores actor373 = new Actores("Maximiliano", "Ghione", 0);
		Actores actor374 = new Actores("Emilio", "Bardi", 0);
		Actores actor375 = new Actores("Tita", "Merello", 0);
		Actores actor376 = new Actores("Arturo", "Buhr", 0);
		Actores actor377 = new Actores("Roberto", "Fugazot", 0);
		Actores actor378 = new Actores("Enrique", "Fava", 0);
		Actores actor379 = new Actores("Graciela", "Lecube", 0);
		Actores actor380 = new Actores("Diego", "Puente", 0);
		Actores actor381 = new Actores("Tino", "Pascali", 0);
		Actores actor382 = new Actores("Cacho", "Espíndola", 0);
		Actores actor383 = new Actores("Victoriano", "Moreira", 0);
		Actores actor384 = new Actores("Beto", "Gianola", 0);
		Actores actor385 = new Actores("Leonardo", "Favio", 0);
		Actores actor386 = new Actores("María", "Vaner", 0);
		Actores actor387 = new Actores("Elcira", "Garcés", 0);
		Actores actor388 = new Actores("María", "Robledo", 0);
		Actores actor389 = new Actores("Hugo", "Arana", 0);
		Actores actor390 = new Actores("Carlos", "Lucero", 0);
		Actores actor391 = new Actores("Mario", "Pena", 0);
		Actores actor392 = new Actores("Juan", "Valunes", 0);
		Actores actor393 = new Actores("Amadeo", "Valiente", 0);
		Actores actor394 = new Actores("Juan", "Castro", 0);
		Actores actor395 = new Actores("Juan", "Delicio", 0);
		Actores actor396 = new Actores("Carlos", "Medrano", 0);
		Actores actor397 = new Actores("Miguel", "Medrano", 0);
		Actores actor398 = new Actores("Jorge", "Puente", 0);
		Actores actor399 = new Actores("Óscar", "Saraceni", 0);
		Actores actor400 = new Actores("Jorge", "Cabello", 0);
		Actores actor401 = new Actores("Néstor", "Tricarico", 0);
		Actores actor402 = new Actores("Roberto", "Domínguez", 0);
		Actores actor403 = new Actores("Carlos", "González", 0);
		Actores actor404 = new Actores("Carmen", "Maura", 0);
		Actores actor405 = new Actores("Rodrigo", "Noya", 0);
		Actores actor406 = new Actores("Julieta", "Cardinali", 0);
		Actores actor407 = new Actores("Jean", "Noher", 0);
		Actores actor408 = new Actores("Mex", "Urtizberea", 0);
		Actores actor409 = new Actores("Alejandro", "Agresti", 0);
		Actores actor410 = new Actores("Carlos", "Cores", 0);
		Actores actor411 = new Actores("Analía", "Gadé", 0);
		Actores actor412 = new Actores("Carmen", "Giménez", 0);
		Actores actor413 = new Actores("George", "Hilton", 0);
		Actores actor414 = new Actores("Vassili", "Lambrinos", 0);
		Actores actor415 = new Actores("Adolfo", "Linvel", 0);
		Actores actor416 = new Actores("Gilda", "Lousek", 0);
		Actores actor417 = new Actores("Aída", "Luz", 0);
		Actores actor418 = new Actores("Pablo", "Moret", 0);
		Actores actor419 = new Actores("Bernardo", "Perrone", 0);
		Actores actor420 = new Actores("Diego", "Peretti", 0);
		Actores actor421 = new Actores("Luis", "Luque", 0);
		Actores actor422 = new Actores("Oscar", "Ferreiro", 0);
		Actores actor423 = new Actores("Gabriela", "Izcovich", 0);
		Actores actor424 = new Actores("Martín", "Adjemián", 0);
		Actores actor425 = new Actores("Tony", "Lestingi", 0);
		Actores actor426 = new Actores("Carlos", "Portaluppi", 0);
		Actores actor427 = new Actores("Ernesto", "Claudio", 0);
		Actores actor428 = new Actores("Daniel", "Valenzuela", 0);
		Actores actor429 = new Actores("Antonio", "Ugo", 0);
		Actores actor430 = new Actores("", "", 0);
		Actores actor431 = new Actores("Juan", "Botto", 0);
		Actores actor432 = new Actores("Susú", "Pecoraro", 0);
		Actores actor433 = new Actores("José", "Sacristán", 0);
		Actores actor434 = new Actores("Agustín", "Garvie", 0);
		Actores actor435 = new Actores("Vando", "Villamil", 0);
		Actores actor436 = new Actores("Marcela", "Kloosterboer", 0);
		Actores actor437 = new Actores("Maximiliano", "Ghione", 0);
		Actores actor438 = new Actores("Marina", "Gleezer", 0);
		Actores actor439 = new Actores("Gustavo", "Garzón", 0);
		Actores actor440 = new Actores("Carla", "Crespo", 0);
		Actores actor441 = new Actores("Marcos", "Mundstock", 0);
		Actores actor442 = new Actores("Raúl", "Rizzo", 0);
		Actores actor443 = new Actores("Jean", "Noher", 0);
		Actores actor444 = new Actores("Alberto", "Jiménez", 0);
		Actores actor445 = new Actores("Ángel", "Facio", 0);
		Actores actor446 = new Actores("María", "Galiana", 0);
		Actores actor447 = new Actores("Marcos", "Woinski", 0);
		Actores actor448 = new Actores("Hugo", "Carril", 0);
		Actores actor449 = new Actores("Adriana", "Benetti", 0);
		Actores actor450 = new Actores("Raúl", "Valle", 0);
		Actores actor451 = new Actores("Pedro", "Laxalt", 0);
		Actores actor452 = new Actores("Gloria", "Ferrandiz", 0);
		Actores actor453 = new Actores("Eloy", "Álvarez", 0);
		Actores actor454 = new Actores("Herminia", "Franco", 0);
		Actores actor455 = new Actores("Luis", "Otero", 0);
		Actores actor456 = new Actores("Federico", "Luppi", 0);
		Actores actor457 = new Actores("Antonella", "Costa", 0);
		Actores actor458 = new Actores("Pablo", "Cedrón", 0);
		Actores actor459 = new Actores("Esteban", "Meloni", 0);
		Actores actor460 = new Actores("Mariana", "Briski", 0);
		Actores actor461 = new Actores("Ricardo", "Mourelle", 0);
		Actores actor462 = new Actores("Hernán", "Jiménez", 0);
		Actores actor463 = new Actores("China", "Zorrilla", 0);
		Actores actor464 = new Actores("Manuel", "Alexandre", 0);
		Actores actor465 = new Actores("Blanca", "Portillo", 0);
		Actores actor466 = new Actores("Roberto", "Carnaghi", 0);
		Actores actor467 = new Actores("José", "Egido", 0);
		Actores actor468 = new Actores("Federico", "Luppi", 0);
		Actores actor469 = new Actores("Gonzalo", "Urtizberea", 0);
		Actores actor470 = new Actores("Omar", "Muñoz", 0);
		Actores actor471 = new Actores("Carlos", "Novoa", 0);
		Actores actor472 = new Actores("Fanny", "Gautier", 0);
		Actores actor473 = new Actores("Claudia", "Álvarez", 0);
		Actores actor474 = new Actores("Tomás", "Sáez", 0);
		Actores actor475 = new Actores("Rodrigo", "Serna", 0);
		Actores actor476 = new Actores("Pablo", "Echarri", 0);
		Actores actor477 = new Actores("Nazareno", "Casero", 0);
		Actores actor478 = new Actores("Matías", "Marmorato", 0);
		Actores actor479 = new Actores("Lautaro", "Delgado", 0);
		Actores actor480 = new Actores("Diego", "Gómez", 0);
		Actores actor481 = new Actores("Martín", "Urruty", 0);
		Actores actor482 = new Actores("Susana", "Pampín", 0);
		Actores actor483 = new Actores("Micaela", "Vázquez", 0);
		Actores actor484 = new Actores("Julián", "Krakov", 0);
		Actores actor485 = new Actores("Rubén", "Noceda", 0);
		Actores actor486 = new Actores("Alfonso", "Tort", 0);
		Actores actor487 = new Actores("César", "Albarracín", 0);
		Actores actor488 = new Actores("Leonardo", "Ramírez", 0);
		Actores actor489 = new Actores("Rodolfo", "Bebán", 0);
		Actores actor490 = new Actores("Pablo", "Cumo", 0);
		Actores actor491 = new Actores("Alba", "Mugica", 0);
		Actores actor492 = new Actores("Carlos", "Muñoz", 0);
		Actores actor493 = new Actores("Elcira", "Garcés", 0);
		Actores actor494 = new Actores("Eduardo", "Rudy", 0);
		Actores actor495 = new Actores("Elena", "Tritek", 0);
		Actores actor496 = new Actores("Edgardo", "Suárez", 0);
		Actores actor497 = new Actores("Osvaldo", "Vega", 0);
		Actores actor498 = new Actores("Augusto", "Kretschmar", 0);
		Actores actor499 = new Actores("Pirucho", "Gómez", 0);
		Actores actor500 = new Actores("Lola", "Palombo", 0);
		Actores actor501 = new Actores("María", "Vera", 0);
		Actores actor502 = new Actores("Hector", "Palavecino", 0);
		Actores actor503 = new Actores("Julio", "González", 0);
		Actores actor504 = new Actores("Carlos", "Rodríguez", 0);
		Actores actor505 = new Actores("Marie", "Laforêt", 0);
		Actores actor506 = new Actores("Philippe", "Léotard", 0);
		Actores actor507 = new Actores("Miguel", "Sola", 0);
		Actores actor508 = new Actores("Marina", "Vlady", 0);
		Actores actor509 = new Actores("Georges", "Wilson", 0);
		Actores actor510 = new Actores("Lautaro", "Murúa", 0);
		Actores actor511 = new Actores("Gabriela", "Toscano", 0);
		Actores actor512 = new Actores("Juan", "Villegas", 0);
		Actores actor513 = new Actores("Walter", "Donado", 0);
		Actores actor514 = new Actores("Rosa", "Valsecchi", 0);
		Actores actor515 = new Actores("Mariela", "Díaz", 0);
		Actores actor516 = new Actores("Pascual", "Condito", 0);
		Actores actor517 = new Actores("Carlos", "Rossi", 0);
		Actores actor518 = new Actores("Federico", "Luppi", 0);
		Actores actor519 = new Actores("Elsa", "Daniel", 0);
		Actores actor520 = new Actores("María", "Vaner", 0);
		Actores actor521 = new Actores("Edgardo", "Suárez", 0);
		Actores actor522 = new Actores("Cacho", "Mendoza", 0);
		Actores actor523 = new Actores("Eduardo", "Vargas", 0);
		Actores actor524 = new Actores("Ernesto", "Cutrera", 0);
		Actores actor525 = new Actores("Rafael", "Chumbito", 0);
		Actores actor526 = new Actores("Mario", "Savino", 0);
		Actores actor527 = new Actores("Julio", "Grazia", 0);
		Actores actor528 = new Actores("Luisina", "Brando", 0);
		Actores actor529 = new Actores("Fernanda", "Mistral", 0);
		Actores actor530 = new Actores("Beba", "Bidart", 0);
		Actores actor531 = new Actores("Lidia", "Catalano", 0);
		Actores actor532 = new Actores("Julio", "Chávez", 0);
		Actores actor533 = new Actores("Patricio", "Contreras", 0);
		Actores actor534 = new Actores("Ulises", "Dumont", 0);
		Actores actor535 = new Actores("Miguel", "Guerberoff", 0);
		Actores actor536 = new Actores("Arturo", "Maly", 0);
		Actores actor537 = new Actores("Cecilia", "Padilla", 0);
		Actores actor538 = new Actores("Osvaldo", "Terranova", 0);
		Actores actor539 = new Actores("Alejandro", "Patiño", 0);
		Actores actor540 = new Actores("China", "Zorrilla", 0);
		Actores actor541 = new Actores("Eduardo", "Blanco", 0);
		Actores actor542 = new Actores("Ulises", "Dumont", 0);
		Actores actor543 = new Actores("Silvina", "Bosco", 0);
		Actores actor544 = new Actores("Floria", "Bloise", 0);
		Actores actor545 = new Actores("Nicolás", "Condito", 0);
		Actores actor546 = new Actores("Tito", "Mendoza", 0);
		Actores actor547 = new Actores("Julio", "Chávez", 0);
		Actores actor548 = new Actores("Soledad", "Villamil", 0);
		Actores actor549 = new Actores("Luis", "Machín", 0);
		Actores actor550 = new Actores("Agostina", "Lage", 0);
		Actores actor551 = new Actores("Enrique", "Liporace", 0);
		Actores actor552 = new Actores("Rene", "Lavand", 0);
		Actores actor553 = new Actores("Daniel", "Valenzuela", 0);
		Actores actor554 = new Actores("Freddy", "Flores", 0);
		Actores actor555 = new Actores("Ernesto", "Villegas", 0);
		Actores actor556 = new Actores("Gastón", "Pauls", 0);
		Actores actor557 = new Actores("Pablo", "Cedrón", 0);
		Actores actor558 = new Actores("", "", 0);
		Actores actor559 = new Actores("Luis", "Machin", 0);
		Actores actor560 = new Actores("Carlos", "Belloso", 0);
		Actores actor561 = new Actores("Alfredo", "Casero", 0);
		Actores actor562 = new Actores("Marcelo", "Mazzarello", 0);
		Actores actor563 = new Actores("Norma", "Aleandro", 0);
		Actores actor564 = new Actores("Luis", "Luque", 0);
		Actores actor565 = new Actores("Leonor", "Manso", 0);
		Actores actor566 = new Actores("Peto", "Menahem", 0);
		Actores actor567 = new Actores("Alejandra", "Manzo", 0);
		Actores actor568 = new Actores("Laura", "Cymer", 0);
		Actores actor569 = new Actores("Germán", "Silva", 0);
		Actores actor570 = new Actores("Ricardo", "Darín", 0);
		Actores actor571 = new Actores("Cecilia", "Roth", 0);
		Actores actor572 = new Actores("Héctor", "Alterio", 0);
		Actores actor573 = new Actores("Fernanda", "Mistral", 0);
		Actores actor574 = new Actores("Tomás", "Fonzi", 0);
		Actores actor575 = new Actores("Mónica", "Scapparone", 0);
		Actores actor576 = new Actores("Milton", "Canal", 0);
		Actores actor577 = new Actores("Matías", "Pozo", 0);
		Actores actor578 = new Actores("Evelyn", "Domínguez", 0);
		Actores actor579 = new Actores("Leticia", "Bredice", 0);
		Actores actor580 = new Actores("Nicolás", "Cantafio", 0);
		Actores actor581 = new Actores("Gabriel", "Galíndez", 0);
		Actores actor582 = new Actores("María", "Socas", 0);
		Actores actor583 = new Actores("Juan", "Carrasco", 0);
		Actores actor584 = new Actores("Demián", "Bugallo", 0);
		Actores actor585 = new Actores("Valentín", "Barrio", 0);
		Actores actor586 = new Actores("Oscar", "Ferrigno", 0);
		Actores actor587 = new Actores("Alberto", "Silva", 0);
		Actores actor588 = new Actores("Susú", "Pecoraro", 0);
		Actores actor589 = new Actores("Imanol", "Arias", 0);
		Actores actor590 = new Actores("Héctor", "Alterio", 0);
		Actores actor591 = new Actores("Elena", "Tasisto", 0);
		Actores actor592 = new Actores("Carlos", "Muñoz", 0);
		Actores actor593 = new Actores("Héctor", "Pellegrini", 0);
		Actores actor594 = new Actores("Juan", "Leyrado", 0);
		Actores actor595 = new Actores("Boris", "Rubaja", 0);
		Actores actor596 = new Actores("Claudio", "Gallardou", 0);
		Actores actor597 = new Actores("Mona", "Maris", 0);
		Actores actor598 = new Actores("Zelmar", "Gueñol", 0);
		Actores actor599 = new Actores("Fernando", "'Tacholas'", 0);
		Actores actor600 = new Actores("Lidia", "Catalano", 0);
		Actores actor601 = new Actores("Oscar", "Núñez", 0);
		Actores actor602 = new Actores("Héctor", "Alterio", 0);
		Actores actor603 = new Actores("Leonardo", "Sbaraglia", 0);
		Actores actor604 = new Actores("Federico", "Luppi", 0);
		Actores actor605 = new Actores("Cecilia", "Dopazo", 0);
		Actores actor606 = new Actores("Ferrán", "Miras", 0);
		Actores actor607 = new Actores("Daniel", "Kuzniecka", 0);
		Actores actor608 = new Actores("Cipe", "Lincovsky", 0);
		Actores actor609 = new Actores("Antonio", "Grimau", 0);
		Actores actor610 = new Actores("Alex", "Benn", 0);
		Actores actor611 = new Actores("Freddy", "Flores", 0);
		Actores actor612 = new Actores("Rosa", "Sánchez", 0);
		Actores actor613 = new Actores("Óscar", "Bertea", 0);
		Actores actor614 = new Actores("Enrique", "Liporace", 0);
		Actores actor615 = new Actores("Marcelo", "Videla", 0);
		Actores actor616 = new Actores("Alberto", "Mercado", 0);
		Actores actor617 = new Actores("Héctor", "Anglada", 0);
		...
		Peliculas pelicula1 = new Peliculas("Un lugar en el mundo",1992,"",120,"Ernesto hace un viaje a la provincia argentina de San Luis, a un remoto pueblo en un valle puntano, para recordar su infancia y las circunstancias que han determinado su vida: sus padres se habían exiliado voluntariamente de Buenos Aires para vivir en una comunidad campesina. La llegada de un geólogo español, contratado por el cacique local para buscar petróleo, representa una amenaza para la forma de vida de los campesinos.",0,"http://pics.filmaffinity.com/un_lugar_en_el_mundo-643443472-mmed.jpg","32tH6F6sFbU",actorespelicula,director1,null,usuario,genero1);
		...
		Peliculas pelicula4 = new Peliculas("El hijo de la novia",2001,"",124,"Rafael dedica 24 horas al día a su restaurante, está divorciado, ve muy poco a su hija, no tiene amigos y elude comprometerse con su novia. Además, desde hace mucho tiempo no visita a su madre, internada en un geriátrico porque sufre el mal de Alzheimer. Una serie de acontecimientos inesperados le obligan a replantearse su vida. Entre ellos, la intención que tiene su padre de cumplir el viejo sueño de su madre: casarse por la Iglesia.",0,"http://pics.filmaffinity.com/el_hijo_de_la_novia-570644260-mmed.jpg","",actorespelicula,director4,null,usuario,genero1);
		...
		Peliculas pelicula7 = new Peliculas("Tiempo de revancha",1981,"",108,"El ex-sindicalista Pedro Bengoa, previa &quot;limpieza&quot; de su pasado, consigue trabajo en las minas de la empresa Tulsaco, donde se reencuentra con un antiguo compañero quien, pasado algún tiempo, le propone un plan: simular un accidente y hacerse pasar por mudo para cobrar una indemnización. Pero algo inesperado sucede...",0,"http://pics.filmaffinity.com/tiempo_de_revancha-353300768-mmed.jpg","C-6ExvULsC0",actorespelicula,director7,null,usuario,genero1);
		...
		Peliculas pelicula9 = new Peliculas("El acto en cuestión",1994,"",114,"Historia del mago Miguel Quiroga que roba un libro de un desconocido y se hace muy famoso.",0,"http://pics.filmaffinity.com/el_acto_en_cuestion-409071526-mmed.jpg","mytGVGBnr1A",actorespelicula,director9,null,usuario,genero1);
		...
		Peliculas pelicula17 = new Peliculas("El ciudadano ilustre",2016,"",118,"Es la historia de un escritor argentino, Premio Nobel de Literatura, que hace cuarenta años abandonó su pueblo y partió hacia Europa, donde triunfó escribiendo sobre su localidad natal y sus personajes. En el pico de su carrera, el alcalde de ese pueblo donde nació le invita para nombrarle &quot;Ciudadano Ilustre&quot; del mismo, y él decide cancelar su apretada agenda y aceptar la invitación.",0,"http://pics.filmaffinity.com/el_ciudadano_ilustre-221897542-mmed.jpg","VI2GLPtYCq8",actorespelicula,director17,null,usuario,genero2);
		...
		Peliculas pelicula18 = new Peliculas("El dependiente",1969,"",87,"Después de comprometerse con una chica retraída y bella, el dependiente de una ferretería es presa de la avaricia. Empieza a pensar que su patrón, que no tiene familiares, puede morir en cualquier momento y que, en ese caso, él heredaría el negocio.",0,"http://pics.filmaffinity.com/el_dependiente-678974693-mmed.jpg","",actorespelicula,director18,null,usuario,genero1);
		...
		Peliculas pelicula21 = new Peliculas("Últimos días de la víctima",1982,"",94,"A Mendizábal, un asesino a sueldo, sus anónimos clientes le ordenan un nuevo asesinato. Pero en la persecución, precisa y obsesiva, descubrirá que solo forma parte de un juego que no le pertenece, de una cadena al servicio de intereses mayores.",0,"http://pics.filmaffinity.com/ultimos_dias_de_la_victima-433328666-mmed.jpg","",actorespelicula,director21,null,usuario,genero0);
		...
		Peliculas pelicula25 = new Peliculas("Darse cuenta",1984,"",106,"En su película más exitosa, el director Alejandro Doria cuenta la relación profesional y afectiva entre un médico fracasado y un joven enfermo al que la medicina da por muerto. De manera paralela, la película narra los acontecimientos positivos y negativos que transcurren en un hospital público.",0,"http://pics.filmaffinity.com/darse_cuenta-270352329-mmed.jpg","",actorespelicula,director25,null,usuario,genero1);
		...
		Peliculas pelicula26 = new Peliculas("Quebracho",1974,"",95,"Ambientada hacia 1910 en el Chaco. Muestra la situación de los leñadores del quebracho, cruelmente explotados por los empresarios ingleses, gracias al apoyo de las autoridades, de la policía local y de un cuerpo parapolicial creado por los propios patronos.",0,"http://pics.filmaffinity.com/quebracho-275824487-mmed.jpg","CNje5ieYdKU",actorespelicula,director26,null,usuario,genero1);
		...
		Peliculas pelicula28 = new Peliculas("La noche de los lápices",1986,"",106,"En septiembre de 1976, durante los primeros meses de la dictadura militar argentina, siete adolescentes de la ciudad de La Plata son secuestrados, torturados y asesinados a raíz de sus protestas por el aumento del boleto estudiantil. El film relata estos sucesos desde la voz y presencia de uno de los supervivientes.",0,"http://pics.filmaffinity.com/la_noche_de_los_lapices-239087571-mmed.jpg","Y41L4oZfWrg",actorespelicula,director28,null,usuario,genero1);
		...
		Peliculas pelicula33 = new Peliculas("Cenizas del paraíso",1997,"",116,"El juez Makantasis se precipita desde lo alto del edificio que alberga los juzgados. Al mismo tiempo, la joven Ana Muro aparece asesinada. Los tres hijos del juez y el novio de Ana se declaran culpables del asesinato de la chica. La conexión que hay entre ambas muertes tratará de descubrirla la juez Teller.",0,"http://pics.filmaffinity.com/cenizas_del_paraiso-520141637-mmed.jpg","owCOpUqtvJg",actorespelicula,director33,null,usuario,genero0);
		...
		Peliculas pelicula35 = new Peliculas("Crónica de un niño solo",1965,"",79,"Este clásico del cine argentino nos describe la infancia marginal, a través de un niño solitario, y su vida a medio camino entre su barrio pobre y el reformatorio.",0,"http://pics.filmaffinity.com/cronica_de_un_nino_solo-920728726-mmed.jpg","lo2xpriZwX4",actorespelicula,director35,null,usuario,genero1);
		...
		Peliculas pelicula39 = new Peliculas("El empleo (The Employment) (S)",2008,"",6,"Un hombre realiza su trayecto habitual hacia el trabajo, inmerso en un sistema en el cual el uso de las personas como objetos es algo cotidiano.",0,"http://pics.filmaffinity.com/el_empleo_the_employment_s-835189600-mmed.jpg","cxUuU1jwMgM",actorespelicula,director39,null,usuario,genero3);
		...
		Peliculas pelicula41 = new Peliculas("Las aguas bajan turbias",1952,"",92,"Los hermanos Santos y Rufino Peralta se emplean como trabajadores en los yerbatales del Alto Paraná. Allí se encontrarán con condiciones infrahumanas de trabajo y la codicia de los patrones. Además, Santos se enfrentará con un capataz por el amor de Amelia. La rebelión va madurando, al tiempo que se va gestando la formación de un sindicato de trabajadores.",0,"http://pics.filmaffinity.com/las_aguas_bajan_turbias-970096260-mmed.jpg","IANnYuwMFdQ",actorespelicula,director41,null,usuario,genero1);
		...
		Peliculas pelicula46 = new Peliculas("Los inundados",1962,"",87,"Narra la historia de una familia de pocos recursos, habitantes del sur de la provincia de Santa Fe, que se ve forzada a mudarse a un vagón abandonado del ferrocarril hasta que bajen las aguas del río Salado.",0,"http://pics.filmaffinity.com/los_inundados-547434603-mmed.jpg","",actorespelicula,director46,null,usuario,genero1);
		...
		Peliculas pelicula47 = new Peliculas("El exilio de Gardel (Tangos)",1985,"",120,"Narra cómo un grupo de exiliados argentinos montan en París un número musical para &quot;curar&quot; su nostalgia tanguera.",0,"http://pics.filmaffinity.com/el_exilio_de_gardel_tangos-240224504-mmed.jpg","Z995mGACUKw",actorespelicula,director47,null,usuario,genero1);
		...
		Peliculas pelicula50 = new Peliculas("La parte del León",1978,"",85,"Historia de un hombre común y corriente que, por casualidad, toma posesión del dinero que fue robado de un banco, creyendo que así podrá solucionar todos sus problemas.",0,"http://pics.filmaffinity.com/la_parte_del_leon-998120172-mmed.jpg","",actorespelicula,director50,null,usuario,genero0);
		...
		Peliculas pelicula53 = new Peliculas("Felicidades",2000,"",100,"Es Nochebuena en Argentina. Un escritor famoso que no es feliz y que decide viajar al encuentro de su amada; un médico que quiere ligar con una española, y un odontólogo loco por encontrar el juguete que su hijo quiere de regalo. Una ácida visión sobre la otra cara de la navidad, donde la clase media insiste en sostener una celebración que ya ha perdido su naturaleza. Todos la festejan, pero se centra en los que quedan fuera: los protagonistas, que transitan en un mundo al revés, un mundo en el que irónicamente los justicieros se vuelven delincuentes y los nobles, miserables.",0,"http://pics.filmaffinity.com/felicidades-440056730-mmed.jpg","",actorespelicula,director53,null,usuario,genero1);
		...
		Peliculas pelicula55 = new Peliculas("Kamchatka",2002,"",104,"Los difíciles años de la dictadura militar argentina son contemplados por Harry, un niño de diez años que lo único que desea es jugar y hacer travesuras con su hermano pequeño. Sin embargo, en 1976, cuando su familia, perseguida por la dictadura, se ve obligada a esconderse en el campo, comienza para él una nueva vida que pondrá fin a su infancia.",0,"http://pics.filmaffinity.com/kamchatka-239998952-mmed.jpg","JkAWI_fS7Pc",actorespelicula,director55,null,usuario,genero1);
		...
		Peliculas pelicula56 = new Peliculas("Camila",1984,"",107,"Un filme basado en hechos reales que narra la historia de amor que mantuvieron, en el siglo XIX, la aristócrata Camila O'Gorman y el sacerdote Ladislao Gutiérrez. Una relación que provocó el escándalo entre la iglesia y la sociedad de la época.",0,"http://pics.filmaffinity.com/camila-502418258-mmed.jpg","",actorespelicula,director56,null,usuario,genero1);
		...
		Peliculas pelicula57 = new Peliculas("Caballos salvajes",1995,"",92,"José, que ya tiene setenta años y cree saber cómo y por qué vale la pena jugarse la vida, conoce a un joven de 23, convencido de que ya está haciendo lo que debe hacer. Aunque nada parece unirlos, a partir del momento en que se conocen ya nada puede separarlos. A ellos se une Ana, una chica sin rumbo ni ilusiones. Los tres se sienten amenazados y perseguidos por gente que querría eliminarlos.",0,"http://pics.filmaffinity.com/caballos_salvajes-718245719-mmed.jpg","",actorespelicula,director57,null,usuario,genero1);
