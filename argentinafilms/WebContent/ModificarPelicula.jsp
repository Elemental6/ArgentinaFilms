...
<c:if test="${not empty userLogueado}">
    ...
    <div class="login reg">
        <h1 class="text-center titulo-seccion"><img src="imgs/register.png" class="imagen-seccion" style="margin-top: -50px!important;" />MODIFICAR PELÍCULA</h1>
                    ...
                    <div>
                        <div>
                            <div>
                                ...
                                <input type="number" min="10" max="350" class="form-control login" name="txtDuracion" id="txtDuracion" placeholder="Ingrese la duracíon" required>
			 ...
			 <div class="form-group"> 
                ...
                <div class="col-sm-offset-2 col-sm-10">
                    <div>
                        <div>
                            <div>
                                <button type="submit" class="btn btn-success" id="btnModificar">Modificar Película</button>
                            </div>
