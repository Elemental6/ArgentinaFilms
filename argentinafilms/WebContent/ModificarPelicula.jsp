...
<c:if test="${not empty userLogueado}">
    ...
    <div class="login reg">
        <h1 class="text-center titulo-seccion"><img src="imgs/register.png" class="imagen-seccion" />Modificar Pelicula</h1>
        
        <div class="${tipoMensaje}"><b>${mensajeResultado}</b></div>
        
        <form action="ServletActualizarPelicula" role="form" class="login form-horizontal" method="POST"> 
                    ...
                    <div>
                        <div>
                            <div>
                                ...
                                <input type="text" class="form-control" name="txtnombre" id="txtnombre" placeholder="Ingrese el nombre de la película"  pattern=".{1,250}"
			...
			<label class="control-label col-sm-2">Ubicación:</label>                 
                <div class="col-sm-10">
                    <div>
                        <div>
                            <div>
                                <input type="text" class="form-control login" maxlength="70" id="txtUbicacion" name="txtUbicacion"MAXLENGTH="50" placeholder="Ingrese la ubicacíon" required>
                            </div>
                        </div>
                    </div>
                </div>                 
                    ...
                    <div>
                        <div>
                            <div>
                                ...
                                <input type="number" min="10" max="350" class="form-control login" id="txtDuracion" name="txtDuracion" placeholder="Ingrese la duracíon" required>
			...
			<div class="form-group"> 
	                    ...
	                    <div>
	                        <div>
	                         <div> 
							   ...
							   <textarea class="form-control note-editor" rows="5" id="txtAreaSynospsis" name="txtAreaSynospsis"  MAXLENGTH="254"></textarea>
                ...
                <div class="col-sm-10">
                    <div>
                        <div>
                            <div>
                                <select  class="form-control login" name="txtanio" id="txtanio"  required>
			 ...
			 <div class="form-group"> 
                ...
                <div class="col-sm-offset-2 col-sm-10">
                    <div>
                        <div>
                            <div>
                                <button type="submit" class="btn btn-success" id="btnAgregar">Modificar Película</button>
                            </div>
