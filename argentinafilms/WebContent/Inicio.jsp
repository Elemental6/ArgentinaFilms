            ...
            <c:forEach items="${UltimasPeliculas}" var="pelicula">
                ...
                <li class="film-detail"> 
                    ...
                    <div class="film-detail-content pull-left"> 
                        ...
                        <p class="film-detail-meta rating-green film-detail-with-author"> <a class="avatar avatar-24" href="/eternalsunshi/"> 
                                <img src="${pelicula.usuario.avatar}" width="24" height="24" /> 
                                <span></span> 
